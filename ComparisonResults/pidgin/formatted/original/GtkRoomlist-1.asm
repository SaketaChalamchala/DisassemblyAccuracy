...
call	_Perl_croak
endproc
_XS_Pidgin__Roomlist__Dialog_show_with_account PROC
push	ebp
push	edi
push	esi
push	ebx
...
endproc
_XS_Pidgin__Roomlist__Dialog_show PROC
push	edi
push	esi
push	ebx
sub	esp, 32
...
call	___stack_chk_fail
endproc
_XS_Pidgin__Roomlist_is_showable PROC
push	ebp
push	edi
push	esi
push	ebx
...
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Roomlist_is_showable
...
mov	DWORD PTR [esp+16], OFFSET FLAT:LC4
mov	DWORD PTR [esp+12], OFFSET FLAT:LC5
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Roomlist__Dialog_show
...
mov	DWORD PTR [esp+12], OFFSET FLAT:LC5
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Roomlist__Dialog_show_with_account
