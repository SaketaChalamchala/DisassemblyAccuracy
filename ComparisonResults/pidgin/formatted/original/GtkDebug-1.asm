_S_croak_xs_usage_isra_0_constprop_1 PROC
push	esi
push	ebx
sub	esp, 52
mov	ebx, eax
...
call	_Perl_croak
endproc
_XS_Pidgin__Debug_get_handle PROC
push	ebp
push	edi
push	esi
push	ebx
...
endproc
_XS_Pidgin__Debug__Window_show PROC
push	edi
push	esi
push	ebx
sub	esp, 32
...
call	___stack_chk_fail
endproc
_XS_Pidgin__Debug__Window_hide PROC
push	edi
push	esi
push	ebx
sub	esp, 32
