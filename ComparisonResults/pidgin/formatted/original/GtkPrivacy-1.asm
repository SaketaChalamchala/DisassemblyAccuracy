...
call	_Perl_croak
endproc
_XS_Pidgin__Privacy__Dialog_hide PROC
push	edi
push	esi
push	ebx
sub	esp, 32
...
endproc
_XS_Pidgin__Privacy__Dialog_show PROC
push	edi
push	esi
push	ebx
sub	esp, 32
...
call	___stack_chk_fail
endproc
_XS_Pidgin__Privacy_request_add_block PROC
push	ebp
push	edi
push	esi
push	ebx
...
call	___stack_chk_fail
endproc
_XS_Pidgin__Privacy_request_add_permit PROC
push	ebp
push	edi
push	esi
push	ebx
...
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Privacy_request_add_permit
...
mov	DWORD PTR [esp+16], OFFSET FLAT:LC5
mov	DWORD PTR [esp+12], OFFSET FLAT:LC6
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Privacy_request_add_block
...
mov	DWORD PTR [esp+12], OFFSET FLAT:LC6
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Privacy__Dialog_show
...
mov	DWORD PTR [esp+16], OFFSET FLAT:LC3
mov	DWORD PTR [esp+12], OFFSET FLAT:LC6
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Privacy__Dialog_hide
