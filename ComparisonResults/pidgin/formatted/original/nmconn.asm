...
mov ['[esp+4Ch+dwMilliseconds],', 'esi']
call ['_nm_tcp_read']
test ['eax,', 'eax']
jg ['short', 'loc_26C']
call ['__errno']
...
db ['0']
endp
_read_line_constprop_2 proc near	
push ['ebp']
push ['edi']
push ['esi']
push ['ebx']
...
mov ['[esp+104Ch+var_1040],', 'eax']
mov ['[esp+104Ch+var_1044],', 'offset', 'aCmdS']
mov ['[esp+104Ch+var_1048],', '1000h']
mov ['[esp+104Ch+var_104C],', 'edi']
call ['_g_snprintf']
mov ['[esp+104Ch+var_1044],', 'eax']
...
mov ['eax,', '[ebx-0Ch]']
mov ['[esp+104Ch+var_1040],', 'eax']
mov ['[esp+104Ch+var_1044],', 'offset', 'aValU']
mov ['[esp+104Ch+var_1048],', '1000h']
mov ['[esp+104Ch+var_104C],', 'edi']
call ['_g_snprintf']
mov ['[esp+104Ch+var_1044],', 'eax']
...
mov ['[esp+104Ch+var_1040],', 'eax']
mov ['[esp+104Ch+var_1044],', 'offset', 'aTypeU']
mov ['[esp+104Ch+var_1048],', '1000h']
mov ['[esp+104Ch+var_104C],', 'edi']
call ['_g_snprintf']
mov ['[esp+104Ch+var_1044],', 'eax']
...
mov ['eax,', '[esp+104Ch+var_1034]']
mov ['[esp+104Ch+var_1040],', 'eax']
mov ['[esp+104Ch+var_1044],', 'offset', 'aValS']
mov ['[esp+104Ch+var_1048],', '1000h']
mov ['[esp+104Ch+var_104C],', 'edi']
call ['_g_snprintf']
cmp ['eax,', '1000h']
...
db ['90h']
endp
_nm_conn_add_request_item proc near	
push ['esi']
push ['ebx']
sub ['esp,', '24h']
...
mov ['[esp+25Ch+var_254],', 'offset', 'aPostSHttp1_0']
...
mov ['[ebx+0Ch],', 'eax']
mov ['[esp+25Ch+var_258],', 'eax']
mov ['[esp+25Ch+var_25C],', 'offset', 'aD']
...
mov ['[esp+25Ch+var_258],', 'offset', 'aNm_a_sz_transa']
...
mov ['[esp+25Ch+var_254],', 'offset', 'aHostSD']
mov ['[esp+25Ch+var_258],', '200h']
lea ['eax,', '[esp+25Ch+var_220]']
mov ['[esp+25Ch+var_25C],', 'eax']
mov ['[esp+25Ch+var_23C],', 'edx']
...
db ['90h']
endp
_nm_conn_remove_request_item proc near	
push ['esi']
push ['ebx']
sub ['esp,', '24h']
mov ['ebx,', '[esp+2Ch+arg_0]']
...
call ['___stack_chk_fail']
endp
_nm_conn_find_request proc near		
push ['edi']
push ['esi']
push ['ebx']
sub ['esp,', '20h']
...
dd ['3', 'dup(0)']
dd ['offset', 'a3g1fedcba98765+2']
dd ['offset', 'a3g1fedcba98765+4']
dd ['offset', 'a3g1fedcba98765+6']
dd ['offset', 'byte_FC4']
dd ['offset', 'byte_FC4']
dd ['offset', 'byte_FC4']
dd ['offset', 'a3g1fedcba98765+8']
dd ['offset', 'a3g1fedcba98765+0Ah']
dd ['offset', 'byte_FC4']
dd ['offset', 'a3g1fedcba98765+0Ch']
dd ['offset', 'a3g1fedcba98765+0Eh']
dd ['offset', 'a3g1fedcba98765+10h']
dd ['offset', 'a3g1fedcba98765+12h']
dd ['offset', 'byte_FC4']
dd ['offset', 'a3g1fedcba98765+14h']
dd ['offset', 'byte_FC4']
dd ['offset', 'byte_FC4']
dd ['offset', 'byte_FC4']
dd ['offset', 'byte_FC4']
...
dd ['offset', 'byte_FC4']
dd ['offset', 'byte_FC4']
dd ['offset', 'a3g1fedcba98765+18h']
dd ['offset', 'a3g1fedcba98765+1Ah']
dd ['offset', 'a3g1fedcba98765+1Ch']
align ['4']
dd ['2', 'dup(0)']
...
extrn ['_time:near']
extrn ['_nm_create_request:near']
extrn ['_g_slist_remove:near']
extrn ['_nm_request_get_trans_id:near']
end
