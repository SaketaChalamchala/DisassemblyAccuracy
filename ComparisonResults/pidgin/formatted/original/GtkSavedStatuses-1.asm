...
call	_Perl_croak
endproc
_XS_Pidgin__Status__Window_hide PROC
push	edi
push	esi
push	ebx
sub	esp, 32
...
endproc
_XS_Pidgin__Status__Window_show PROC
push	edi
push	esi
push	ebx
sub	esp, 32
...
call	___stack_chk_fail
endproc
_XS_Pidgin__Status__Editor_show PROC
push	ebp
push	edi
push	esi
push	ebx
...
call	_S_croak_xs_usage.isra.0
endproc
_XS_Pidgin__Status_get_handle PROC
push	ebp
push	edi
push	esi
push	ebx
...
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Status_get_handle
...
mov	DWORD PTR [esp+12], OFFSET FLAT:LC8
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Status__Editor_show
...
mov	DWORD PTR [esp+16], OFFSET FLAT:LC3
mov	DWORD PTR [esp+12], OFFSET FLAT:LC8
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Status__Window_show
...
mov	DWORD PTR [esp+16], OFFSET FLAT:LC3
mov	DWORD PTR [esp+12], OFFSET FLAT:LC8
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Status__Window_hide
