...
call	_Perl_croak
endproc
_XS_Pidgin__Utils_convert_buddy_icon PROC
push	ebp
push	edi
push	esi
push	ebx
...
endproc
_XS_Pidgin__Utils_load_accels PROC
push	edi
push	esi
push	ebx
sub	esp, 32
...
call	___stack_chk_fail
endproc
_XS_Pidgin__Utils_save_accels PROC
push	ebp
push	edi
push	esi
push	ebx
...
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Utils_save_accels
...
mov	DWORD PTR [esp+12], OFFSET FLAT:LC7
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Utils_load_accels
...
mov	DWORD PTR [esp+12], OFFSET FLAT:LC7
mov	DWORD PTR [esp+8], OFFSET FLAT:_XS_Pidgin__Utils_convert_buddy_icon
