?Init@CSha1Hasher@@UAGXXZ proc near     
push ['ebp']
mov ['ebp,', 'esp']
mov ['eax,', '[ebp+this]']
add ['eax,', '8']
...
retn ['4']
endp
?Update@CSha1Hasher@@UAGXPBXI@Z proc near 
push ['ebp']
mov ['ebp,', 'esp']
mov ['eax,', '[ebp+arg_8]']
push ['eax']
...
retn ['0Ch']
endp
?Final@CSha1Hasher@@UAGXPAE@Z proc near 
push ['ebp']
mov ['ebp,', 'esp']
mov ['eax,', '[ebp+arg_4]']
push ['eax']
...
retn ['8']
endp
?GetDigestSize@CSha1Hasher@@UAGIXZ proc near 
push ['ebp']
mov ['ebp,', 'esp']
mov ['eax,', '14h']
pop ['ebp']
...
retn
endp
?QueryInterface@CSha1Hasher@@UAGJABU_GUID@@PAPAX@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
mov ['eax,', '[ebp+arg_8]']
mov ['dword', 'ptr', '[eax],', '0']
...
retn ['0Ch']
endp
?AddRef@CSha1Hasher@@UAGKXZ proc near   
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', '0CCCCCCCCh']
...
retn ['4']
endp
?Release@CSha1Hasher@@UAGKXZ proc near  
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '8']
...
retn
endp
??0CRegHasher_CSha1Hasher@@QAE@XZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', '0CCCCCCCCh']
