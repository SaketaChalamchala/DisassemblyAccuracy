...
ret	4
ENDP
?Update@CSha1Hasher@@UAGXPBXI@Z PROC			
push	ebp
mov	ebp, esp
...
ret	12					
ENDP
?Final@CSha1Hasher@@UAGXPAE@Z PROC			
push	ebp
mov	ebp, esp
...
ret	8
ENDP
?GetDigestSize@CSha1Hasher@@UAGIXZ PROC			
push	ebp
mov	ebp, esp
mov	eax, 20					
pop	ebp
...
ret	0
ENDP
?QueryInterface@CSha1Hasher@@UAGJABU_GUID@@PAPAX@Z PROC	
push	ebp
mov	ebp, esp
...
ret	12					
ENDP
?AddRef@CSha1Hasher@@UAGKXZ PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	4
ENDP
?Release@CSha1Hasher@@UAGKXZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 8
...
call	??0CRegHasher_CSha1Hasher@@QAE@XZ	
cmp	ebp, esp
call	__RTC_CheckEsp
pop	ebp
ret	0
ENDP
??0CRegHasher_CSha1Hasher@@QAE@XZ PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
