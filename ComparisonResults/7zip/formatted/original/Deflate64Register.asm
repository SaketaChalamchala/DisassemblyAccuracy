...
ENDP
ENDP
??0CCOMCoder64@NDecoder@NDeflate@NCompress@@QAE@XZ PROC	
push	ebp
mov	ebp, esp
push	ecx
...
ret	4
ENDP
??_GCCOMCoder64@NDecoder@NDeflate@NCompress@@UAEPAXI@Z PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	4
ENDP
??1CCOMCoder64@NDecoder@NDeflate@NCompress@@UAE@XZ PROC	
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ENDP
ENDP
??0CCOMCoder64@NEncoder@NDeflate@NCompress@@QAE@XZ PROC	
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	0
ENDP
?QueryInterface@CCOMCoder64@NEncoder@NDeflate@NCompress@@UAGJABU_GUID@@PAPAX@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 8
...
ret	12					
ENDP
?AddRef@CCOMCoder64@NEncoder@NDeflate@NCompress@@UAGKXZ PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	4
ENDP
?Release@CCOMCoder64@NEncoder@NDeflate@NCompress@@UAGKXZ PROC 
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	eax, -858993460				
...
ret	4
ENDP
??_GCCOMCoder64@NEncoder@NDeflate@NCompress@@QAEPAXI@Z PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	4
ENDP
??1CCOMCoder64@NEncoder@NDeflate@NCompress@@QAE@XZ PROC	
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
jmp	?AddRef@CCoder@NDecoder@NDeflate@NCompress@@UAGKXZ 
ENDP
?Release@CCOMCoder64@NEncoder@NDeflate@NCompress@@W3AGKXZ PROC 
sub	DWORD PTR [esp+4], 4
...
jmp	?QueryInterface@CCoder@NDecoder@NDeflate@NCompress@@UAGJABU_GUID@@PAPAX@Z 
ENDP
?AddRef@CCOMCoder64@NEncoder@NDeflate@NCompress@@W3AGKXZ PROC 
sub	DWORD PTR [esp+4], 4
...
jmp	?Release@CCoder@NDecoder@NDeflate@NCompress@@UAGKXZ 
ENDP
?QueryInterface@CCOMCoder64@NEncoder@NDeflate@NCompress@@W3AGJABU_GUID@@PAPAX@Z PROC 
sub	DWORD PTR [esp+4], 4
...
ret	0
ENDP
??0CRegisterCodecDeflate64@@QAE@XZ PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
