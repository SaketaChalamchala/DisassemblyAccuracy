...
assume ['es:nothing,', 'ss:nothing,', 'ds:_rdata,', 'fs:nothing,', 'gs:nothing']
endp
?getDynamicClassID@CopticCalendar@icu_56@@UBEPAXXZ proc	near 
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0CCh']
push ['ebx']
...
align ['4']
assume ['cs:_rdata']
dd ['offset', '??_R4CopticCalendar@icu_56@@6B@']
public ['??_7CopticCalendar@icu_56@@6B@']
dd ['offset', '?clone@CopticCalendar@icu_56@@UBEPAVCalendar@2@XZ']
...
dd ['offset', '?getType@CopticCalendar@icu_56@@UBEPBDXZ']
...
dd ['offset', '?handleGetExtendedYear@CopticCalendar@icu_56@@MAEHXZ']
...
dd ['offset', '?handleComputeFields@CopticCalendar@icu_56@@MAEXHAAW4UErrorCode@@@Z']
...
dd ['offset', '?defaultCenturyStart@CopticCalendar@icu_56@@MBENXZ']
dd ['offset', '?defaultCenturyStartYear@CopticCalendar@icu_56@@MBEHXZ']
dd ['offset', '?getRelatedYear@Calendar@icu_56@@UBEHAAW4UErrorCode@@@Z']
dd ['offset', '?setRelatedYear@Calendar@icu_56@@UAEXH@Z']
dd ['offset', '?getJDEpochOffset@CopticCalendar@icu_56@@MBEHXZ']
assume ['cs:_rdata$r']
public ['??_R4CopticCalendar@icu_56@@6B@']
dd ['offset', '??_R0?AVCopticCalendar@icu_56@@@8']
dd ['offset', '??_R3CopticCalendar@icu_56@@8']
assume ['cs:_data']
...
dd ['5']
dd ['offset', '??_R2CopticCalendar@icu_56@@8']
assume ['cs:_rdata$r']
public ['??_R2CopticCalendar@icu_56@@8']
dd ['offset', '??_R1A@?0A@EA@CECalendar@icu_56@@8']
...
assume ['es:nothing,', 'ss:nothing,', 'ds:_rdata,', 'fs:nothing,', 'gs:nothing']
endp
?clone@CopticCalendar@icu_56@@UBEPAVCalendar@2@XZ proc near 
push ['ebp']
mov ['ebp,', 'esp']
push ['0FFFFFFFFh']
...
assume ['es:nothing,', 'ss:nothing,', 'ds:_rdata,', 'fs:nothing,', 'gs:nothing']
endp
?getType@CopticCalendar@icu_56@@UBEPBDXZ proc near 
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0CCh']
push ['ebx']
...
assume ['es:nothing,', 'ss:nothing,', 'ds:_rdata,', 'fs:nothing,', 'gs:nothing']
endp
?handleGetExtendedYear@CopticCalendar@icu_56@@MAEHXZ proc near 
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0E4h']
push ['ebx']
...
assume ['es:nothing,', 'ss:nothing,', 'ds:_rdata,', 'fs:nothing,', 'gs:nothing']
endp
?defaultCenturyStart@CopticCalendar@icu_56@@MBENXZ proc	near 
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0CCh']
push ['ebx']
...
assume ['es:nothing,', 'ss:nothing,', 'ds:_rdata,', 'fs:nothing,', 'gs:nothing']
endp
?getJDEpochOffset@CopticCalendar@icu_56@@MBEHXZ	proc near 
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0CCh']
push ['ebx']
...
extrn ['??_ECopticCalendar@icu_56@@UAEPAXI@Z:near']
