...
mov	ecx, DWORD PTR _this$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _len$34208[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _textLength$34209[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?isBogus@UnicodeString@icu_56@@QBECXZ	
movsx	eax, al
test	eax, eax
jne	SHORT $LN5@operator
mov	ecx, DWORD PTR _len$34208[ebp]
cmp	ecx, DWORD PTR _textLength$34209[ebp]
jne	SHORT $LN5@operator
mov	edx, DWORD PTR _len$34208[ebp]
push	edx
...
mov	eax, DWORD PTR $T41963[ebp]
or	eax, 1
mov	DWORD PTR $T41963[ebp], eax
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
ret	4
ENDP
?parseInteger@ICU_Utility@icu_56@@SAHABVUnicodeString@2@AAHH@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 268				
push	ebx
...
mov	BYTE PTR _radix$[ebp], 10		
mov	eax, DWORD PTR _p$[ebp]
cmp	eax, DWORD PTR _limit$[ebp]
jge	SHORT $LN5@parseInteg
mov	eax, DWORD PTR _p$[ebp]
push	eax
...
movzx	ecx, ax
cmp	ecx, 48					
jne	SHORT $LN5@parseInteg
mov	eax, DWORD PTR _p$[ebp]
add	eax, 1
cmp	eax, DWORD PTR _limit$[ebp]
jge	SHORT $LN8@parseInteg
mov	eax, DWORD PTR _p$[ebp]
add	eax, 1
push	eax
mov	ecx, DWORD PTR _rule$[ebp]
...
movzx	ecx, ax
cmp	ecx, 88					
jne	SHORT $LN8@parseInteg
mov	eax, DWORD PTR _p$[ebp]
add	eax, 2
mov	DWORD PTR _p$[ebp], eax
mov	BYTE PTR _radix$[ebp], 16		
jmp	SHORT $LN5@parseInteg
mov	eax, DWORD PTR _p$[ebp]
add	eax, 1
mov	DWORD PTR _p$[ebp], eax
mov	DWORD PTR _count$[ebp], 1
mov	BYTE PTR _radix$[ebp], 8
mov	eax, DWORD PTR _p$[ebp]
cmp	eax, DWORD PTR _limit$[ebp]
jge	SHORT $LN4@parseInteg
mov	eax, DWORD PTR _p$[ebp]
mov	DWORD PTR tv92[ebp], eax
mov	ecx, DWORD PTR _p$[ebp]
add	ecx, 1
mov	DWORD PTR _p$[ebp], ecx
movzx	edx, BYTE PTR _radix$[ebp]
push	edx
...
call	_u_digit_56
add	esp, 8
mov	DWORD PTR _d$34951[ebp], eax
cmp	DWORD PTR _d$34951[ebp], 0
jge	SHORT $LN3@parseInteg
mov	eax, DWORD PTR _p$[ebp]
sub	eax, 1
mov	DWORD PTR _p$[ebp], eax
jmp	SHORT $LN4@parseInteg
mov	eax, DWORD PTR _count$[ebp]
add	eax, 1
mov	DWORD PTR _count$[ebp], eax
movsx	eax, BYTE PTR _radix$[ebp]
imul	eax, DWORD PTR _value$[ebp]
add	eax, DWORD PTR _d$34951[ebp]
mov	DWORD PTR _v$34953[ebp], eax
mov	eax, DWORD PTR _v$34953[ebp]
cmp	eax, DWORD PTR _value$[ebp]
jg	SHORT $LN2@parseInteg
xor	eax, eax
jmp	SHORT $LN10@parseInteg
mov	eax, DWORD PTR _v$34953[ebp]
mov	DWORD PTR _value$[ebp], eax
jmp	SHORT $LN5@parseInteg
cmp	DWORD PTR _count$[ebp], 0
jle	SHORT $LN1@parseInteg
mov	eax, DWORD PTR _pos$[ebp]
mov	ecx, DWORD PTR _p$[ebp]
mov	DWORD PTR [eax], ecx
...
ret	0
ENDP
?parsePattern@ICU_Utility@icu_56@@SAHABVUnicodeString@2@HH0PAH@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 256				
push	ebx
...
mov	eax, -858993460				
rep stosd
mov	DWORD PTR _intCount$[ebp], 0
mov	DWORD PTR _i$34965[ebp], 0
jmp	SHORT $LN14@parsePatte
mov	eax, DWORD PTR _i$34965[ebp]
add	eax, 1
mov	DWORD PTR _i$34965[ebp], eax
mov	ecx, DWORD PTR _pattern$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
cmp	DWORD PTR _i$34965[ebp], eax
jge	$LN12@parsePatte
mov	eax, DWORD PTR _i$34965[ebp]
push	eax
mov	ecx, DWORD PTR _pattern$[ebp]
call	?charAt@UnicodeString@icu_56@@QBE_WH@Z	
mov	WORD PTR _cpat$34969[ebp], ax
movzx	eax, WORD PTR _cpat$34969[ebp]
mov	DWORD PTR tv72[ebp], eax
cmp	DWORD PTR tv72[ebp], 32			
je	SHORT $LN9@parsePatte
cmp	DWORD PTR tv72[ebp], 35			
je	SHORT $LN5@parsePatte
cmp	DWORD PTR tv72[ebp], 126		
je	SHORT $LN6@parsePatte
jmp	$LN3@parsePatte
mov	eax, DWORD PTR _pos$[ebp]
cmp	eax, DWORD PTR _limit$[ebp]
jl	SHORT $LN8@parsePatte
or	eax, -1
jmp	$LN15@parsePatte
mov	eax, DWORD PTR _pos$[ebp]
...
mov	ecx, DWORD PTR _rule$[ebp]
call	?charAt@UnicodeString@icu_56@@QBE_WH@Z	
mov	WORD PTR _c$34970[ebp], ax
movzx	eax, WORD PTR _c$34970[ebp]
push	eax
...
add	esp, 12					
mov	ecx, DWORD PTR _intCount$[ebp]
mov	edx, DWORD PTR _parsedInts$[ebp]
mov	DWORD PTR [edx+ecx*4], eax
mov	eax, DWORD PTR _intCount$[ebp]
add	eax, 1
mov	DWORD PTR _intCount$[ebp], eax
mov	eax, DWORD PTR _p$[ebp]
cmp	eax, DWORD PTR _pos$[ebp]
jne	SHORT $LN4@parsePatte
or	eax, -1
jmp	SHORT $LN15@parsePatte
mov	eax, DWORD PTR _p$[ebp]
mov	DWORD PTR _pos$[ebp], eax
jmp	SHORT $LN10@parsePatte
mov	eax, DWORD PTR _pos$[ebp]
cmp	eax, DWORD PTR _limit$[ebp]
jl	SHORT $LN2@parsePatte
or	eax, -1
jmp	SHORT $LN15@parsePatte
mov	eax, DWORD PTR _pos$[ebp]
...
mov	WORD PTR _c$34970[ebp], ax
movzx	eax, WORD PTR _c$34970[ebp]
movzx	ecx, WORD PTR _cpat$34969[ebp]
cmp	eax, ecx
je	SHORT $LN10@parsePatte
or	eax, -1
jmp	SHORT $LN15@parsePatte
jmp	$LN13@parsePatte
mov	eax, DWORD PTR _pos$[ebp]
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN19@parsePatte
...
DB	0
ENDP
?parseUnicodeIdentifier@ICU_Utility@icu_56@@SA?AVUnicodeString@2@ABV32@AAH@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?parseUnicodeIdentifier@ICU_Utility@icu_56@@SA?AVUnicodeString@2@ABV32@AAH@Z
...
mov	DWORD PTR _ch$34995[ebp], eax
lea	ecx, DWORD PTR _buf$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
test	eax, eax
jne	SHORT $LN6@parseUnico
mov	eax, DWORD PTR _ch$34995[ebp]
push	eax
call	_u_isIDStart_56
add	esp, 4
movsx	ecx, al
test	ecx, ecx
je	SHORT $LN5@parseUnico
mov	eax, DWORD PTR _ch$34995[ebp]
push	eax
lea	ecx, DWORD PTR _buf$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@H@Z 
jmp	SHORT $LN4@parseUnico
push	0
lea	ecx, DWORD PTR _buf$[ebp]
call	?truncate@UnicodeString@icu_56@@QAECH@Z	
...
mov	ecx, DWORD PTR $T42056[ebp]
or	ecx, 1
mov	DWORD PTR $T42056[ebp], ecx
mov	BYTE PTR __$EHRec$[ebp+8], 0
lea	ecx, DWORD PTR _buf$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
jmp	SHORT $LN9@parseUnico
jmp	SHORT $LN3@parseUnico
mov	eax, DWORD PTR _ch$34995[ebp]
push	eax
call	_u_isIDPart_56
add	esp, 4
...
call	?append@UnicodeString@icu_56@@QAEAAV12@H@Z 
jmp	SHORT $LN3@parseUnico
jmp	SHORT $LN7@parseUnico
mov	eax, 65535				
cmp	eax, DWORD PTR _ch$34995[ebp]
sbb	ecx, ecx
neg	ecx
add	ecx, 1
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN17@parseUnico
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
...
DB	0
ENDP
__unwindfunclet$?parseUnicodeIdentifier@ICU_Utility@icu_56@@SA?AVUnicodeString@2@ABV32@AAH@Z$0 PROC
lea	ecx, DWORD PTR _buf$[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ENDP
__unwindfunclet$?parseUnicodeIdentifier@ICU_Utility@icu_56@@SA?AVUnicodeString@2@ABV32@AAH@Z$1 PROC
mov	eax, DWORD PTR $T42056[ebp]
and	eax, 1
je	$LN13@parseUnico
and	DWORD PTR $T42056[ebp], -2		
mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ret	0
ENDP
__ehhandler$?parseUnicodeIdentifier@ICU_Utility@icu_56@@SA?AVUnicodeString@2@ABV32@AAH@Z PROC
...
ENDP
ENDP
?parseNumber@ICU_Utility@icu_56@@SAHABVUnicodeString@2@AAHC@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 240				
push	ebx
...
call	?length@UnicodeString@icu_56@@QBEHXZ	
cmp	DWORD PTR _p$[ebp], eax
jge	SHORT $LN4@parseNumbe
mov	eax, DWORD PTR _p$[ebp]
push	eax
mov	ecx, DWORD PTR _text$[ebp]
call	?char32At@UnicodeString@icu_56@@QBEHH@Z	
mov	DWORD PTR _ch$35013[ebp], eax
movzx	eax, BYTE PTR _radix$[ebp]
push	eax
mov	ecx, DWORD PTR _ch$35013[ebp]
push	ecx
call	_u_digit_56
add	esp, 8
mov	DWORD PTR _d$35014[ebp], eax
cmp	DWORD PTR _d$35014[ebp], 0
jge	SHORT $LN3@parseNumbe
jmp	SHORT $LN4@parseNumbe
movsx	eax, BYTE PTR _radix$[ebp]
imul	eax, DWORD PTR _n$[ebp]
add	eax, DWORD PTR _d$35014[ebp]
mov	DWORD PTR _n$[ebp], eax
jns	SHORT $LN2@parseNumbe
or	eax, -1
jmp	SHORT $LN6@parseNumbe
mov	eax, DWORD PTR _p$[ebp]
add	eax, 1
mov	DWORD PTR _p$[ebp], eax
jmp	SHORT $LN5@parseNumbe
mov	eax, DWORD PTR _pos$[ebp]
mov	ecx, DWORD PTR _p$[ebp]
cmp	ecx, DWORD PTR [eax]
jne	SHORT $LN1@parseNumbe
or	eax, -1
jmp	SHORT $LN6@parseNumbe
mov	eax, DWORD PTR _pos$[ebp]
mov	ecx, DWORD PTR _p$[ebp]
