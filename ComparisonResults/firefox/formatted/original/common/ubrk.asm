...
mov	ecx, DWORD PTR _this$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _len$33252[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _textLength$33253[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?isBogus@UnicodeString@icu_56@@QBECXZ	
movsx	eax, al
test	eax, eax
jne	SHORT $LN5@operator
mov	ecx, DWORD PTR _len$33252[ebp]
cmp	ecx, DWORD PTR _textLength$33253[ebp]
jne	SHORT $LN5@operator
mov	edx, DWORD PTR _len$33252[ebp]
push	edx
...
cmp	DWORD PTR _$S1$33961[ebp], 32		
...
jmp	DWORD PTR $LN15@ubrk_open_[ecx*4]
mov	eax, DWORD PTR _status$[ebp]
push	eax
push	0
push	0
...
push	ecx
lea	ecx, DWORD PTR $T38515[ebp]
call	??0Locale@icu_56@@QAE@PBD000@Z		
push	eax
call	?createCharacterInstance@BreakIterator@icu_56@@SAPAV12@ABVLocale@2@AAW4UErrorCode@@@Z 
add	esp, 8
...
call	??0Locale@icu_56@@QAE@PBD000@Z		
push	eax
call	?createLineInstance@BreakIterator@icu_56@@SAPAV12@ABVLocale@2@AAW4UErrorCode@@@Z 
add	esp, 8
mov	DWORD PTR _result$[ebp], eax
lea	ecx, DWORD PTR $T38519[ebp]
call	??1Locale@icu_56@@UAE@XZ		
jmp	SHORT $LN10@ubrk_open_
mov	eax, DWORD PTR _status$[ebp]
push	eax
push	0
push	0
...
mov	ecx, DWORD PTR _locale$[ebp]
push	ecx
lea	ecx, DWORD PTR $T38521[ebp]
call	??0Locale@icu_56@@QAE@PBD000@Z		
push	eax
call	?createSentenceInstance@BreakIterator@icu_56@@SAPAV12@ABVLocale@2@AAW4UErrorCode@@@Z 
add	esp, 8
mov	DWORD PTR _result$[ebp], eax
lea	ecx, DWORD PTR $T38521[ebp]
call	??1Locale@icu_56@@UAE@XZ		
...
mov	ecx, DWORD PTR _locale$[ebp]
push	ecx
lea	ecx, DWORD PTR $T38523[ebp]
call	??0Locale@icu_56@@QAE@PBD000@Z		
push	eax
call	?createTitleInstance@BreakIterator@icu_56@@SAPAV12@ABVLocale@2@AAW4UErrorCode@@@Z 
add	esp, 8
mov	DWORD PTR _result$[ebp], eax
lea	ecx, DWORD PTR $T38523[ebp]
call	??1Locale@icu_56@@UAE@XZ		
...
movsx	edx, al
test	edx, edx
je	SHORT $LN3@ubrk_open_
xor	eax, eax
jmp	SHORT $LN13@ubrk_open_
cmp	DWORD PTR _result$[ebp], 0
jne	SHORT $LN2@ubrk_open_
mov	eax, DWORD PTR _status$[ebp]
mov	DWORD PTR [eax], 7
xor	eax, eax
jmp	SHORT $LN13@ubrk_open_
mov	eax, DWORD PTR _result$[ebp]
mov	DWORD PTR _uBI$[ebp], eax
cmp	DWORD PTR _text$[ebp], 0
je	SHORT $LN1@ubrk_open_
mov	eax, DWORD PTR _status$[ebp]
push	eax
...
movsx	edx, al
test	edx, edx
je	SHORT $LN2@ubrk_openR
mov	DWORD PTR $T46063[ebp], 0
lea	ecx, DWORD PTR _ruleString$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T46063[ebp]
jmp	SHORT $LN5@ubrk_openR
mov	eax, DWORD PTR _result$[ebp]
mov	DWORD PTR _uBI$[ebp], eax
cmp	DWORD PTR _text$[ebp], 0
je	SHORT $LN1@ubrk_openR
mov	eax, DWORD PTR _status$[ebp]
push	eax
mov	ecx, DWORD PTR _textLength$[ebp]
push	ecx
...
add	esp, 16					
mov	eax, DWORD PTR _uBI$[ebp]
mov	DWORD PTR $T46064[ebp], eax
lea	ecx, DWORD PTR _ruleString$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T46064[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN9@ubrk_openR
...
movsx	edx, al
test	edx, edx
je	SHORT $LN7@ubrk_safeC
xor	eax, eax
jmp	SHORT $LN8@ubrk_safeC
cmp	DWORD PTR _bi$[ebp], 0
jne	SHORT $LN5@ubrk_safeC
mov	eax, DWORD PTR _status$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	SHORT $LN8@ubrk_safeC
cmp	DWORD PTR _pBufferSize$[ebp], 0
je	SHORT $LN4@ubrk_safeC
mov	eax, DWORD PTR _pBufferSize$[ebp]
mov	ecx, DWORD PTR [eax]
mov	DWORD PTR _inputSize$38558[ebp], ecx
mov	eax, DWORD PTR _pBufferSize$[ebp]
mov	DWORD PTR [eax], 1
cmp	DWORD PTR _inputSize$38558[ebp], 0
jne	SHORT $LN4@ubrk_safeC
xor	eax, eax
jmp	SHORT $LN8@ubrk_safeC
...
cmp	esi, esp
call	__RTC_CheckEsp
mov	DWORD PTR _newBI$[ebp], eax
cmp	DWORD PTR _newBI$[ebp], 0
jne	SHORT $LN2@ubrk_safeC
mov	eax, DWORD PTR _status$[ebp]
mov	DWORD PTR [eax], 7
jmp	SHORT $LN1@ubrk_safeC
mov	eax, DWORD PTR _status$[ebp]
mov	DWORD PTR [eax], -126			
mov	eax, DWORD PTR _newBI$[ebp]
pop	edi
pop	esi
pop	ebx
add	esp, 216				
...
mov	ecx, DWORD PTR $T46074[ebp]
mov	DWORD PTR $T46073[ebp], ecx
cmp	DWORD PTR $T46073[ebp], 0
je	SHORT $LN3@ubrk_close
mov	esi, esp
push	1
...
mov	eax, -858993460				
rep stosd
mov	DWORD PTR _ut$[ebp], 878368812		
mov	DWORD PTR _ut$[ebp+4], 0
mov	DWORD PTR _ut$[ebp+8], 0
mov	DWORD PTR _ut$[ebp+12], 112		
mov	DWORD PTR _ut$[ebp+16], 0
mov	DWORD PTR _ut$[ebp+20], 0
mov	DWORD PTR _ut$[ebp+24], 0
mov	DWORD PTR _ut$[ebp+28], 0
mov	DWORD PTR _ut$[ebp+32], 0
mov	DWORD PTR _ut$[ebp+36], 0
mov	DWORD PTR _ut$[ebp+40], 0
mov	DWORD PTR _ut$[ebp+44], 0
mov	DWORD PTR _ut$[ebp+48], 0
mov	DWORD PTR _ut$[ebp+52], 0
mov	DWORD PTR _ut$[ebp+56], 0
mov	DWORD PTR _ut$[ebp+60], 0
mov	DWORD PTR _ut$[ebp+64], 0
mov	DWORD PTR _ut$[ebp+68], 0
mov	DWORD PTR _ut$[ebp+72], 0
mov	DWORD PTR _ut$[ebp+76], 0
mov	DWORD PTR _ut$[ebp+80], 0
mov	DWORD PTR _ut$[ebp+84], 0
mov	DWORD PTR _ut$[ebp+88], 0
mov	DWORD PTR _ut$[ebp+92], 0
mov	DWORD PTR _ut$[ebp+96], 0
mov	DWORD PTR _ut$[ebp+100], 0
mov	DWORD PTR _ut$[ebp+104], 0
mov	DWORD PTR _ut$[ebp+108], 0
mov	eax, DWORD PTR _status$[ebp]
push	eax
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN5@ubrk_setTe
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
ret	0
ENDP
_ubrk_getRuleStatusVec_56 PROC				
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
mov	ecx, DWORD PTR _capacity$[ebp]
push	ecx
mov	edx, DWORD PTR _fillInVec$[ebp]
push	edx
mov	eax, DWORD PTR _bi$[ebp]
mov	edx, DWORD PTR [eax]
mov	ecx, DWORD PTR _bi$[ebp]
...
movsx	edx, al
test	edx, edx
je	SHORT $LN1@ubrk_getLo
mov	eax, DWORD PTR _status$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	SHORT $LN3@ubrk_getLo
mov	eax, DWORD PTR _status$[ebp]
push	eax
mov	ecx, DWORD PTR _type$[ebp]
push	ecx
mov	ecx, DWORD PTR _bi$[ebp]
call	?getLocaleID@BreakIterator@icu_56@@QBEPBDW4ULocDataLocaleType@@AAW4UErrorCode@@@Z 
pop	edi
pop	esi
pop	ebx
add	esp, 192				
...
rep stosd
mov	eax, DWORD PTR _bi$[ebp]
mov	DWORD PTR _bii$[ebp], eax
mov	esi, esp
mov	eax, DWORD PTR _status$[ebp]
push	eax
mov	ecx, DWORD PTR _text$[ebp]
push	ecx
mov	edx, DWORD PTR _bii$[ebp]
mov	eax, DWORD PTR [edx]
mov	ecx, DWORD PTR _bii$[ebp]
