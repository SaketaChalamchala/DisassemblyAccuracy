...
ret	0
ENDP
?toTitle@UnicodeString@icu_56@@QAEAAV12@PAVBreakIterator@2@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
push	eax
mov	eax, DWORD PTR _titleIter$[ebp]
push	eax
mov	ecx, DWORD PTR _this$[ebp]
call	?toTitle@UnicodeString@icu_56@@QAEAAV12@PAVBreakIterator@2@ABVLocale@2@I@Z 
pop	edi
pop	esi
pop	ebx
add	esp, 204				
...
ret	4
ENDP
?toTitle@UnicodeString@icu_56@@QAEAAV12@PAVBreakIterator@2@ABVLocale@2@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
push	eax
mov	ecx, DWORD PTR _titleIter$[ebp]
push	ecx
mov	ecx, DWORD PTR _this$[ebp]
call	?toTitle@UnicodeString@icu_56@@QAEAAV12@PAVBreakIterator@2@ABVLocale@2@I@Z 
pop	edi
...
ret	8
ENDP
?toTitle@UnicodeString@icu_56@@QAEAAV12@PAVBreakIterator@2@ABVLocale@2@I@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 316				
push	ebx
...
push	eax
lea	eax, DWORD PTR _csm$[ebp]
push	eax
call	?setTempCaseMap@@YAXPAUUCaseMap@@PBD@Z	
add	esp, 8
mov	eax, DWORD PTR _titleIter$[ebp]
mov	DWORD PTR _bi$[ebp], eax
cmp	DWORD PTR _bi$[ebp], 0
jne	SHORT $LN3@toTitle
mov	DWORD PTR _errorCode$37355[ebp], 0
lea	eax, DWORD PTR _errorCode$37355[ebp]
push	eax
mov	ecx, DWORD PTR _locale$[ebp]
push	ecx
...
add	esp, 8
mov	DWORD PTR _bi$[ebp], eax
mov	eax, DWORD PTR _errorCode$37355[ebp]
push	eax
call	?U_FAILURE@@YACW4UErrorCode@@@Z		
add	esp, 4
movsx	ecx, al
test	ecx, ecx
je	SHORT $LN3@toTitle
mov	ecx, DWORD PTR _this$[ebp]
call	?setToBogus@UnicodeString@icu_56@@QAEXXZ 
mov	eax, DWORD PTR _this$[ebp]
jmp	SHORT $LN4@toTitle
mov	eax, DWORD PTR _bi$[ebp]
mov	DWORD PTR _csm$[ebp+4], eax
push	OFFSET ?unistr_case_internalToTitle@@YAHPBUUCaseMap@@PA_WHPB_WHPAW4UErrorCode@@@Z 
lea	eax, DWORD PTR _csm$[ebp]
push	eax
mov	ecx, DWORD PTR _this$[ebp]
call	?caseMap@UnicodeString@icu_56@@AAEAAV12@PBUUCaseMap@@P6AH0PA_WHPB_WHPAW4UErrorCode@@@Z@Z 
cmp	DWORD PTR _titleIter$[ebp], 0
jne	SHORT $LN1@toTitle
mov	eax, DWORD PTR _bi$[ebp]
mov	DWORD PTR $T44533[ebp], eax
mov	ecx, DWORD PTR $T44533[ebp]
mov	DWORD PTR $T44532[ebp], ecx
cmp	DWORD PTR $T44532[ebp], 0
je	SHORT $LN6@toTitle
mov	esi, esp
push	1
mov	edx, DWORD PTR $T44532[ebp]
mov	eax, DWORD PTR [edx]
mov	ecx, DWORD PTR $T44532[ebp]
mov	edx, DWORD PTR [eax]
call	edx
cmp	esi, esp
call	__RTC_CheckEsp
mov	DWORD PTR tv94[ebp], eax
jmp	SHORT $LN1@toTitle
mov	DWORD PTR tv94[ebp], 0
mov	eax, DWORD PTR _this$[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN11@toTitle
...
ret	0
ENDP
?unistr_case_internalToTitle@@YAHPBUUCaseMap@@PA_WHPB_WHPAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
push	edx
call	_ustrcase_internalToTitle_56
add	esp, 24					
pop	edi
pop	esi
pop	ebx
...
ret	0
ENDP
?setTempCaseMap@@YAXPAUUCaseMap@@PBD@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
mov	eax, DWORD PTR _csm$[ebp]
cmp	DWORD PTR [eax], 0
jne	SHORT $LN3@setTempCas
call	_ucase_getSingleton_56
mov	ecx, DWORD PTR _csm$[ebp]
mov	DWORD PTR [ecx], eax
cmp	DWORD PTR _locale$[ebp], 0
je	SHORT $LN2@setTempCas
mov	eax, DWORD PTR _locale$[ebp]
movsx	ecx, BYTE PTR [eax]
test	ecx, ecx
jne	SHORT $LN2@setTempCas
mov	eax, DWORD PTR _csm$[ebp]
mov	BYTE PTR [eax+8], 0
jmp	SHORT $LN4@setTempCas
mov	eax, DWORD PTR _locale$[ebp]
push	eax
mov	ecx, DWORD PTR _csm$[ebp]
push	ecx
call	_ustrcase_setTempCaseMapLocale_56
add	esp, 8
pop	edi
pop	esi
pop	ebx
