...
mov	ecx, DWORD PTR _this$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _len$35404[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _textLength$35405[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?isBogus@UnicodeString@icu_56@@QBECXZ	
movsx	eax, al
test	eax, eax
jne	SHORT $LN5@operator
mov	ecx, DWORD PTR _len$35404[ebp]
cmp	ecx, DWORD PTR _textLength$35405[ebp]
jne	SHORT $LN5@operator
mov	edx, DWORD PTR _len$35404[ebp]
push	edx
...
mov	DWORD PTR _$S1$36113[ebp], 0
jmp	SHORT $LN3@operator@2
mov	eax, DWORD PTR _$S1$36113[ebp]
add	eax, 1
mov	DWORD PTR _$S1$36113[ebp], eax
cmp	DWORD PTR _$S1$36113[ebp], 32		
jae	SHORT $LN1@operator@2
mov	eax, DWORD PTR _this$[ebp]
add	eax, DWORD PTR _$S1$36113[ebp]
mov	ecx, DWORD PTR ___that$[ebp]
add	ecx, DWORD PTR _$S1$36113[ebp]
...
movsx	edx, al
test	edx, edx
je	SHORT $LN8@u_strToWCS
xor	eax, eax
jmp	$LN9@u_strToWCS
cmp	DWORD PTR _src$[ebp], 0
jne	SHORT $LN4@u_strToWCS
cmp	DWORD PTR _srcLength$[ebp], 0
jne	SHORT $LN5@u_strToWCS
cmp	DWORD PTR _srcLength$[ebp], -1
jl	SHORT $LN5@u_strToWCS
cmp	DWORD PTR _destCapacity$[ebp], 0
jl	SHORT $LN5@u_strToWCS
cmp	DWORD PTR _dest$[ebp], 0
jne	SHORT $LN6@u_strToWCS
cmp	DWORD PTR _destCapacity$[ebp], 0
jle	SHORT $LN6@u_strToWCS
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	SHORT $LN9@u_strToWCS
cmp	DWORD PTR _srcLength$[ebp], -1
jne	SHORT $LN3@u_strToWCS
mov	eax, DWORD PTR _src$[ebp]
push	eax
call	_u_strlen_56
add	esp, 4
mov	DWORD PTR _srcLength$[ebp], eax
cmp	DWORD PTR _srcLength$[ebp], 0
jle	SHORT $LN2@u_strToWCS
mov	eax, DWORD PTR _srcLength$[ebp]
cmp	eax, DWORD PTR _destCapacity$[ebp]
jg	SHORT $LN2@u_strToWCS
push	1
mov	eax, DWORD PTR _src$[ebp]
push	eax
...
movsx	edx, al
test	edx, edx
je	SHORT $LN8@u_strFromW
xor	eax, eax
jmp	$LN9@u_strFromW
cmp	DWORD PTR _src$[ebp], 0
jne	SHORT $LN4@u_strFromW
cmp	DWORD PTR _srcLength$[ebp], 0
jne	SHORT $LN5@u_strFromW
cmp	DWORD PTR _srcLength$[ebp], -1
jl	SHORT $LN5@u_strFromW
cmp	DWORD PTR _destCapacity$[ebp], 0
jl	SHORT $LN5@u_strFromW
cmp	DWORD PTR _dest$[ebp], 0
jne	SHORT $LN6@u_strFromW
cmp	DWORD PTR _destCapacity$[ebp], 0
jle	SHORT $LN6@u_strFromW
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	SHORT $LN9@u_strFromW
cmp	DWORD PTR _srcLength$[ebp], -1
jne	SHORT $LN3@u_strFromW
mov	eax, DWORD PTR _src$[ebp]
push	eax
call	_u_strlen_56
add	esp, 4
mov	DWORD PTR _srcLength$[ebp], eax
cmp	DWORD PTR _srcLength$[ebp], 0
jle	SHORT $LN2@u_strFromW
mov	eax, DWORD PTR _srcLength$[ebp]
cmp	eax, DWORD PTR _destCapacity$[ebp]
jg	SHORT $LN2@u_strFromW
push	1
mov	eax, DWORD PTR _src$[ebp]
push	eax
call	_uprv_checkValidMemory
