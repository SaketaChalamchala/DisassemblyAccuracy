...
mov	eax, DWORD PTR $T43123[ebp]
or	eax, 1
mov	DWORD PTR $T43123[ebp], eax
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
ret	4
ENDP
_ustrcase_setTempCaseMapLocale_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
jne	SHORT $LN6@ustrcase_s
call	_uloc_getDefault_56
mov	DWORD PTR _locale$[ebp], eax
mov	DWORD PTR _i$[ebp], 0
jmp	SHORT $LN5@ustrcase_s
mov	eax, DWORD PTR _i$[ebp]
add	eax, 1
mov	DWORD PTR _i$[ebp], eax
cmp	DWORD PTR _i$[ebp], 4
jge	SHORT $LN3@ustrcase_s
...
jmp	SHORT $LN4@ustrcase_s
cmp	DWORD PTR _i$[ebp], 3
jg	SHORT $LN2@ustrcase_s
mov	eax, DWORD PTR _csm$[ebp]
add	eax, DWORD PTR _i$[ebp]
mov	BYTE PTR [eax+8], 0
jmp	SHORT $LN7@ustrcase_s
mov	eax, DWORD PTR _csm$[ebp]
mov	BYTE PTR [eax+8], 0
pop	edi
pop	esi
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN5@u_strToLow
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN5@u_strToUpp
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
