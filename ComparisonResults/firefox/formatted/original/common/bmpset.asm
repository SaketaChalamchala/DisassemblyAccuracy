...
ret	12					
ENDP
??0BMPSet@icu_56@@QAE@PBHH@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
ret	8
ENDP
??_GBMPSet@icu_56@@UAEPAXI@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
??0BMPSet@icu_56@@QAE@ABV01@PBHH@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
?initBits@BMPSet@icu_56@@AAEXXZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 256				
push	ebx
...
cmp	DWORD PTR _start$[ebp], 128		
jl	SHORT $LN21@initBits
cmp	DWORD PTR _limit$[ebp], 128		
jle	$LN27@initBits
cmp	DWORD PTR _start$[ebp], 2048		
jge	$LN16@initBits
cmp	DWORD PTR _limit$[ebp], 2048		
jg	SHORT $LN30@initBits
mov	eax, DWORD PTR _limit$[ebp]
mov	DWORD PTR tv83[ebp], eax
jmp	SHORT $LN31@initBits
mov	DWORD PTR tv83[ebp], 2048		
...
mov	DWORD PTR _limit$[ebp], 1114112		
jmp	$LN17@initBits
mov	DWORD PTR _minStart$[ebp], 2048		
cmp	DWORD PTR _start$[ebp], 65536		
jge	$LN28@initBits
cmp	DWORD PTR _limit$[ebp], 65536		
jle	SHORT $LN10@initBits
mov	DWORD PTR _limit$[ebp], 65536		
mov	eax, DWORD PTR _start$[ebp]
...
ret	0
ENDP
?set32x64Bits@icu_56@@YAXQAIHH@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 256				
push	ebx
...
not	eax
mov	DWORD PTR _bits$[ebp], eax
cmp	DWORD PTR _limitLead$[ebp], 32		
...
ret	0
ENDP
?overrideIllegal@BMPSet@icu_56@@AAEXXZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 240				
push	ebx
...
mov	DWORD PTR _mask$[ebp], -536879105	
mov	DWORD PTR _bits$[ebp], 8192		
...
ret	0
ENDP
?containsSlow@BMPSet@icu_56@@ABECHHH@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	12					
ENDP
?findCodePoint@BMPSet@icu_56@@ABEHHHH@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
ret	12					
ENDP
?contains@BMPSet@icu_56@@UBECH@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 228				
push	ebx
...
ret	4
ENDP
?span@BMPSet@icu_56@@QBEPB_WPB_W0W4USetSpanCondition@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 276				
push	ebx
...
ret	12					
ENDP
?spanBack@BMPSet@icu_56@@QBEPB_WPB_W0W4USetSpanCondition@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 276				
push	ebx
...
ret	12					
ENDP
?spanUTF8@BMPSet@icu_56@@QBEPBEPBEHW4USetSpanCondition@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 316				
push	ebx
...
cmp	DWORD PTR _c$36392[ebp], 65536		
jl	SHORT $LN57@spanUTF8
cmp	DWORD PTR _c$36392[ebp], 1114111	
...
ret	12					
ENDP
?spanBackUTF8@BMPSet@icu_56@@QBEHPBEHW4USetSpanCondition@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 264				
push	ebx
...
cmp	DWORD PTR _c$36433[ebp], 2047		
...
jmp	$LN30@spanBackUT
jmp	$LN27@spanBackUT
cmp	DWORD PTR _c$36433[ebp], 65535		
