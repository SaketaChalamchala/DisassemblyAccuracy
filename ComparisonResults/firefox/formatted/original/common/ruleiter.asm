...
mov	ecx, DWORD PTR _this$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _len$33429[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _textLength$33430[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?isBogus@UnicodeString@icu_56@@QBECXZ	
movsx	eax, al
test	eax, eax
jne	SHORT $LN5@operator@2
mov	ecx, DWORD PTR _len$33429[ebp]
cmp	ecx, DWORD PTR _textLength$33430[ebp]
jne	SHORT $LN5@operator@2
mov	edx, DWORD PTR _len$33429[ebp]
push	edx
...
ret	4
ENDP
??0RuleCharacterIterator@icu_56@@QAE@ABVUnicodeString@1@PBVSymbolTable@1@AAVParsePosition@1@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
mov	DWORD PTR [eax], ecx
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _thePos$[ebp]
mov	DWORD PTR [eax+4], ecx
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _theSym$[ebp]
mov	DWORD PTR [eax+8], ecx
mov	eax, DWORD PTR _this$[ebp]
...
ret	12					
ENDP
?atEnd@RuleCharacterIterator@icu_56@@QBECXZ PROC	
push	ebp
mov	ebp, esp
sub	esp, 208				
push	ebx
...
ret	0
ENDP
?next@RuleCharacterIterator@icu_56@@QAEHHAACAAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?next@RuleCharacterIterator@icu_56@@QAEHHAACAAW4UErrorCode@@@Z
...
mov	eax, DWORD PTR _isEscaped$[ebp]
mov	BYTE PTR [eax], 0
mov	ecx, DWORD PTR _this$[ebp]
...
mov	ecx, DWORD PTR [eax]
push	ecx
lea	edx, DWORD PTR _name$34186[ebp]
push	edx
mov	eax, DWORD PTR _this$[ebp]
...
lea	ecx, DWORD PTR _name$34186[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
test	eax, eax
jne	SHORT $LN6@next
...
mov	DWORD PTR [eax+16], 0
mov	esi, esp
lea	eax, DWORD PTR _name$34186[ebp]
push	eax
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+8]
mov	eax, DWORD PTR _this$[ebp]
...
jne	SHORT $LN5@next
mov	eax, DWORD PTR _ec$[ebp]
mov	DWORD PTR [eax], 65554			
mov	DWORD PTR $T41360[ebp], -1
mov	DWORD PTR __$EHRec$[ebp+8], -1
lea	ecx, DWORD PTR _name$34186[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T41360[ebp]
jmp	$LN11@next
mov	eax, DWORD PTR _this$[ebp]
...
and	eax, 2
je	$LN2@next
lea	ecx, DWORD PTR _tempEscape$34194[ebp]
call	??0UnicodeString@icu_56@@QAE@XZ		
mov	DWORD PTR __$EHRec$[ebp+8], 1
mov	DWORD PTR _offset$34195[ebp], 0
lea	eax, DWORD PTR _offset$34195[ebp]
push	eax
push	12					
lea	ecx, DWORD PTR _tempEscape$34194[ebp]
push	ecx
...
mov	DWORD PTR _c$[ebp], eax
mov	eax, DWORD PTR _offset$34195[ebp]
push	eax
mov	ecx, DWORD PTR _this$[ebp]
...
jge	SHORT $LN1@next
mov	eax, DWORD PTR _ec$[ebp]
mov	DWORD PTR [eax], 65540			
mov	DWORD PTR $T41361[ebp], -1
mov	DWORD PTR __$EHRec$[ebp+8], -1
lea	ecx, DWORD PTR _tempEscape$34194[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T41361[ebp]
jmp	SHORT $LN11@next
mov	DWORD PTR __$EHRec$[ebp+8], -1
lea	ecx, DWORD PTR _tempEscape$34194[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
...
DB	0
ENDP
__unwindfunclet$?next@RuleCharacterIterator@icu_56@@QAEHHAACAAW4UErrorCode@@@Z$0 PROC
lea	ecx, DWORD PTR _name$34186[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ENDP
__unwindfunclet$?next@RuleCharacterIterator@icu_56@@QAEHHAACAAW4UErrorCode@@@Z$1 PROC
lea	ecx, DWORD PTR _tempEscape$34194[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ENDP
__ehhandler$?next@RuleCharacterIterator@icu_56@@QAEHHAACAAW4UErrorCode@@@Z PROC
...
ret	0
ENDP
?getPos@RuleCharacterIterator@icu_56@@QBEXAAUPos@12@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
?setPos@RuleCharacterIterator@icu_56@@QAEXABUPos@12@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
?skipIgnored@RuleCharacterIterator@icu_56@@QAEXH@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
mov	eax, DWORD PTR _options$[ebp]
and	eax, 4
je	SHORT $LN5@skipIgnore
mov	ecx, DWORD PTR _this$[ebp]
call	?_current@RuleCharacterIterator@icu_56@@ABEHXZ 
mov	DWORD PTR _a$34214[ebp], eax
mov	eax, DWORD PTR _a$34214[ebp]
push	eax
call	?isWhiteSpace@PatternProps@icu_56@@SACH@Z 
add	esp, 4
movsx	ecx, al
test	ecx, ecx
jne	SHORT $LN1@skipIgnore
jmp	SHORT $LN5@skipIgnore
mov	eax, 65535				
cmp	eax, DWORD PTR _a$34214[ebp]
sbb	ecx, ecx
neg	ecx
add	ecx, 1
push	ecx
...
ret	4
ENDP
?lookahead@RuleCharacterIterator@icu_56@@QBEAAVUnicodeString@2@AAV32@H@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
pop	ecx
mov	DWORD PTR _this$[ebp], ecx
cmp	DWORD PTR _maxLookAhead$[ebp], 0
jge	SHORT $LN3@lookahead
mov	DWORD PTR _maxLookAhead$[ebp], 2147483647 
mov	eax, DWORD PTR _this$[ebp]
cmp	DWORD PTR [eax+12], 0
je	SHORT $LN2@lookahead
mov	eax, DWORD PTR _result$[ebp]
push	eax
mov	ecx, DWORD PTR _maxLookAhead$[ebp]
push	ecx
mov	edx, DWORD PTR _this$[ebp]
...
ret	8
ENDP
?jumpahead@RuleCharacterIterator@icu_56@@QAEXH@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
?_current@RuleCharacterIterator@icu_56@@ABEHXZ PROC	
push	ebp
mov	ebp, esp
sub	esp, 220				
push	ebx
...
mov	ecx, DWORD PTR [eax+4]
call	?getIndex@ParsePosition@icu_56@@QBEHXZ	
mov	DWORD PTR _i$34234[ebp], eax
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax]
call	?length@UnicodeString@icu_56@@QBEHXZ	
cmp	DWORD PTR _i$34234[ebp], eax
jge	SHORT $LN5@current
mov	ecx, DWORD PTR _i$34234[ebp]
push	ecx
mov	edx, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [edx]
call	?char32At@UnicodeString@icu_56@@QBEHH@Z	
...
ret	0
ENDP
?_advance@RuleCharacterIterator@icu_56@@AAEXH@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
