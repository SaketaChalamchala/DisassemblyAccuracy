...
mov	ecx, DWORD PTR _this$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _len$33374[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _textLength$33375[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?isBogus@UnicodeString@icu_56@@QBECXZ	
movsx	eax, al
test	eax, eax
jne	SHORT $LN5@operator
mov	ecx, DWORD PTR _len$33374[ebp]
cmp	ecx, DWORD PTR _textLength$33375[ebp]
jne	SHORT $LN5@operator
mov	edx, DWORD PTR _len$33374[ebp]
push	edx
...
ret	4
ENDP
?appendNumber@ICU_Utility@icu_56@@SAAAVUnicodeString@2@AAV32@HHH@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 228				
push	ebx
...
jl	SHORT $LN4@appendNumb
mov	eax, DWORD PTR _nn$[ebp]
cdq
idiv	DWORD PTR _radix$[ebp]
mov	DWORD PTR _nn$[ebp], eax
...
jmp	SHORT $LN6@appendNumb
mov	eax, DWORD PTR _minDigits$[ebp]
sub	eax, 1
mov	DWORD PTR _minDigits$[ebp], eax
cmp	DWORD PTR _minDigits$[ebp], 0
jle	SHORT $LN2@appendNumb
movzx	eax, WORD PTR _DIGITS
push	eax
mov	ecx, DWORD PTR _result$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@_W@Z 
jmp	SHORT $LN4@appendNumb
cmp	DWORD PTR _r$[ebp], 0
jle	SHORT $LN1@appendNumb
mov	eax, DWORD PTR _n$[ebp]
cdq
idiv	DWORD PTR _r$[ebp]
mov	DWORD PTR _digit$34128[ebp], eax
mov	eax, DWORD PTR _digit$34128[ebp]
movzx	ecx, WORD PTR _DIGITS[eax*2]
push	ecx
mov	ecx, DWORD PTR _result$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@_W@Z 
mov	eax, DWORD PTR _digit$34128[ebp]
...
ret	0
ENDP
?isUnprintable@ICU_Utility@icu_56@@SACH@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 196				
push	ebx
...
jl	SHORT $LN3@isUnprinta
cmp	DWORD PTR _c$[ebp], 126			
jg	SHORT $LN3@isUnprinta
mov	BYTE PTR tv66[ebp], 0
jmp	SHORT $LN4@isUnprinta
...
ret	0
ENDP
?escapeUnprintable@ICU_Utility@icu_56@@SACAAVUnicodeString@2@H@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
?skipWhitespace@ICU_Utility@icu_56@@SAHABVUnicodeString@2@AAHC@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
movsx	eax, BYTE PTR _advance$[ebp]
test	eax, eax
...
ret	0
ENDP
?parseChar@ICU_Utility@icu_56@@SACABVUnicodeString@2@AAH_W@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
cmp	edx, eax
je	SHORT $LN2@parseChar
mov	eax, DWORD PTR _pos$[ebp]
mov	ecx, DWORD PTR _start$[ebp]
mov	DWORD PTR [eax], ecx
xor	al, al
jmp	SHORT $LN3@parseChar
mov	eax, DWORD PTR _pos$[ebp]
mov	ecx, DWORD PTR [eax]
add	ecx, 1
...
ret	0
ENDP
?parsePattern@ICU_Utility@icu_56@@SAHABVUnicodeString@2@ABVReplaceable@2@HH@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 228				
push	ebx
...
call	?length@UnicodeString@icu_56@@QBEHXZ	
cmp	DWORD PTR _ipat$[ebp], eax
jne	SHORT $LN11@parsePatte
mov	eax, DWORD PTR _index$[ebp]
jmp	$LN12@parsePatte
mov	eax, DWORD PTR _ipat$[ebp]
push	eax
mov	ecx, DWORD PTR _pat$[ebp]
call	?char32At@UnicodeString@icu_56@@QBEHH@Z	
mov	DWORD PTR _cpat$[ebp], eax
mov	eax, DWORD PTR _index$[ebp]
...
mov	DWORD PTR _c$34168[ebp], eax
cmp	DWORD PTR _cpat$[ebp], 126		
jne	SHORT $LN8@parsePatte
mov	eax, DWORD PTR _c$34168[ebp]
push	eax
call	?isWhiteSpace@PatternProps@icu_56@@SACH@Z 
add	esp, 4
movsx	ecx, al
test	ecx, ecx
je	SHORT $LN7@parsePatte
mov	eax, 65535				
cmp	eax, DWORD PTR _c$34168[ebp]
sbb	ecx, ecx
neg	ecx
add	ecx, 1
add	ecx, DWORD PTR _index$[ebp]
mov	DWORD PTR _index$[ebp], ecx
jmp	SHORT $LN10@parsePatte
jmp	SHORT $LN6@parsePatte
mov	eax, DWORD PTR _ipat$[ebp]
add	eax, 1
...
call	?length@UnicodeString@icu_56@@QBEHXZ	
cmp	DWORD PTR _ipat$[ebp], eax
jne	SHORT $LN6@parsePatte
mov	eax, DWORD PTR _index$[ebp]
jmp	SHORT $LN12@parsePatte
jmp	SHORT $LN4@parsePatte
mov	eax, DWORD PTR _c$34168[ebp]
cmp	eax, DWORD PTR _cpat$[ebp]
jne	SHORT $LN3@parsePatte
mov	eax, 65535				
cmp	eax, DWORD PTR _c$34168[ebp]
sbb	ecx, ecx
neg	ecx
...
neg	ecx
add	ecx, 1
add	ecx, DWORD PTR _ipat$[ebp]
mov	DWORD PTR _ipat$[ebp], ecx
mov	ecx, DWORD PTR _pat$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
cmp	DWORD PTR _ipat$[ebp], eax
jne	SHORT $LN2@parsePatte
mov	eax, DWORD PTR _index$[ebp]
jmp	SHORT $LN12@parsePatte
jmp	SHORT $LN4@parsePatte
or	eax, -1
...
ret	0
ENDP
?appendToRule@ICU_Utility@icu_56@@SAXAAVUnicodeString@2@HCC0@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 220				
push	ebx
...
mov	eax, -858993460				
rep stosd
movsx	eax, BYTE PTR _isLiteral$[ebp]
test	eax, eax
jne	SHORT $LN27@appendToRu
...
test	ecx, ecx
je	$LN28@appendToRu
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
test	eax, eax
jle	$LN26@appendToRu
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
cmp	eax, 2
jl	SHORT $LN24@appendToRu
push	0
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?charAt@UnicodeString@icu_56@@QBE_WH@Z	
movzx	eax, ax
cmp	eax, 39					
jne	SHORT $LN24@appendToRu
push	1
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?charAt@UnicodeString@icu_56@@QBE_WH@Z	
movzx	eax, ax
...
jmp	SHORT $LN25@appendToRu
mov	DWORD PTR _trailingCount$34193[ebp], 0
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
cmp	eax, 2
jl	SHORT $LN22@appendToRu
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
sub	eax, 2
push	eax
...
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?truncate@UnicodeString@icu_56@@QAECH@Z	
mov	eax, DWORD PTR _trailingCount$34193[ebp]
add	eax, 1
mov	DWORD PTR _trailingCount$34193[ebp], eax
jmp	SHORT $LN23@appendToRu
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
test	eax, eax
jle	SHORT $LN20@appendToRu
push	39					
mov	ecx, DWORD PTR _rule$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@_W@Z 
mov	eax, DWORD PTR _quoteBuf$[ebp]
push	eax
mov	ecx, DWORD PTR _rule$[ebp]
...
call	?truncate@UnicodeString@icu_56@@QAECH@Z	
mov	eax, DWORD PTR _trailingCount$34193[ebp]
mov	ecx, DWORD PTR _trailingCount$34193[ebp]
sub	ecx, 1
mov	DWORD PTR _trailingCount$34193[ebp], ecx
test	eax, eax
jle	SHORT $LN31@appendToRu
mov	DWORD PTR tv166[ebp], 1
jmp	SHORT $LN32@appendToRu
mov	DWORD PTR tv166[ebp], 0
cmp	DWORD PTR tv166[ebp], 0
je	SHORT $LN26@appendToRu
push	39					
push	92					
mov	ecx, DWORD PTR _rule$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@_W@Z 
mov	ecx, eax
call	?append@UnicodeString@icu_56@@QAEAAV12@_W@Z 
jmp	SHORT $LN20@appendToRu
cmp	DWORD PTR _c$[ebp], -1
je	SHORT $LN18@appendToRu
cmp	DWORD PTR _c$[ebp], 32			
jne	SHORT $LN17@appendToRu
mov	ecx, DWORD PTR _rule$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _len$34204[ebp], eax
cmp	DWORD PTR _len$34204[ebp], 0
jle	SHORT $LN16@appendToRu
mov	eax, DWORD PTR _len$34204[ebp]
sub	eax, 1
push	eax
mov	ecx, DWORD PTR _rule$[ebp]
call	?charAt@UnicodeString@icu_56@@QBE_WH@Z	
...
je	SHORT $LN16@appendToRu
mov	eax, DWORD PTR _c$[ebp]
push	eax
mov	ecx, DWORD PTR _rule$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@H@Z 
jmp	SHORT $LN18@appendToRu
movsx	eax, BYTE PTR _escapeUnprintable$[ebp]
test	eax, eax
je	SHORT $LN13@appendToRu
mov	eax, DWORD PTR _c$[ebp]
push	eax
mov	ecx, DWORD PTR _rule$[ebp]
push	ecx
...
call	?length@UnicodeString@icu_56@@QBEHXZ	
test	eax, eax
jne	SHORT $LN11@appendToRu
cmp	DWORD PTR _c$[ebp], 39			
je	SHORT $LN10@appendToRu
...
mov	ecx, DWORD PTR _rule$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@H@Z 
jmp	SHORT $LN29@appendToRu
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
test	eax, eax
jg	SHORT $LN7@appendToRu
cmp	DWORD PTR _c$[ebp], 33			
jl	SHORT $LN6@appendToRu
cmp	DWORD PTR _c$[ebp], 126			
jg	SHORT $LN6@appendToRu
cmp	DWORD PTR _c$[ebp], 48			
jl	SHORT $LN4@appendToRu
cmp	DWORD PTR _c$[ebp], 57			
jle	SHORT $LN6@appendToRu
cmp	DWORD PTR _c$[ebp], 65			
jl	SHORT $LN3@appendToRu
cmp	DWORD PTR _c$[ebp], 90			
jle	SHORT $LN6@appendToRu
cmp	DWORD PTR _c$[ebp], 97			
jl	SHORT $LN7@appendToRu
...
movsx	ecx, al
test	ecx, ecx
je	SHORT $LN8@appendToRu
mov	eax, DWORD PTR _c$[ebp]
push	eax
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@H@Z 
cmp	DWORD PTR _c$[ebp], 39			
jne	SHORT $LN2@appendToRu
mov	eax, DWORD PTR _c$[ebp]
push	eax
mov	ecx, DWORD PTR _quoteBuf$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@H@Z 
...
ret	0
ENDP
?appendToRule@ICU_Utility@icu_56@@SAXAAVUnicodeString@2@ABV32@CC0@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
mov	eax, -858993460				
rep stosd
mov	DWORD PTR _i$34228[ebp], 0
jmp	SHORT $LN3@appendToRu@2
mov	eax, DWORD PTR _i$34228[ebp]
add	eax, 1
mov	DWORD PTR _i$34228[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
cmp	DWORD PTR _i$34228[ebp], eax
jge	SHORT $LN4@appendToRu@2
mov	eax, DWORD PTR _quoteBuf$[ebp]
push	eax
movzx	ecx, BYTE PTR _escapeUnprintable$[ebp]
push	ecx
movzx	edx, BYTE PTR _isLiteral$[ebp]
push	edx
mov	eax, DWORD PTR _i$34228[ebp]
push	eax
mov	ecx, DWORD PTR _text$[ebp]
...
push	edx
call	?appendToRule@ICU_Utility@icu_56@@SAXAAVUnicodeString@2@HCC0@Z 
add	esp, 20					
jmp	SHORT $LN2@appendToRu@2
pop	edi
pop	esi
pop	ebx
add	esp, 204				
...
ret	0
ENDP
?appendToRule@ICU_Utility@icu_56@@SAXAAVUnicodeString@2@PBVUnicodeMatcher@2@C0@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?appendToRule@ICU_Utility@icu_56@@SAXAAVUnicodeString@2@PBVUnicodeMatcher@2@C0@Z
...
cmp	DWORD PTR _matcher$[ebp], 0
je	SHORT $LN2@appendToRu@3
lea	ecx, DWORD PTR _pat$34239[ebp]
...
push	edx
lea	eax, DWORD PTR _pat$34239[ebp]
push	eax
...
mov	ecx, DWORD PTR _rule$[ebp]
push	ecx
call	?appendToRule@ICU_Utility@icu_56@@SAXAAVUnicodeString@2@ABV32@CC0@Z 
add	esp, 20					
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN8@appendToRu@3
...
DB	0
ENDP
__unwindfunclet$?appendToRule@ICU_Utility@icu_56@@SAXAAVUnicodeString@2@PBVUnicodeMatcher@2@C0@Z$0 PROC
lea	ecx, DWORD PTR _pat$34239[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ENDP
__ehhandler$?appendToRule@ICU_Utility@icu_56@@SAXAAVUnicodeString@2@PBVUnicodeMatcher@2@C0@Z PROC
