...
mov	eax, DWORD PTR $T44371[ebp]
or	eax, 1
mov	DWORD PTR $T44371[ebp], eax
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
ret	0
ENDP
_ucasemap_getBreakIterator_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
_ucasemap_setBreakIterator_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 220				
push	ebx
...
mov	eax, DWORD PTR _csm$[ebp]
mov	ecx, DWORD PTR [eax+4]
mov	DWORD PTR $T44516[ebp], ecx
mov	edx, DWORD PTR $T44516[ebp]
mov	DWORD PTR $T44515[ebp], edx
cmp	DWORD PTR $T44515[ebp], 0
je	SHORT $LN3@ucasemap_s
mov	esi, esp
push	1
...
jmp	SHORT $LN4@ucasemap_s
mov	DWORD PTR tv75[ebp], 0
mov	eax, DWORD PTR _csm$[ebp]
mov	ecx, DWORD PTR _iterToAdopt$[ebp]
mov	DWORD PTR [eax+4], ecx
pop	edi
pop	esi
pop	ebx
...
mov	eax, -858993460				
rep stosd
mov	DWORD PTR _utext$[ebp], 878368812	
mov	DWORD PTR _utext$[ebp+4], 0
mov	DWORD PTR _utext$[ebp+8], 0
mov	DWORD PTR _utext$[ebp+12], 112		
mov	DWORD PTR _utext$[ebp+16], 0
mov	DWORD PTR _utext$[ebp+20], 0
mov	DWORD PTR _utext$[ebp+24], 0
mov	DWORD PTR _utext$[ebp+28], 0
mov	DWORD PTR _utext$[ebp+32], 0
mov	DWORD PTR _utext$[ebp+36], 0
mov	DWORD PTR _utext$[ebp+40], 0
mov	DWORD PTR _utext$[ebp+44], 0
mov	DWORD PTR _utext$[ebp+48], 0
mov	DWORD PTR _utext$[ebp+52], 0
mov	DWORD PTR _utext$[ebp+56], 0
mov	DWORD PTR _utext$[ebp+60], 0
mov	DWORD PTR _utext$[ebp+64], 0
mov	DWORD PTR _utext$[ebp+68], 0
mov	DWORD PTR _utext$[ebp+72], 0
mov	DWORD PTR _utext$[ebp+76], 0
mov	DWORD PTR _utext$[ebp+80], 0
mov	DWORD PTR _utext$[ebp+84], 0
mov	DWORD PTR _utext$[ebp+88], 0
mov	DWORD PTR _utext$[ebp+92], 0
mov	DWORD PTR _utext$[ebp+96], 0
mov	DWORD PTR _utext$[ebp+100], 0
mov	DWORD PTR _utext$[ebp+104], 0
mov	DWORD PTR _utext$[ebp+108], 0
...
push	ecx
lea	edx, DWORD PTR _utext$[ebp]
push	edx
call	_utext_openUTF8_56
add	esp, 20					
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	ecx, DWORD PTR [eax]
push	ecx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN2@ucasemap_u
xor	eax, eax
jmp	SHORT $LN3@ucasemap_u
mov	eax, DWORD PTR _csm$[ebp]
cmp	DWORD PTR [eax+4], 0
jne	SHORT $LN1@ucasemap_u
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
push	0
push	0
...
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
lea	ecx, DWORD PTR _utext$[ebp]
push	ecx
mov	edx, DWORD PTR _csm$[ebp]
mov	eax, DWORD PTR [edx+4]
push	eax
call	_ubrk_setUText_56
add	esp, 12					
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
push	OFFSET _ucasemap_internalUTF8ToTitle_56
mov	ecx, DWORD PTR _srcLength$[ebp]
push	ecx
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN7@ucasemap_u
