...
mov	eax, DWORD PTR $T41809[ebp]
or	eax, 1
mov	DWORD PTR $T41809[ebp], eax
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
ret	0
ENDP
??4LocaleBased@icu_56@@QAEAAV01@ABV01@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
??0LocaleBased@icu_56@@QAE@PAD0@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
mov	DWORD PTR _this$[ebp], ecx
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _validAlias$[ebp]
mov	DWORD PTR [eax], ecx
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _actualAlias$[ebp]
mov	DWORD PTR [eax+4], ecx
mov	eax, DWORD PTR _this$[ebp]
pop	edi
pop	esi
...
ret	8
ENDP
??0LocaleBased@icu_56@@QAE@PBD0@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	8
ENDP
?getLocale@LocaleBased@icu_56@@QBE?AVLocale@2@W4ULocDataLocaleType@@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 232				
push	ebx
...
jmp	SHORT $LN4@getLocale
mov	DWORD PTR tv74[ebp], OFFSET ??_C@_00CNPNBAHC@?$AA@
push	0
push	0
push	0
...
mov	edx, DWORD PTR $T41933[ebp]
or	edx, 1
mov	DWORD PTR $T41933[ebp], edx
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
ret	12					
ENDP
?getLocaleID@LocaleBased@icu_56@@QBEPBDW4ULocDataLocaleType@@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 208				
push	ebx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN6@getLocaleI
xor	eax, eax
jmp	SHORT $LN7@getLocaleI
mov	eax, DWORD PTR _type$[ebp]
mov	DWORD PTR tv68[ebp], eax
cmp	DWORD PTR tv68[ebp], 0
je	SHORT $LN2@getLocaleI
cmp	DWORD PTR tv68[ebp], 1
je	SHORT $LN3@getLocaleI
jmp	SHORT $LN1@getLocaleI
mov	eax, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [eax]
jmp	SHORT $LN7@getLocaleI
mov	eax, DWORD PTR _this$[ebp]
...
ret	0
ENDP
?setLocaleIDs@LocaleBased@icu_56@@QAEXPBD0@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
pop	ecx
mov	DWORD PTR _this$[ebp], ecx
cmp	DWORD PTR _validID$[ebp], 0
je	SHORT $LN2@setLocaleI
push	1
mov	eax, DWORD PTR _validID$[ebp]
push	eax
call	_uprv_checkValidMemory
add	esp, 8
mov	esi, esp
push	157					
mov	ecx, DWORD PTR _validID$[ebp]
push	ecx
mov	edx, DWORD PTR _this$[ebp]
...
ret	8
ENDP
?setLocaleIDs@LocaleBased@icu_56@@QAEXABVLocale@2@0@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
