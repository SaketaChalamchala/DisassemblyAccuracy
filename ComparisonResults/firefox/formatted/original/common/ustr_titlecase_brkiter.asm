...
mov	eax, DWORD PTR $T44374[ebp]
or	eax, 1
mov	DWORD PTR $T44374[ebp], eax
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
mov	eax, DWORD PTR _src$[ebp]
push	eax
mov	ecx, DWORD PTR _csm$[ebp+4]
push	ecx
call	_ubrk_setText_56
add	esp, 16					
jmp	SHORT $LN2@u_strToTit
...
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
push	OFFSET _ustrcase_internalToTitle_56
mov	ecx, DWORD PTR _srcLength$[ebp]
push	ecx
mov	edx, DWORD PTR _src$[ebp]
push	edx
...
cmp	DWORD PTR _titleIter$[ebp], 0
jne	SHORT $LN1@u_strToTit
cmp	DWORD PTR _csm$[ebp+4], 0
je	SHORT $LN1@u_strToTit
mov	eax, DWORD PTR _csm$[ebp+4]
push	eax
call	_ubrk_close_56
add	esp, 4
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN8@u_strToTit
