...
ret	8
ENDP
?getScriptProps@?A0xa04f1960@@YAHW4UScriptCode@@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
jl	SHORT $LN2@getScriptP
cmp	DWORD PTR _script$[ebp], 167		
jge	SHORT $LN2@getScriptP
mov	eax, DWORD PTR _script$[ebp]
mov	eax, DWORD PTR _SCRIPT_PROPS[eax*4]
jmp	SHORT $LN3@getScriptP
jmp	SHORT $LN3@getScriptP
xor	eax, eax
pop	edi
pop	esi
...
ret	0
ENDP
_uscript_getSampleString_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 228				
push	ebx
...
jl	SHORT $LN6@uscript_ge
cmp	DWORD PTR _capacity$[ebp], 0
jle	SHORT $LN7@uscript_ge
cmp	DWORD PTR _dest$[ebp], 0
jne	SHORT $LN7@uscript_ge
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	$LN9@uscript_ge
...
add	esp, 4
and	eax, 2097151				
mov	DWORD PTR _sampleChar$[ebp], eax
jne	SHORT $LN5@uscript_ge
mov	DWORD PTR _length$[ebp], 0
jmp	$LN4@uscript_ge
mov	eax, 65535				
cmp	eax, DWORD PTR _sampleChar$[ebp]
sbb	ecx, ecx
neg	ecx
add	ecx, 1
...
jg	SHORT $LN4@uscript_ge
mov	DWORD PTR _i$36178[ebp], 0
cmp	DWORD PTR _sampleChar$[ebp], 65535	
ja	SHORT $LN2@uscript_ge
mov	eax, DWORD PTR _i$36178[ebp]
mov	ecx, DWORD PTR _dest$[ebp]
mov	dx, WORD PTR _sampleChar$[ebp]
mov	WORD PTR [ecx+eax*2], dx
mov	eax, DWORD PTR _i$36178[ebp]
add	eax, 1
mov	DWORD PTR _i$36178[ebp], eax
jmp	SHORT $LN4@uscript_ge
mov	eax, DWORD PTR _sampleChar$[ebp]
sar	eax, 10					
add	eax, 55232				
mov	ecx, DWORD PTR _i$36178[ebp]
...
ret	0
ENDP
?uscript_getSampleUnicodeString_56@@YA?AVUnicodeString@icu_56@@W4UScriptCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?uscript_getSampleUnicodeString_56@@YA?AVUnicodeString@icu_56@@W4UScriptCode@@@Z
...
mov	DWORD PTR $T43247[ebp], 0
lea	ecx, DWORD PTR _sample$[ebp]
...
mov	ecx, DWORD PTR $T43247[ebp]
or	ecx, 1
mov	DWORD PTR $T43247[ebp], ecx
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN10@uscript_ge@2
...
DB	0
ENDP
__unwindfunclet$?uscript_getSampleUnicodeString_56@@YA?AVUnicodeString@icu_56@@W4UScriptCode@@@Z$0 PROC
lea	ecx, DWORD PTR _sample$[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ENDP
__unwindfunclet$?uscript_getSampleUnicodeString_56@@YA?AVUnicodeString@icu_56@@W4UScriptCode@@@Z$1 PROC
mov	eax, DWORD PTR $T43247[ebp]
and	eax, 1
je	$LN6@uscript_ge@2
and	DWORD PTR $T43247[ebp], -2		
mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ret	0
ENDP
__ehhandler$?uscript_getSampleUnicodeString_56@@YA?AVUnicodeString@icu_56@@W4UScriptCode@@@Z PROC
...
ret	0
ENDP
_uscript_isRightToLeft_56 PROC				
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
_uscript_breaksBetweenLetters_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
