...
mov	ecx, DWORD PTR _this$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _len$35032[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _textLength$35033[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?isBogus@UnicodeString@icu_56@@QBECXZ	
movsx	eax, al
test	eax, eax
jne	SHORT $LN5@operator@2
mov	ecx, DWORD PTR _len$35032[ebp]
cmp	ecx, DWORD PTR _textLength$35033[ebp]
jne	SHORT $LN5@operator@2
mov	edx, DWORD PTR _len$35032[ebp]
push	edx
...
mov	eax, DWORD PTR $T78552[ebp]
or	eax, 1
mov	DWORD PTR $T78552[ebp], eax
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
mov	eax, DWORD PTR $T78661[ebp]
and	eax, 1
je	$LN5@normalize
and	DWORD PTR $T78661[ebp], -2		
mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ret	0
ENDP
...
mov	WORD PTR _c2$70445[ebp], dx
movzx	eax, WORD PTR _c2$70445[ebp]
and	eax, -1024				
cmp	eax, 55296				
...
mov	edx, DWORD PTR [ecx+36]
mov	DWORD PTR [eax+36], edx
mov	DWORD PTR _$S1$70514[ebp], 0
jmp	SHORT $LN3@operator@3
mov	eax, DWORD PTR _$S1$70514[ebp]
add	eax, 1
mov	DWORD PTR _$S1$70514[ebp], eax
cmp	DWORD PTR _$S1$70514[ebp], 384		
jae	SHORT $LN1@operator@3
mov	eax, DWORD PTR _this$[ebp]
add	eax, DWORD PTR _$S1$70514[ebp]
mov	ecx, DWORD PTR ___that$[ebp]
add	ecx, DWORD PTR _$S1$70514[ebp]
...
ret	0
ENDP
_unorm_quickCheckWithOptions_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 236				
push	ebx
...
mov	ecx, DWORD PTR _n2$[ebp]
push	ecx
lea	ecx, DWORD PTR _fn2$71182[ebp]
...
mov	edx, DWORD PTR _src$[ebp]
push	edx
lea	eax, DWORD PTR _fn2$71182[ebp]
push	eax
call	_unorm2_quickCheck_56
add	esp, 16					
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN7@unorm_quic
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
ret	0
ENDP
_unorm_isNormalizedWithOptions_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 236				
push	ebx
...
mov	ecx, DWORD PTR _n2$[ebp]
push	ecx
lea	ecx, DWORD PTR _fn2$71205[ebp]
call	??0FilteredNormalizer2@icu_56@@QAE@ABVNormalizer2@1@ABVUnicodeSet@1@@Z 
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
mov	ecx, DWORD PTR _srcLength$[ebp]
...
mov	edx, DWORD PTR _src$[ebp]
push	edx
lea	eax, DWORD PTR _fn2$71205[ebp]
push	eax
call	_unorm2_isNormalized_56
add	esp, 16					
mov	BYTE PTR $T78883[ebp], al
lea	ecx, DWORD PTR _fn2$71205[ebp]
call	??1FilteredNormalizer2@icu_56@@UAE@XZ	
mov	al, BYTE PTR $T78883[ebp]
jmp	SHORT $LN3@unorm_isNo
jmp	SHORT $LN3@unorm_isNo
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
mov	ecx, DWORD PTR _srcLength$[ebp]
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN7@unorm_isNo
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
mov	ecx, DWORD PTR _n2$[ebp]
push	ecx
lea	ecx, DWORD PTR _fn2$71222[ebp]
call	??0FilteredNormalizer2@icu_56@@QAE@ABVNormalizer2@1@ABVUnicodeSet@1@@Z 
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
...
push	ecx
lea	edx, DWORD PTR _fn2$71222[ebp]
push	edx
call	_unorm2_normalize_56
add	esp, 24					
mov	DWORD PTR $T78889[ebp], eax
lea	ecx, DWORD PTR _fn2$71222[ebp]
call	??1FilteredNormalizer2@icu_56@@UAE@XZ	
mov	eax, DWORD PTR $T78889[ebp]
jmp	SHORT $LN3@unorm_norm
jmp	SHORT $LN3@unorm_norm
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
mov	ecx, DWORD PTR _destCapacity$[ebp]
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN7@unorm_norm
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
mov	ecx, DWORD PTR _pNeededToNormalize$[ebp]
push	ecx
...
ret	0
ENDP
?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z
mov	eax, DWORD PTR fs:0
push	eax
sub	esp, 248				
push	ebx
...
call	_uniset_getUnicode32Instance_56
add	esp, 4
mov	DWORD PTR _uni32$71277[ebp], eax
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	ecx, DWORD PTR [eax]
push	ecx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN1@unorm_iter
xor	eax, eax
jmp	$LN3@unorm_iter
mov	eax, DWORD PTR _uni32$71277[ebp]
push	eax
mov	ecx, DWORD PTR _n2$[ebp]
push	ecx
lea	ecx, DWORD PTR _fn2$71279[ebp]
call	??0FilteredNormalizer2@icu_56@@QAE@ABVNormalizer2@1@ABVUnicodeSet@1@@Z 
mov	DWORD PTR __$EHRec$[ebp+8], 0
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
...
movzx	edx, BYTE PTR _doNormalize$[ebp]
push	edx
lea	eax, DWORD PTR _fn2$71279[ebp]
push	eax
mov	ecx, DWORD PTR _destCapacity$[ebp]
push	ecx
mov	edx, DWORD PTR _dest$[ebp]
...
add	esp, 32					
mov	DWORD PTR $T78897[ebp], eax
mov	DWORD PTR __$EHRec$[ebp+8], -1
lea	ecx, DWORD PTR _fn2$71279[ebp]
call	??1FilteredNormalizer2@icu_56@@UAE@XZ	
mov	eax, DWORD PTR $T78897[ebp]
jmp	SHORT $LN3@unorm_iter
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
mov	ecx, DWORD PTR _pNeededToNormalize$[ebp]
push	ecx
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN9@unorm_iter
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
mov	ecx, DWORD PTR __$EHRec$[ebp]
...
DB	0
ENDP
__unwindfunclet$?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z$0 PROC
lea	ecx, DWORD PTR _fn2$71279[ebp]
jmp	??1FilteredNormalizer2@icu_56@@UAE@XZ	
ENDP
__ehhandler$?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ret	0
ENDP
?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z
mov	eax, DWORD PTR fs:0
push	eax
sub	esp, 380				
push	ebx
...
jl	SHORT $LN16@iterate
cmp	DWORD PTR _dest$[ebp], 0
jne	SHORT $LN15@iterate
cmp	DWORD PTR _destCapacity$[ebp], 0
jg	SHORT $LN16@iterate
cmp	DWORD PTR _src$[ebp], 0
jne	SHORT $LN17@iterate
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	$LN19@iterate
cmp	DWORD PTR _pNeededToNormalize$[ebp], 0
je	SHORT $LN14@iterate
mov	eax, DWORD PTR _pNeededToNormalize$[ebp]
mov	BYTE PTR [eax], 0
movsx	eax, BYTE PTR _forward$[ebp]
test	eax, eax
je	SHORT $LN21@iterate
mov	esi, esp
mov	ecx, DWORD PTR _src$[ebp]
push	ecx
mov	edx, DWORD PTR _src$[ebp]
...
call	__RTC_CheckEsp
mov	BYTE PTR tv81[ebp], al
movsx	ecx, BYTE PTR tv81[ebp]
test	ecx, ecx
jne	SHORT $LN13@iterate
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
push	0
mov	ecx, DWORD PTR _destCapacity$[ebp]
...
cmp	esi, esp
call	__RTC_CheckEsp
jmp	SHORT $LN10@iterate
jmp	SHORT $LN8@iterate
mov	eax, DWORD PTR _c$[ebp]
push	eax
lea	ecx, DWORD PTR _buffer$[ebp]
call	?append@UnicodeString@icu_56@@QAEAAV12@H@Z 
jmp	SHORT $LN11@iterate
jmp	SHORT $LN7@iterate
mov	eax, DWORD PTR _src$[ebp]
push	eax
...
jmp	SHORT $LN19@iterate
jmp	SHORT $LN1@iterate
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
mov	ecx, DWORD PTR _destCapacity$[ebp]
push	ecx
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN29@iterate
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
mov	ecx, DWORD PTR __$EHRec$[ebp]
...
DB	0
ENDP
__unwindfunclet$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z$0 PROC
lea	ecx, DWORD PTR _buffer$[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ENDP
__unwindfunclet$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z$1 PROC
lea	ecx, DWORD PTR _destString$[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ENDP
__ehhandler$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
mov	eax, DWORD PTR _options$[ebp]
and	eax, 32					
je	SHORT $LN2@unorm_conc
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
call	_uniset_getUnicode32Instance_56
add	esp, 4
mov	DWORD PTR _uni32$71336[ebp], eax
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	ecx, DWORD PTR [eax]
push	ecx
call	?U_FAILURE@@YACW4UErrorCode@@@Z		
...
movsx	edx, al
test	edx, edx
je	SHORT $LN1@unorm_conc
xor	eax, eax
jmp	SHORT $LN3@unorm_conc
mov	eax, DWORD PTR _uni32$71336[ebp]
push	eax
mov	ecx, DWORD PTR _n2$[ebp]
push	ecx
lea	ecx, DWORD PTR _fn2$71338[ebp]
call	??0FilteredNormalizer2@icu_56@@QAE@ABVNormalizer2@1@ABVUnicodeSet@1@@Z 
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
lea	ecx, DWORD PTR _fn2$71338[ebp]
...
add	esp, 32					
mov	DWORD PTR $T78935[ebp], eax
lea	ecx, DWORD PTR _fn2$71338[ebp]
call	??1FilteredNormalizer2@icu_56@@UAE@XZ	
mov	eax, DWORD PTR $T78935[ebp]
jmp	SHORT $LN3@unorm_conc
mov	eax, DWORD PTR _pErrorCode$[ebp]
push	eax
mov	ecx, DWORD PTR _n2$[ebp]
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN7@unorm_conc
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
DB	0
ENDP
?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z
mov	eax, DWORD PTR fs:0
push	eax
sub	esp, 360				
push	ebx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN9@concatenat
xor	eax, eax
jmp	$LN10@concatenat
cmp	DWORD PTR _destCapacity$[ebp], 0
jl	SHORT $LN7@concatenat
cmp	DWORD PTR _dest$[ebp], 0
jne	SHORT $LN6@concatenat
cmp	DWORD PTR _destCapacity$[ebp], 0
jg	SHORT $LN7@concatenat
cmp	DWORD PTR _left$[ebp], 0
je	SHORT $LN7@concatenat
cmp	DWORD PTR _leftLength$[ebp], -1
jl	SHORT $LN7@concatenat
cmp	DWORD PTR _right$[ebp], 0
je	SHORT $LN7@concatenat
cmp	DWORD PTR _rightLength$[ebp], -1
jge	SHORT $LN8@concatenat
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	$LN10@concatenat
cmp	DWORD PTR _dest$[ebp], 0
je	SHORT $LN5@concatenat
mov	eax, DWORD PTR _right$[ebp]
cmp	eax, DWORD PTR _dest$[ebp]
jb	SHORT $LN3@concatenat
mov	eax, DWORD PTR _destCapacity$[ebp]
mov	ecx, DWORD PTR _dest$[ebp]
lea	edx, DWORD PTR [ecx+eax*2]
cmp	DWORD PTR _right$[ebp], edx
jb	SHORT $LN4@concatenat
cmp	DWORD PTR _rightLength$[ebp], 0
jle	SHORT $LN5@concatenat
mov	eax, DWORD PTR _dest$[ebp]
cmp	eax, DWORD PTR _right$[ebp]
jb	SHORT $LN5@concatenat
mov	eax, DWORD PTR _rightLength$[ebp]
mov	ecx, DWORD PTR _right$[ebp]
lea	edx, DWORD PTR [ecx+eax*2]
cmp	DWORD PTR _dest$[ebp], edx
jae	SHORT $LN5@concatenat
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	$LN10@concatenat
...
lea	ecx, DWORD PTR _destString$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T78942[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN17@concatenat
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
mov	ecx, DWORD PTR __$EHRec$[ebp]
...
DB	0
ENDP
__unwindfunclet$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z$0 PROC
lea	ecx, DWORD PTR _destString$[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ENDP
__unwindfunclet$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z$1 PROC
lea	ecx, DWORD PTR $T71321[ebp]
jmp	??1UnicodeString@icu_56@@UAE@XZ		
ENDP
__ehhandler$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
