...
mov	eax, DWORD PTR $T41426[ebp]
or	eax, 1
mov	DWORD PTR $T41426[ebp], eax
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
ret	8
ENDP
??4PluralMapBase@icu_56@@QAEAAV01@ABV01@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
?toCategory@PluralMapBase@icu_56@@SA?AW4Category@12@PBD@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
mov	eax, -858993460				
rep stosd
mov	DWORD PTR _i$34367[ebp], 0
jmp	SHORT $LN4@toCategory
mov	eax, DWORD PTR _i$34367[ebp]
add	eax, 1
mov	DWORD PTR _i$34367[ebp], eax
cmp	DWORD PTR _i$34367[ebp], 6
jge	SHORT $LN2@toCategory
mov	eax, DWORD PTR _i$34367[ebp]
...
add	esp, 8
test	eax, eax
jne	SHORT $LN1@toCategory
mov	eax, DWORD PTR _i$34367[ebp]
jmp	SHORT $LN5@toCategory
jmp	SHORT $LN3@toCategory
or	eax, -1
pop	edi
pop	esi
pop	ebx
...
ret	0
ENDP
?toCategory@PluralMapBase@icu_56@@SA?AW4Category@12@ABVUnicodeString@2@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?toCategory@PluralMapBase@icu_56@@SA?AW4Category@12@ABVUnicodeString@2@@Z
mov	eax, DWORD PTR fs:0
push	eax
sub	esp, 288				
push	ebx
...
lea	eax, DWORD PTR __$EHRec$[ebp]
mov	DWORD PTR fs:0, eax
lea	ecx, DWORD PTR _cCategory$[ebp]
call	??0CharString@icu_56@@QAE@XZ		
mov	DWORD PTR __$EHRec$[ebp+8], 0
mov	DWORD PTR _status$[ebp], 0
lea	eax, DWORD PTR _status$[ebp]
push	eax
mov	ecx, DWORD PTR _pluralForm$[ebp]
push	ecx
lea	ecx, DWORD PTR _cCategory$[ebp]
...
movsx	ecx, al
test	ecx, ecx
je	SHORT $LN3@toCategory@2
mov	DWORD PTR tv78[ebp], -1
jmp	SHORT $LN4@toCategory@2
lea	ecx, DWORD PTR _cCategory$[ebp]
...
mov	DWORD PTR $T41573[ebp], edx
mov	DWORD PTR __$EHRec$[ebp+8], -1
lea	ecx, DWORD PTR _cCategory$[ebp]
call	??1CharString@icu_56@@QAE@XZ		
mov	eax, DWORD PTR $T41573[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN10@toCategory@2
...
DB	0
ENDP
__unwindfunclet$?toCategory@PluralMapBase@icu_56@@SA?AW4Category@12@ABVUnicodeString@2@@Z$0 PROC
lea	ecx, DWORD PTR _cCategory$[ebp]
jmp	??1CharString@icu_56@@QAE@XZ		
ENDP
__ehhandler$?toCategory@PluralMapBase@icu_56@@SA?AW4Category@12@ABVUnicodeString@2@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ret	0
ENDP
?getCategoryName@PluralMapBase@icu_56@@SAPBDW4Category@12@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 208				
push	ebx
...
jl	SHORT $LN3@getCategor
cmp	DWORD PTR _index$[ebp], 6
jge	SHORT $LN3@getCategor
mov	eax, DWORD PTR _index$[ebp]
mov	ecx, DWORD PTR _gPluralForms[eax*4]
...
add	esp, 4
mov	DWORD PTR _p$38487[ebp], eax
cmp	DWORD PTR _p$38487[ebp], 0
je	SHORT $LN5@resize
...
mov	ecx, DWORD PTR [eax]
push	ecx
mov	edx, DWORD PTR _p$38487[ebp]
push	edx
call	_memcpy
add	esp, 12					
mov	ecx, DWORD PTR _this$[ebp]
call	?releaseArray@?$MaybeStackArray@D$0CI@@icu_56@@AAEXXZ 
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _p$38487[ebp]
mov	DWORD PTR [eax], ecx
mov	eax, DWORD PTR _this$[ebp]
...
mov	eax, DWORD PTR _p$38487[ebp]
