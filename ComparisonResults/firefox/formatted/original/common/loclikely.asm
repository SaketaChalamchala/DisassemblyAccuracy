...
ret	0
ENDP
_uloc_addLikelySubtags_56 PROC				
push	ebp
mov	ebp, esp
sub	esp, 364				
push	ebx
...
DB	0
ENDP
?_uloc_addLikelySubtags@@YAHPBDPADHPAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 368				
push	ebx
...
xor	eax, ebp
mov	DWORD PTR __$ArrayPad$[ebp], eax
mov	DWORD PTR _langLength$[ebp], 12		
...
ret	0
ENDP
?parseTagString@@YAHPBDPADPAH1212PAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
DB	0
ENDP
?createLikelySubtagsString@@YAHPBDH0H0H0HPADHPAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 580				
push	ebx
...
DB	0
ENDP
?findLikelySubtags@@YAPBDPBDPADHPAW4UErrorCode@@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 252				
push	ebx
...
ret	0
ENDP
?createTagStringWithAlternates@@YAHPBDH0H0H0H0PADHPAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 512				
push	ebx
...
cmp	DWORD PTR _langLength$[ebp], 12		
...
add	esp, 16					
jmp	$LN31@createTagS
mov	DWORD PTR _alternateLangLength$37155[ebp], 12 
mov	eax, DWORD PTR _err$[ebp]
push	eax
...
cmp	DWORD PTR _alternateLangLength$37155[ebp], 12 
...
DB	0
ENDP
?appendTag@@YAXPBDHPADPAH@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
?createTagString@@YAHPBDH0H0H0HPADHPAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
?do_canonicalize@@YACPBDPADHPAW4UErrorCode@@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
DB	0
ENDP
?_uloc_minimizeSubtags@@YAHPBDPADHPAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 1076				
push	ebx
...
xor	eax, ebp
mov	DWORD PTR __$ArrayPad$[ebp], eax
mov	DWORD PTR _maximizedTagBufferLength$[ebp], 157 
mov	DWORD PTR _langLength$[ebp], 12		
mov	DWORD PTR _scriptLength$[ebp], 6
mov	DWORD PTR _regionLength$[ebp], 4
mov	DWORD PTR _trailing$[ebp], OFFSET ??_C@_00CNPNBAHC@?$AA@
...
cmp	DWORD PTR _errorCode$[ebp], -124	
...
cmp	BYTE PTR tv92[ebp], 43			
je	SHORT $LN6@uloc_isRig
cmp	BYTE PTR tv92[ebp], 45			
...
DB	0
ENDP
?isRightToLeft@Locale@icu_56@@QBECXZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
