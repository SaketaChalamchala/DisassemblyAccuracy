...
ret	0
ENDP
?copyFrom@CharString@icu_56@@QAEAAV12@ABV12@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
?lastIndexOf@CharString@icu_56@@QBEHD@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax+52]
mov	DWORD PTR _i$34317[ebp], ecx
cmp	DWORD PTR _i$34317[ebp], 0
jle	SHORT $LN2@lastIndexO@2
mov	eax, DWORD PTR _i$34317[ebp]
sub	eax, 1
mov	DWORD PTR _i$34317[ebp], eax
mov	ecx, DWORD PTR _i$34317[ebp]
push	ecx
mov	ecx, DWORD PTR _this$[ebp]
call	??A?$MaybeStackArray@D$0CI@@icu_56@@QBEABDH@Z 
...
cmp	edx, eax
jne	SHORT $LN1@lastIndexO@2
mov	eax, DWORD PTR _i$34317[ebp]
jmp	SHORT $LN4@lastIndexO@2
jmp	SHORT $LN3@lastIndexO@2
or	eax, -1
pop	edi
pop	esi
pop	ebx
...
ret	4
ENDP
?truncate@CharString@icu_56@@QAEAAV12@H@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
pop	ecx
mov	DWORD PTR _this$[ebp], ecx
cmp	DWORD PTR _newLength$[ebp], 0
jge	SHORT $LN2@truncate@2
mov	DWORD PTR _newLength$[ebp], 0
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _newLength$[ebp]
cmp	ecx, DWORD PTR [eax+52]
jge	SHORT $LN1@truncate@2
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _newLength$[ebp]
...
ret	4
ENDP
?append@CharString@icu_56@@QAEAAV12@DAAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 208				
push	ebx
...
ret	8
ENDP
?append@CharString@icu_56@@QAEAAV12@PBDHAAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?append@CharString@icu_56@@QAEAAV12@PBDHAAW4UErrorCode@@@Z
mov	eax, DWORD PTR fs:0
push	eax
sub	esp, 292				
push	ebx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN12@append@2
mov	eax, DWORD PTR _this$[ebp]
jmp	$LN13@append@2
cmp	DWORD PTR _sLength$[ebp], -1
jl	SHORT $LN10@append@2
cmp	DWORD PTR _s$[ebp], 0
jne	SHORT $LN11@append@2
cmp	DWORD PTR _sLength$[ebp], 0
je	SHORT $LN11@append@2
mov	eax, DWORD PTR _errorCode$[ebp]
mov	DWORD PTR [eax], 1
mov	eax, DWORD PTR _this$[ebp]
jmp	$LN13@append@2
cmp	DWORD PTR _sLength$[ebp], 0
jge	SHORT $LN9@append@2
...
mov	eax, DWORD PTR $T41597[ebp]
jmp	$LN13@append@2
jmp	SHORT $LN8@append@2
mov	eax, DWORD PTR _errorCode$[ebp]
push	eax
push	0
mov	ecx, DWORD PTR _this$[ebp]
...
ret	12					
ENDP
__unwindfunclet$?append@CharString@icu_56@@QAEAAV12@PBDHAAW4UErrorCode@@@Z$0 PROC
lea	ecx, DWORD PTR $T34350[ebp]
jmp	??1CharString@icu_56@@QAE@XZ		
ENDP
__ehhandler$?append@CharString@icu_56@@QAEAAV12@PBDHAAW4UErrorCode@@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ret	0
ENDP
?getAppendBuffer@CharString@icu_56@@QAEPADHHAAHAAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+52]
mov	eax, DWORD PTR _desiredCapacityHint$[ebp]
lea	ecx, DWORD PTR [edx+eax+1]
push	ecx
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+52]
mov	ecx, DWORD PTR _minCapacity$[ebp]
...
ret	16					
ENDP
?appendInvariantChars@CharString@icu_56@@QAEAAV12@ABVUnicodeString@2@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
movsx	ecx, al
test	ecx, ecx
jne	SHORT $LN2@appendInva
mov	eax, DWORD PTR _errorCode$[ebp]
mov	DWORD PTR [eax], 26			
mov	eax, DWORD PTR _this$[ebp]
jmp	SHORT $LN4@appendInva
mov	eax, DWORD PTR _errorCode$[ebp]
push	eax
push	0
mov	ecx, DWORD PTR _s$[ebp]
...
ret	8
ENDP
?ensureCapacity@CharString@icu_56@@AAECHHAAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
mov	ecx, DWORD PTR _this$[ebp]
call	?getCapacity@?$MaybeStackArray@D$0CI@@icu_56@@QBEHXZ 
cmp	DWORD PTR _capacity$[ebp], eax
jle	SHORT $LN4@ensureCapa
cmp	DWORD PTR _desiredCapacityHint$[ebp], 0
jne	SHORT $LN3@ensureCapa
mov	ecx, DWORD PTR _this$[ebp]
call	?getCapacity@?$MaybeStackArray@D$0CI@@icu_56@@QBEHXZ 
add	eax, DWORD PTR _capacity$[ebp]
mov	DWORD PTR _desiredCapacityHint$[ebp], eax
mov	eax, DWORD PTR _desiredCapacityHint$[ebp]
cmp	eax, DWORD PTR _capacity$[ebp]
jle	SHORT $LN1@ensureCapa
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax+52]
add	ecx, 1
push	ecx
mov	edx, DWORD PTR _desiredCapacityHint$[ebp]
push	edx
mov	ecx, DWORD PTR _this$[ebp]
...
ret	12					
ENDP
?appendPathPart@CharString@icu_56@@QAEAAV12@ABVStringPiece@2@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN3@appendPath
mov	eax, DWORD PTR _this$[ebp]
jmp	SHORT $LN4@appendPath
mov	ecx, DWORD PTR _s$[ebp]
call	?length@StringPiece@icu_56@@QBEHXZ	
test	eax, eax
jne	SHORT $LN2@appendPath
mov	eax, DWORD PTR _this$[ebp]
jmp	SHORT $LN4@appendPath
mov	eax, DWORD PTR _this$[ebp]
cmp	DWORD PTR [eax+52], 0
jle	SHORT $LN1@appendPath
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax+52]
sub	ecx, 1
push	ecx
...
ret	8
ENDP
?ensureEndsWithFileSeparator@CharString@icu_56@@QAEAAV12@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN1@ensureEnds
mov	eax, DWORD PTR _this$[ebp]
cmp	DWORD PTR [eax+52], 0
jle	SHORT $LN1@ensureEnds
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax+52]
sub	ecx, 1
push	ecx
...
add	esp, 4
mov	DWORD PTR _p$38501[ebp], eax
cmp	DWORD PTR _p$38501[ebp], 0
je	SHORT $LN5@resize
...
mov	ecx, DWORD PTR [eax]
push	ecx
mov	edx, DWORD PTR _p$38501[ebp]
push	edx
call	_memcpy
add	esp, 12					
mov	ecx, DWORD PTR _this$[ebp]
call	?releaseArray@?$MaybeStackArray@D$0CI@@icu_56@@AAEXXZ 
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _p$38501[ebp]
mov	DWORD PTR [eax], ecx
mov	eax, DWORD PTR _this$[ebp]
...
mov	eax, DWORD PTR _p$38501[ebp]
