...
ret	4
ENDP
_uloc_getTableStringWithFallback_56 PROC		
push	ebp
mov	ebp, esp
sub	esp, 756				
push	ebx
...
mov	BYTE PTR _explicitFallbackName$[ebp], 0
push	156					
push	0
lea	eax, DWORD PTR _explicitFallbackName$[ebp+1]
push	eax
call	_memset
add	esp, 12					
...
movsx	ecx, al
test	ecx, ecx
je	SHORT $LN20@uloc_getTa
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	ecx, DWORD PTR _errorCode$[ebp]
mov	DWORD PTR [eax], ecx
xor	eax, eax
jmp	$LN21@uloc_getTa
jmp	SHORT $LN16@uloc_getTa
cmp	DWORD PTR _errorCode$[ebp], -127	
je	SHORT $LN17@uloc_getTa
cmp	DWORD PTR _errorCode$[ebp], -128	
jne	SHORT $LN16@uloc_getTa
mov	eax, DWORD PTR _pErrorCode$[ebp]
cmp	DWORD PTR [eax], -127			
je	SHORT $LN16@uloc_getTa
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	ecx, DWORD PTR _errorCode$[ebp]
mov	DWORD PTR [eax], ecx
...
add	esp, 4
lea	eax, DWORD PTR _subTable$[ebp]
push	eax
call	_ures_initStackObject_56
add	esp, 4
lea	eax, DWORD PTR _errorCode$[ebp]
...
add	esp, 16					
cmp	DWORD PTR _subTableKey$[ebp], 0
je	SHORT $LN14@uloc_getTa
lea	eax, DWORD PTR _errorCode$[ebp]
push	eax
lea	ecx, DWORD PTR _table$[ebp]
push	ecx
mov	edx, DWORD PTR _subTableKey$[ebp]
push	edx
lea	eax, DWORD PTR _table$[ebp]
push	eax
call	_ures_getByKeyWithFallback_56
...
test	ecx, ecx
je	$LN12@uloc_getTa
mov	DWORD PTR _replacement$35513[ebp], 0
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	ecx, DWORD PTR _errorCode$[ebp]
mov	DWORD PTR [eax], ecx
mov	DWORD PTR _errorCode$[ebp], 0
...
add	esp, 8
test	eax, eax
jne	SHORT $LN11@uloc_getTa
mov	eax, DWORD PTR _itemKey$[ebp]
push	eax
call	_uloc_getCurrentCountryID_56
add	esp, 4
mov	DWORD PTR _replacement$35513[ebp], eax
jmp	SHORT $LN10@uloc_getTa
...
add	esp, 8
test	eax, eax
jne	SHORT $LN10@uloc_getTa
mov	eax, DWORD PTR _itemKey$[ebp]
push	eax
call	_uloc_getCurrentLanguageID_56
add	esp, 4
mov	DWORD PTR _replacement$35513[ebp], eax
cmp	DWORD PTR _replacement$35513[ebp], 0
je	SHORT $LN8@uloc_getTa
mov	eax, DWORD PTR _itemKey$[ebp]
cmp	eax, DWORD PTR _replacement$35513[ebp]
je	SHORT $LN8@uloc_getTa
lea	eax, DWORD PTR _errorCode$[ebp]
push	eax
mov	ecx, DWORD PTR _pLength$[ebp]
push	ecx
mov	edx, DWORD PTR _replacement$35513[ebp]
push	edx
lea	eax, DWORD PTR _table$[ebp]
push	eax
call	_ures_getStringByKeyWithFallback_56
...
test	ecx, ecx
je	$LN5@uloc_getTa
mov	DWORD PTR _len$35523[ebp], 0
mov	DWORD PTR _fallbackLocale$35524[ebp], 0
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	ecx, DWORD PTR _errorCode$[ebp]
mov	DWORD PTR [eax], ecx
mov	DWORD PTR _errorCode$[ebp], 0
lea	eax, DWORD PTR _errorCode$[ebp]
push	eax
lea	ecx, DWORD PTR _len$35523[ebp]
push	ecx
push	OFFSET ??_C@_08DHOPKLBH@Fallback?$AA@
lea	edx, DWORD PTR _table$[ebp]
push	edx
call	_ures_getStringByKeyWithFallback_56
add	esp, 16					
mov	DWORD PTR _fallbackLocale$35524[ebp], eax
mov	eax, DWORD PTR _errorCode$[ebp]
push	eax
call	?U_FAILURE@@YACW4UErrorCode@@@Z		
add	esp, 4
movsx	ecx, al
test	ecx, ecx
je	SHORT $LN4@uloc_getTa
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	ecx, DWORD PTR _errorCode$[ebp]
mov	DWORD PTR [eax], ecx
jmp	$LN15@uloc_getTa
mov	eax, DWORD PTR _len$35523[ebp]
push	eax
lea	ecx, DWORD PTR _explicitFallbackName$[ebp]
push	ecx
mov	edx, DWORD PTR _fallbackLocale$35524[ebp]
push	edx
...
add	esp, 8
test	eax, eax
jne	SHORT $LN3@uloc_getTa
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	DWORD PTR [eax], 5
jmp	SHORT $LN15@uloc_getTa
mov	eax, DWORD PTR _rb$[ebp]
push	eax
call	_ures_close_56
add	esp, 4
...
movsx	ecx, al
test	ecx, ecx
je	SHORT $LN2@uloc_getTa
mov	eax, DWORD PTR _pErrorCode$[ebp]
mov	ecx, DWORD PTR _errorCode$[ebp]
mov	DWORD PTR [eax], ecx
jmp	SHORT $LN15@uloc_getTa
jmp	SHORT $LN1@uloc_getTa
jmp	SHORT $LN15@uloc_getTa
jmp	$LN16@uloc_getTa
lea	eax, DWORD PTR _subTable$[ebp]
push	eax
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN29@uloc_getTa
...
ret	0
ENDP
_uloc_getCharacterOrientation_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
push	eax
push	OFFSET ??_C@_0L@MKHPBEDE@characters?$AA@
mov	ecx, DWORD PTR _localeId$[ebp]
push	ecx
call	?_uloc_getOrientationHelper@@YA?AW4ULayoutType@@PBD0PAW4UErrorCode@@@Z 
add	esp, 12					
pop	edi
pop	esi
pop	ebx
...
ret	0
ENDP
?_uloc_getOrientationHelper@@YA?AW4ULayoutType@@PBD0PAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 404				
push	ebx
...
test	edx, edx
jne	$LN10@uloc_getOr
mov	DWORD PTR _length$35537[ebp], 0
mov	eax, DWORD PTR _status$[ebp]
push	eax
push	157					
lea	ecx, DWORD PTR _localeBuffer$35538[ebp]
push	ecx
...
mov	eax, DWORD PTR _status$[ebp]
push	eax
lea	ecx, DWORD PTR _length$35537[ebp]
push	ecx
mov	edx, DWORD PTR _key$[ebp]
push	edx
push	0
push	OFFSET ??_C@_06GDMDKJEN@layout?$AA@
lea	eax, DWORD PTR _localeBuffer$35538[ebp]
push	eax
push	0
call	_uloc_getTableStringWithFallback_56
add	esp, 28					
mov	DWORD PTR _value$35540[ebp], eax
mov	eax, DWORD PTR _status$[ebp]
mov	ecx, DWORD PTR [eax]
push	ecx
call	?U_FAILURE@@YACW4UErrorCode@@@Z		
...
movsx	edx, al
test	edx, edx
jne	SHORT $LN10@uloc_getOr
cmp	DWORD PTR _length$35537[ebp], 0
je	SHORT $LN10@uloc_getOr
mov	eax, DWORD PTR _value$35540[ebp]
movzx	ecx, WORD PTR [eax]
mov	DWORD PTR tv90[ebp], ecx
mov	edx, DWORD PTR tv90[ebp]
sub	edx, 98					
mov	DWORD PTR tv90[ebp], edx
cmp	DWORD PTR tv90[ebp], 18			
ja	SHORT $LN1@uloc_getOr
mov	eax, DWORD PTR tv90[ebp]
movzx	ecx, BYTE PTR $LN13@uloc_getOr[eax]
jmp	DWORD PTR $LN18@uloc_getOr[ecx*4]
mov	DWORD PTR _result$[ebp], 3
jmp	SHORT $LN10@uloc_getOr
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN17@uloc_getOr
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
DB	3
ENDP
_uloc_getLineOrientation_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
mov	eax, DWORD PTR _status$[ebp]
push	eax
push	OFFSET ??_C@_05DENOCHIP@lines?$AA@
mov	ecx, DWORD PTR _localeId$[ebp]
push	ecx
call	?_uloc_getOrientationHelper@@YA?AW4ULayoutType@@PBD0PAW4UErrorCode@@@Z 
add	esp, 12					
