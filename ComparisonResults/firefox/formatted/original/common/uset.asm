...
mov	eax, DWORD PTR $T43451[ebp]
or	eax, 1
mov	DWORD PTR $T43451[ebp], eax
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
add	esp, 4
mov	DWORD PTR $T43585[ebp], eax
cmp	DWORD PTR $T43585[ebp], 0
je	SHORT $LN3@uset_openE
mov	ecx, DWORD PTR $T43585[ebp]
call	??0UnicodeSet@icu_56@@QAE@XZ		
mov	DWORD PTR tv71[ebp], eax
jmp	SHORT $LN4@uset_openE
mov	DWORD PTR tv71[ebp], 0
mov	eax, DWORD PTR tv71[ebp]
mov	DWORD PTR $T43584[ebp], eax
mov	eax, DWORD PTR $T43584[ebp]
pop	edi
pop	esi
pop	ebx
add	esp, 220				
...
call	??2UMemory@icu_56@@SAPAXI@Z		
add	esp, 4
mov	DWORD PTR $T43591[ebp], eax
cmp	DWORD PTR $T43591[ebp], 0
je	SHORT $LN3@uset_open_
mov	eax, DWORD PTR _end$[ebp]
push	eax
mov	ecx, DWORD PTR _start$[ebp]
push	ecx
mov	ecx, DWORD PTR $T43591[ebp]
call	??0UnicodeSet@icu_56@@QAE@HH@Z		
mov	DWORD PTR tv73[ebp], eax
jmp	SHORT $LN4@uset_open_
mov	DWORD PTR tv73[ebp], 0
mov	edx, DWORD PTR tv73[ebp]
mov	DWORD PTR $T43590[ebp], edx
mov	eax, DWORD PTR $T43590[ebp]
pop	edi
pop	esi
pop	ebx
add	esp, 220				
...
mov	DWORD PTR $T43597[ebp], eax
mov	ecx, DWORD PTR $T43597[ebp]
mov	DWORD PTR $T43596[ebp], ecx
cmp	DWORD PTR $T43596[ebp], 0
je	SHORT $LN3@uset_close
mov	esi, esp
push	1
mov	edx, DWORD PTR $T43596[ebp]
...
mov	eax, -858993460				
rep stosd
mov	eax, DWORD PTR _additionalSet$[ebp]
push	eax
mov	ecx, DWORD PTR _set$[ebp]
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN5@uset_addSt
...
DB	0
ENDP
_uset_addAllCodePoints_56 PROC				
push	ebp
mov	ebp, esp
sub	esp, 268				
push	ebx
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN5@uset_addAl
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN5@uset_remov
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
mov	eax, -858993460				
rep stosd
mov	eax, DWORD PTR _complement$[ebp]
push	eax
mov	ecx, DWORD PTR _set$[ebp]
...
ret	0
ENDP
_uset_removeAllStrings_56 PROC				
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
mov	BYTE PTR $T43666[ebp], al
lea	ecx, DWORD PTR _s$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	al, BYTE PTR $T43666[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN5@uset_conta
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
ret	0
ENDP
_uset_containsAllCodePoints_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 280				
push	ebx
...
mov	BYTE PTR $T43675[ebp], al
lea	ecx, DWORD PTR _s$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	al, BYTE PTR $T43675[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN5@uset_conta@2
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
ret	0
ENDP
?getStringCount@USetAccess@icu_56@@SAHABVUnicodeSet@2@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN7@uset_getIt
xor	eax, eax
jmp	$LN8@uset_getIt
mov	eax, DWORD PTR _uset$[ebp]
mov	DWORD PTR _set$[ebp], eax
cmp	DWORD PTR _itemIndex$[ebp], 0
jge	SHORT $LN6@uset_getIt
mov	eax, DWORD PTR _ec$[ebp]
mov	DWORD PTR [eax], 1
or	eax, -1
jmp	$LN8@uset_getIt
...
cmp	ecx, DWORD PTR _rangeCount$[ebp]
jge	SHORT $LN4@uset_getIt
mov	esi, esp
...
mov	DWORD PTR [ecx], eax
xor	eax, eax
jmp	SHORT $LN8@uset_getIt
jmp	SHORT $LN8@uset_getIt
mov	eax, DWORD PTR _itemIndex$[ebp]
sub	eax, DWORD PTR _rangeCount$[ebp]
...
add	esp, 8
mov	DWORD PTR _s$36208[ebp], eax
mov	eax, DWORD PTR _ec$[ebp]
push	eax
mov	ecx, DWORD PTR _strCapacity$[ebp]
push	ecx
mov	edx, DWORD PTR _str$[ebp]
push	edx
mov	ecx, DWORD PTR _s$36208[ebp]
...
ret	0
ENDP
?getString@USetAccess@icu_56@@SAPBVUnicodeString@2@ABVUnicodeSet@2@H@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN2@uset_seria
xor	eax, eax
jmp	SHORT $LN3@uset_seria
mov	eax, DWORD PTR _ec$[ebp]
push	eax
...
ret	0
ENDP
_uset_getSerializedSet_56 PROC				
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
mov	eax, -858993460				
rep stosd
cmp	DWORD PTR _fillSet$[ebp], 0
jne	SHORT $LN7@uset_getSe
xor	al, al
jmp	$LN8@uset_getSe
cmp	DWORD PTR _src$[ebp], 0
je	SHORT $LN5@uset_getSe
cmp	DWORD PTR _srcLength$[ebp], 0
jg	SHORT $LN6@uset_getSe
mov	eax, DWORD PTR _fillSet$[ebp]
mov	DWORD PTR [eax+4], 0
mov	ecx, DWORD PTR _fillSet$[ebp]
...
and	eax, 32768				
je	SHORT $LN4@uset_getSe
mov	eax, DWORD PTR _length$[ebp]
and	eax, 32767				
mov	DWORD PTR _length$[ebp], eax
mov	eax, DWORD PTR _length$[ebp]
add	eax, 2
cmp	DWORD PTR _srcLength$[ebp], eax
jge	SHORT $LN3@uset_getSe
mov	eax, DWORD PTR _fillSet$[ebp]
mov	DWORD PTR [eax+4], 0
mov	ecx, DWORD PTR _fillSet$[ebp]
mov	DWORD PTR [ecx+8], 0
xor	al, al
jmp	SHORT $LN8@uset_getSe
mov	eax, DWORD PTR _src$[ebp]
movzx	ecx, WORD PTR [eax]
mov	edx, DWORD PTR _fillSet$[ebp]
mov	DWORD PTR [edx+4], ecx
mov	eax, DWORD PTR _src$[ebp]
add	eax, 2
mov	DWORD PTR _src$[ebp], eax
jmp	SHORT $LN2@uset_getSe
mov	eax, DWORD PTR _length$[ebp]
add	eax, 1
cmp	DWORD PTR _srcLength$[ebp], eax
jge	SHORT $LN1@uset_getSe
mov	eax, DWORD PTR _fillSet$[ebp]
mov	DWORD PTR [eax+4], 0
mov	ecx, DWORD PTR _fillSet$[ebp]
mov	DWORD PTR [ecx+8], 0
...
ret	0
ENDP
_uset_setSerializedToOne_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
rep stosd
cmp	DWORD PTR _fillSet$[ebp], 0
je	SHORT $LN7@uset_setSe
cmp	DWORD PTR _c$[ebp], 1114111		
jbe	SHORT $LN8@uset_setSe
jmp	$LN9@uset_setSe
mov	eax, DWORD PTR _fillSet$[ebp]
add	eax, 12					
mov	ecx, DWORD PTR _fillSet$[ebp]
...
ret	0
ENDP
_uset_serializedContains_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 324				
push	ebx
...
je	SHORT $LN26@uset_seria@2
cmp	DWORD PTR _c$[ebp], 1114111		
jbe	SHORT $LN27@uset_seria@2
xor	al, al
jmp	$LN28@uset_seria@2
mov	eax, DWORD PTR _set$[ebp]
mov	ecx, DWORD PTR [eax]
mov	DWORD PTR _array$[ebp], ecx
cmp	DWORD PTR _c$[ebp], 65535		
jg	$LN25@uset_seria@2
mov	DWORD PTR _lo$36260[ebp], 0
mov	eax, DWORD PTR _set$[ebp]
mov	ecx, DWORD PTR [eax+4]
sub	ecx, 1
mov	DWORD PTR _hi$36261[ebp], ecx
mov	eax, DWORD PTR _array$[ebp]
movzx	ecx, WORD PTR [eax]
cmp	DWORD PTR _c$[ebp], ecx
jge	SHORT $LN24@uset_seria@2
mov	DWORD PTR _hi$36261[ebp], 0
jmp	SHORT $LN23@uset_seria@2
mov	eax, DWORD PTR _hi$36261[ebp]
mov	ecx, DWORD PTR _array$[ebp]
movzx	edx, WORD PTR [ecx+eax*2]
cmp	DWORD PTR _c$[ebp], edx
jge	SHORT $LN22@uset_seria@2
mov	eax, DWORD PTR _lo$36260[ebp]
add	eax, DWORD PTR _hi$36261[ebp]
sar	eax, 1
mov	DWORD PTR _i$36268[ebp], eax
mov	eax, DWORD PTR _i$36268[ebp]
cmp	eax, DWORD PTR _lo$36260[ebp]
jne	SHORT $LN19@uset_seria@2
jmp	SHORT $LN20@uset_seria@2
jmp	SHORT $LN18@uset_seria@2
mov	eax, DWORD PTR _i$36268[ebp]
mov	ecx, DWORD PTR _array$[ebp]
movzx	edx, WORD PTR [ecx+eax*2]
cmp	DWORD PTR _c$[ebp], edx
jge	SHORT $LN17@uset_seria@2
mov	eax, DWORD PTR _i$36268[ebp]
mov	DWORD PTR _hi$36261[ebp], eax
jmp	SHORT $LN18@uset_seria@2
mov	eax, DWORD PTR _i$36268[ebp]
mov	DWORD PTR _lo$36260[ebp], eax
jmp	SHORT $LN21@uset_seria@2
jmp	SHORT $LN23@uset_seria@2
mov	eax, DWORD PTR _hi$36261[ebp]
add	eax, 1
mov	DWORD PTR _hi$36261[ebp], eax
...
mov	eax, DWORD PTR _c$[ebp]
sar	eax, 16					
mov	WORD PTR _high$36276[ebp], ax
mov	ax, WORD PTR _c$[ebp]
mov	WORD PTR _low$36278[ebp], ax
mov	eax, DWORD PTR _set$[ebp]
mov	ecx, DWORD PTR [eax+4]
mov	DWORD PTR _base$36280[ebp], ecx
mov	DWORD PTR _lo$36281[ebp], 0
mov	eax, DWORD PTR _set$[ebp]
mov	ecx, DWORD PTR [eax+8]
sub	ecx, 2
sub	ecx, DWORD PTR _base$36280[ebp]
mov	DWORD PTR _hi$36282[ebp], ecx
movzx	eax, WORD PTR _high$36276[ebp]
mov	ecx, DWORD PTR _base$36280[ebp]
mov	edx, DWORD PTR _array$[ebp]
movzx	ecx, WORD PTR [edx+ecx*2]
cmp	eax, ecx
jl	SHORT $LN12@uset_seria@2
movzx	eax, WORD PTR _high$36276[ebp]
mov	ecx, DWORD PTR _base$36280[ebp]
mov	edx, DWORD PTR _array$[ebp]
movzx	ecx, WORD PTR [edx+ecx*2]
cmp	eax, ecx
jne	SHORT $LN13@uset_seria@2
movzx	eax, WORD PTR _low$36278[ebp]
mov	ecx, DWORD PTR _base$36280[ebp]
mov	edx, DWORD PTR _array$[ebp]
movzx	ecx, WORD PTR [edx+ecx*2+2]
cmp	eax, ecx
jge	SHORT $LN13@uset_seria@2
mov	DWORD PTR _hi$36282[ebp], 0
jmp	$LN11@uset_seria@2
movzx	eax, WORD PTR _high$36276[ebp]
mov	ecx, DWORD PTR _base$36280[ebp]
add	ecx, DWORD PTR _hi$36282[ebp]
mov	edx, DWORD PTR _array$[ebp]
movzx	ecx, WORD PTR [edx+ecx*2]
cmp	eax, ecx
jl	SHORT $LN8@uset_seria@2
movzx	eax, WORD PTR _high$36276[ebp]
mov	ecx, DWORD PTR _base$36280[ebp]
add	ecx, DWORD PTR _hi$36282[ebp]
mov	edx, DWORD PTR _array$[ebp]
...
movzx	ecx, WORD PTR [edx+ecx*2+2]
cmp	eax, ecx
jge	SHORT $LN10@uset_seria@2
mov	eax, DWORD PTR _lo$36281[ebp]
add	eax, DWORD PTR _hi$36282[ebp]
sar	eax, 1
and	eax, -2					
mov	DWORD PTR _i$36291[ebp], eax
mov	eax, DWORD PTR _i$36291[ebp]
add	eax, DWORD PTR _base$36280[ebp]
mov	DWORD PTR _iabs$36292[ebp], eax
mov	eax, DWORD PTR _i$36291[ebp]
cmp	eax, DWORD PTR _lo$36281[ebp]
jne	SHORT $LN6@uset_seria@2
jmp	SHORT $LN7@uset_seria@2
jmp	SHORT $LN5@uset_seria@2
movzx	eax, WORD PTR _high$36276[ebp]
mov	ecx, DWORD PTR _iabs$36292[ebp]
mov	edx, DWORD PTR _array$[ebp]
movzx	ecx, WORD PTR [edx+ecx*2]
cmp	eax, ecx
jl	SHORT $LN3@uset_seria@2
movzx	eax, WORD PTR _high$36276[ebp]
mov	ecx, DWORD PTR _iabs$36292[ebp]
mov	edx, DWORD PTR _array$[ebp]
movzx	ecx, WORD PTR [edx+ecx*2]
cmp	eax, ecx
jne	SHORT $LN4@uset_seria@2
movzx	eax, WORD PTR _low$36278[ebp]
mov	ecx, DWORD PTR _iabs$36292[ebp]
mov	edx, DWORD PTR _array$[ebp]
movzx	ecx, WORD PTR [edx+ecx*2+2]
cmp	eax, ecx
jge	SHORT $LN4@uset_seria@2
mov	eax, DWORD PTR _i$36291[ebp]
mov	DWORD PTR _hi$36282[ebp], eax
jmp	SHORT $LN5@uset_seria@2
mov	eax, DWORD PTR _i$36291[ebp]
mov	DWORD PTR _lo$36281[ebp], eax
jmp	SHORT $LN8@uset_seria@2
jmp	SHORT $LN11@uset_seria@2
mov	eax, DWORD PTR _hi$36282[ebp]
add	eax, 2
mov	DWORD PTR _hi$36282[ebp], eax
mov	eax, DWORD PTR _base$36280[ebp]
mov	ecx, DWORD PTR _hi$36282[ebp]
lea	edx, DWORD PTR [ecx+eax*2]
and	edx, 2
setne	al
pop	edi
...
ret	0
ENDP
_uset_getSerializedRangeCount_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
rep stosd
cmp	DWORD PTR _set$[ebp], 0
jne	SHORT $LN1@uset_getSe@2
xor	eax, eax
jmp	SHORT $LN2@uset_getSe@2
mov	eax, DWORD PTR _set$[ebp]
mov	ecx, DWORD PTR _set$[ebp]
mov	eax, DWORD PTR [eax+8]
...
ret	0
ENDP
_uset_getSerializedRange_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 228				
push	ebx
...
rep stosd
cmp	DWORD PTR _set$[ebp], 0
je	SHORT $LN11@uset_getSe@3
cmp	DWORD PTR _rangeIndex$[ebp], 0
jl	SHORT $LN11@uset_getSe@3
cmp	DWORD PTR _pStart$[ebp], 0
je	SHORT $LN11@uset_getSe@3
cmp	DWORD PTR _pEnd$[ebp], 0
jne	SHORT $LN12@uset_getSe@3
xor	al, al
jmp	$LN13@uset_getSe@3
mov	eax, DWORD PTR _set$[ebp]
mov	ecx, DWORD PTR [eax]
mov	DWORD PTR _array$[ebp], ecx
mov	eax, DWORD PTR _set$[ebp]
...
mov	eax, DWORD PTR _rangeIndex$[ebp]
shl	eax, 1
mov	DWORD PTR _rangeIndex$[ebp], eax
mov	eax, DWORD PTR _rangeIndex$[ebp]
cmp	eax, DWORD PTR _bmpLength$[ebp]
jge	SHORT $LN10@uset_getSe@3
mov	eax, DWORD PTR _rangeIndex$[ebp]
mov	ecx, DWORD PTR _array$[ebp]
movzx	edx, WORD PTR [ecx+eax*2]
mov	eax, DWORD PTR _pStart$[ebp]
mov	DWORD PTR [eax], edx
mov	ecx, DWORD PTR _rangeIndex$[ebp]
add	ecx, 1
mov	DWORD PTR _rangeIndex$[ebp], ecx
mov	eax, DWORD PTR _rangeIndex$[ebp]
cmp	eax, DWORD PTR _bmpLength$[ebp]
jge	SHORT $LN9@uset_getSe@3
mov	eax, DWORD PTR _rangeIndex$[ebp]
mov	ecx, DWORD PTR _array$[ebp]
movzx	edx, WORD PTR [ecx+eax*2]
sub	edx, 1
...
mov	DWORD PTR [eax], edx
jmp	SHORT $LN8@uset_getSe@3
mov	eax, DWORD PTR _rangeIndex$[ebp]
cmp	eax, DWORD PTR _length$[ebp]
jge	SHORT $LN7@uset_getSe@3
mov	eax, DWORD PTR _rangeIndex$[ebp]
mov	ecx, DWORD PTR _array$[ebp]
movzx	edx, WORD PTR [ecx+eax*2]
shl	edx, 16					
...
mov	eax, DWORD PTR _rangeIndex$[ebp]
cmp	eax, DWORD PTR _length$[ebp]
jge	SHORT $LN4@uset_getSe@3
mov	eax, DWORD PTR _bmpLength$[ebp]
mov	ecx, DWORD PTR _array$[ebp]
lea	edx, DWORD PTR [ecx+eax*2]
mov	DWORD PTR _array$[ebp], edx
mov	eax, DWORD PTR _rangeIndex$[ebp]
mov	ecx, DWORD PTR _array$[ebp]
movzx	edx, WORD PTR [ecx+eax*2]
shl	edx, 16					
...
mov	ecx, DWORD PTR _pEnd$[ebp]
mov	DWORD PTR [ecx], edx
jmp	SHORT $LN2@uset_getSe@3
mov	eax, DWORD PTR _pEnd$[ebp]
mov	DWORD PTR [eax], 1114111		
mov	al, 1
jmp	SHORT $LN13@uset_getSe@3
jmp	SHORT $LN13@uset_getSe@3
xor	al, al
pop	edi
pop	esi
