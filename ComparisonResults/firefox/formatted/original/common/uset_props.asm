...
mov	ecx, DWORD PTR _this$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _len$34596[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?length@UnicodeString@icu_56@@QBEHXZ	
mov	DWORD PTR _textLength$34597[ebp], eax
mov	ecx, DWORD PTR _text$[ebp]
call	?isBogus@UnicodeString@icu_56@@QBECXZ	
movsx	eax, al
test	eax, eax
jne	SHORT $LN5@operator@2
mov	ecx, DWORD PTR _len$34596[ebp]
cmp	ecx, DWORD PTR _textLength$34597[ebp]
jne	SHORT $LN5@operator@2
mov	edx, DWORD PTR _len$34596[ebp]
push	edx
...
mov	eax, DWORD PTR $T43113[ebp]
or	eax, 1
mov	DWORD PTR $T43113[ebp], eax
mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
pop	edi
pop	esi
pop	ebx
...
add	esp, 4
mov	DWORD PTR $T43248[ebp], eax
cmp	DWORD PTR $T43248[ebp], 0
je	SHORT $LN5@uset_openP
mov	eax, DWORD PTR _ec$[ebp]
push	eax
lea	ecx, DWORD PTR _pat$[ebp]
push	ecx
mov	ecx, DWORD PTR $T43248[ebp]
call	??0UnicodeSet@icu_56@@QAE@ABVUnicodeString@1@AAW4UErrorCode@@@Z 
mov	DWORD PTR tv81[ebp], eax
jmp	SHORT $LN6@uset_openP
mov	DWORD PTR tv81[ebp], 0
mov	edx, DWORD PTR tv81[ebp]
mov	DWORD PTR $T43247[ebp], edx
mov	eax, DWORD PTR $T43247[ebp]
mov	DWORD PTR _set$[ebp], eax
cmp	DWORD PTR _set$[ebp], 0
jne	SHORT $LN2@uset_openP
mov	eax, DWORD PTR _ec$[ebp]
mov	DWORD PTR [eax], 7
mov	DWORD PTR $T43251[ebp], 0
lea	ecx, DWORD PTR _pat$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T43251[ebp]
jmp	$LN3@uset_openP
mov	eax, DWORD PTR _ec$[ebp]
mov	ecx, DWORD PTR [eax]
push	ecx
...
movsx	edx, al
test	edx, edx
je	SHORT $LN1@uset_openP
mov	eax, DWORD PTR _set$[ebp]
mov	DWORD PTR $T43253[ebp], eax
mov	ecx, DWORD PTR $T43253[ebp]
mov	DWORD PTR $T43252[ebp], ecx
cmp	DWORD PTR $T43252[ebp], 0
je	SHORT $LN7@uset_openP
mov	esi, esp
push	1
mov	edx, DWORD PTR $T43252[ebp]
mov	eax, DWORD PTR [edx]
mov	ecx, DWORD PTR $T43252[ebp]
mov	edx, DWORD PTR [eax]
call	edx
cmp	esi, esp
call	__RTC_CheckEsp
mov	DWORD PTR tv128[ebp], eax
jmp	SHORT $LN8@uset_openP
mov	DWORD PTR tv128[ebp], 0
mov	DWORD PTR _set$[ebp], 0
mov	eax, DWORD PTR _set$[ebp]
mov	DWORD PTR $T43256[ebp], eax
lea	ecx, DWORD PTR _pat$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T43256[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN11@uset_openP
...
ret	0
ENDP
_uset_openPatternOptions_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 356				
push	ebx
...
call	??2UMemory@icu_56@@SAPAXI@Z		
add	esp, 4
mov	DWORD PTR $T43269[ebp], eax
cmp	DWORD PTR $T43269[ebp], 0
je	SHORT $LN5@uset_openP@2
mov	eax, DWORD PTR _ec$[ebp]
push	eax
push	0
...
push	edx
mov	ecx, DWORD PTR $T43269[ebp]
call	??0UnicodeSet@icu_56@@QAE@ABVUnicodeString@1@IPBVSymbolTable@1@AAW4UErrorCode@@@Z 
mov	DWORD PTR tv83[ebp], eax
jmp	SHORT $LN6@uset_openP@2
mov	DWORD PTR tv83[ebp], 0
mov	eax, DWORD PTR tv83[ebp]
mov	DWORD PTR $T43268[ebp], eax
mov	ecx, DWORD PTR $T43268[ebp]
mov	DWORD PTR _set$[ebp], ecx
cmp	DWORD PTR _set$[ebp], 0
jne	SHORT $LN2@uset_openP@2
mov	eax, DWORD PTR _ec$[ebp]
mov	DWORD PTR [eax], 7
mov	DWORD PTR $T43272[ebp], 0
lea	ecx, DWORD PTR _pat$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T43272[ebp]
jmp	$LN3@uset_openP@2
mov	eax, DWORD PTR _ec$[ebp]
mov	ecx, DWORD PTR [eax]
push	ecx
call	?U_FAILURE@@YACW4UErrorCode@@@Z		
...
movsx	edx, al
test	edx, edx
je	SHORT $LN1@uset_openP@2
mov	eax, DWORD PTR _set$[ebp]
mov	DWORD PTR $T43274[ebp], eax
mov	ecx, DWORD PTR $T43274[ebp]
mov	DWORD PTR $T43273[ebp], ecx
cmp	DWORD PTR $T43273[ebp], 0
je	SHORT $LN7@uset_openP@2
mov	esi, esp
push	1
mov	edx, DWORD PTR $T43273[ebp]
mov	eax, DWORD PTR [edx]
...
jmp	SHORT $LN8@uset_openP@2
mov	DWORD PTR tv130[ebp], 0
mov	DWORD PTR _set$[ebp], 0
mov	eax, DWORD PTR _set$[ebp]
mov	DWORD PTR $T43277[ebp], eax
lea	ecx, DWORD PTR _pat$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T43277[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN11@uset_openP@2
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
movsx	edx, al
test	edx, edx
je	SHORT $LN3@uset_apply
xor	eax, eax
jmp	SHORT $LN4@uset_apply
cmp	DWORD PTR _set$[ebp], 0
jne	SHORT $LN1@uset_apply
mov	eax, DWORD PTR _status$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	SHORT $LN4@uset_apply
...
mov	DWORD PTR $T43284[ebp], eax
lea	ecx, DWORD PTR _pos$[ebp]
call	??1ParsePosition@icu_56@@UAE@XZ		
lea	ecx, DWORD PTR _pat$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T43284[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN9@uset_apply
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
DB	0
ENDP
_uset_applyIntPropertyValue_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
_uset_applyPropertyAlias_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 340				
push	ebx
...
xor	eax, ebp
mov	DWORD PTR __$ArrayPad$[ebp], eax
mov	eax, DWORD PTR _propLength$[ebp]
push	eax
...
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN6@uset_apply@2
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
DB	0
ENDP
_uset_resemblesPattern_56 PROC				
push	ebp
mov	ebp, esp
sub	esp, 284				
push	ebx
...
movzx	ecx, ax
cmp	ecx, 91					
je	SHORT $LN4@uset_resem
mov	edx, DWORD PTR _pos$[ebp]
push	edx
lea	eax, DWORD PTR _pat$[ebp]
push	eax
call	?resemblesPattern@UnicodeSet@icu_56@@SACABVUnicodeString@2@H@Z 
add	esp, 8
movsx	ecx, al
test	ecx, ecx
jne	SHORT $LN4@uset_resem
mov	BYTE PTR tv83[ebp], 0
jmp	SHORT $LN5@uset_resem
mov	BYTE PTR tv83[ebp], 1
mov	dl, BYTE PTR tv83[ebp]
mov	BYTE PTR $T43301[ebp], dl
lea	ecx, DWORD PTR _pat$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	al, BYTE PTR $T43301[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN8@uset_resem
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
mov	DWORD PTR $T43311[ebp], eax
lea	ecx, DWORD PTR _pat$[ebp]
call	??1UnicodeString@icu_56@@UAE@XZ		
mov	eax, DWORD PTR $T43311[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN5@uset_toPat
call	@_RTC_CheckStackVars@8
pop	eax
pop	edx
pop	edi
...
push	eax
mov	ecx, DWORD PTR _set$[ebp]
call	?closeOver@UnicodeSet@icu_56@@QAEAAV12@H@Z 
pop	edi
pop	esi
pop	ebx
add	esp, 192				
