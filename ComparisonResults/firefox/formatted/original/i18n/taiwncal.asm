...
ret	8
ENDP
?getStaticClassID@TaiwanCalendar@icu_56@@SAPAXXZ PROC	
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
mov	eax, -858993460				
rep stosd
mov	eax, OFFSET ?classID@?1??getStaticClassID@TaiwanCalendar@icu_56@@SAPAXXZ@4DA
pop	edi
pop	esi
pop	ebx
mov	esp, ebp
...
ret	0
ENDP
?getDynamicClassID@TaiwanCalendar@icu_56@@UBEPAXXZ PROC	
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
pop	ecx
mov	DWORD PTR _this$[ebp], ecx
call	?getStaticClassID@TaiwanCalendar@icu_56@@SAPAXXZ 
pop	edi
pop	esi
pop	ebx
add	esp, 204				
...
ret	0
ENDP
??0TaiwanCalendar@icu_56@@QAE@ABVLocale@1@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$??0TaiwanCalendar@icu_56@@QAE@ABVLocale@1@AAW4UErrorCode@@@Z
...
mov	eax, DWORD PTR _this$[ebp]
mov	DWORD PTR [eax], OFFSET ??_7TaiwanCalendar@icu_56@@6B@
mov	eax, DWORD PTR _success$[ebp]
push	eax
...
ret	8
ENDP
__unwindfunclet$??0TaiwanCalendar@icu_56@@QAE@ABVLocale@1@AAW4UErrorCode@@@Z$0 PROC
mov	ecx, DWORD PTR _this$[ebp]
jmp	??1GregorianCalendar@icu_56@@UAE@XZ	
ENDP
__ehhandler$??0TaiwanCalendar@icu_56@@QAE@ABVLocale@1@AAW4UErrorCode@@@Z PROC
...
ENDP
ENDP
??_GTaiwanCalendar@icu_56@@UAEPAXI@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
mov	DWORD PTR _this$[ebp], ecx
mov	ecx, DWORD PTR _this$[ebp]
call	??1TaiwanCalendar@icu_56@@UAE@XZ	
...
ret	4
ENDP
??1TaiwanCalendar@icu_56@@UAE@XZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
??0TaiwanCalendar@icu_56@@QAE@ABV01@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
??4TaiwanCalendar@icu_56@@QAEAAV01@ABV01@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
?clone@TaiwanCalendar@icu_56@@UBEPAVCalendar@2@XZ PROC	
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?clone@TaiwanCalendar@icu_56@@UBEPAVCalendar@2@XZ
mov	eax, DWORD PTR fs:0
push	eax
sub	esp, 232				
push	ebx
...
call	??0TaiwanCalendar@icu_56@@QAE@ABV01@@Z	
mov	DWORD PTR tv75[ebp], eax
jmp	SHORT $LN4@clone
mov	DWORD PTR tv75[ebp], 0
mov	ecx, DWORD PTR tv75[ebp]
mov	DWORD PTR $T76068[ebp], ecx
mov	DWORD PTR __$EHRec$[ebp+8], -1
mov	eax, DWORD PTR $T76068[ebp]
mov	ecx, DWORD PTR __$EHRec$[ebp]
mov	DWORD PTR fs:0, ecx
pop	ecx
pop	edi
...
ret	0
ENDP
__unwindfunclet$?clone@TaiwanCalendar@icu_56@@UBEPAVCalendar@2@XZ$0 PROC
mov	esi, esp
...
jmp	__RTC_CheckEsp
ENDP
__ehhandler$?clone@TaiwanCalendar@icu_56@@UBEPAVCalendar@2@XZ PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ENDP
ENDP
?getType@TaiwanCalendar@icu_56@@UBEPBDXZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
pop	ecx
mov	DWORD PTR _this$[ebp], ecx
mov	eax, OFFSET ??_C@_03BCNGPMIN@roc?$AA@
pop	edi
pop	esi
pop	ebx
mov	esp, ebp
...
ret	0
ENDP
?handleGetExtendedYear@TaiwanCalendar@icu_56@@MAEHXZ PROC 
push	ebp
mov	ebp, esp
sub	esp, 228				
push	ebx
...
jmp	SHORT $LN4@handleGetE
push	1
push	0
mov	ecx, DWORD PTR _this$[ebp]
call	?internalGet@Calendar@icu_56@@IBEHW4UCalendarDateFields@@H@Z 
mov	DWORD PTR _era$69276[ebp], eax
cmp	DWORD PTR _era$69276[ebp], 1
...
mov	DWORD PTR _year$[ebp], eax
jmp	SHORT $LN4@handleGetE
cmp	DWORD PTR _era$69276[ebp], 0
...
ret	0
ENDP
?handleComputeFields@TaiwanCalendar@icu_56@@MAEXHAAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
ret	8
ENDP
?handleGetLimit@TaiwanCalendar@icu_56@@MBEHW4UCalendarDateFields@@W4ELimitType@Calendar@2@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
jne	SHORT $LN5@handleGetL
cmp	DWORD PTR _limitType$[ebp], 0
je	SHORT $LN3@handleGetL
cmp	DWORD PTR _limitType$[ebp], 1
jne	SHORT $LN4@handleGetL
xor	eax, eax
jmp	SHORT $LN6@handleGetL
...
ret	8
ENDP
?haveDefaultCentury@TaiwanCalendar@icu_56@@MBECXZ PROC	
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
?defaultCenturyStart@TaiwanCalendar@icu_56@@MBENXZ PROC	
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
push	0
push	0
push	OFFSET ??_C@_0O@DMMEJDEA@?$EAcalendar?$DNroc?$AA@
...
lea	ecx, DWORD PTR _calendar$[ebp]
jmp	??1TaiwanCalendar@icu_56@@UAE@XZ	
ENDP
...
ret	0
ENDP
?defaultCenturyStartYear@TaiwanCalendar@icu_56@@MBEHXZ PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
