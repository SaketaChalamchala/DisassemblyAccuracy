...
ret	8
ENDP
?getStaticClassID@BuddhistCalendar@icu_56@@SAPAXXZ PROC	
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
?getDynamicClassID@BuddhistCalendar@icu_56@@UBEPAXXZ PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
??0BuddhistCalendar@icu_56@@QAE@ABVLocale@1@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$??0BuddhistCalendar@icu_56@@QAE@ABVLocale@1@AAW4UErrorCode@@@Z
...
ret	8
ENDP
__unwindfunclet$??0BuddhistCalendar@icu_56@@QAE@ABVLocale@1@AAW4UErrorCode@@@Z$0 PROC
mov	ecx, DWORD PTR _this$[ebp]
jmp	??1GregorianCalendar@icu_56@@UAE@XZ	
ENDP
__ehhandler$??0BuddhistCalendar@icu_56@@QAE@ABVLocale@1@AAW4UErrorCode@@@Z PROC
...
ENDP
ENDP
??_GBuddhistCalendar@icu_56@@UAEPAXI@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
??1BuddhistCalendar@icu_56@@UAE@XZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
??0BuddhistCalendar@icu_56@@QAE@ABV01@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
??4BuddhistCalendar@icu_56@@QAEAAV01@ABV01@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
?clone@BuddhistCalendar@icu_56@@UBEPAVCalendar@2@XZ PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?clone@BuddhistCalendar@icu_56@@UBEPAVCalendar@2@XZ
mov	eax, DWORD PTR fs:0
push	eax
sub	esp, 232				
push	ebx
...
cmp	esi, esp
call	__RTC_CheckEsp
mov	DWORD PTR $T76072[ebp], eax
mov	DWORD PTR __$EHRec$[ebp+8], 0
cmp	DWORD PTR $T76072[ebp], 0
je	SHORT $LN3@clone
mov	eax, DWORD PTR _this$[ebp]
push	eax
...
ret	0
ENDP
__unwindfunclet$?clone@BuddhistCalendar@icu_56@@UBEPAVCalendar@2@XZ$0 PROC
mov	esi, esp
...
jmp	__RTC_CheckEsp
ENDP
__ehhandler$?clone@BuddhistCalendar@icu_56@@UBEPAVCalendar@2@XZ PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ENDP
ENDP
?getType@BuddhistCalendar@icu_56@@UBEPBDXZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
?handleGetExtendedYear@BuddhistCalendar@icu_56@@MAEHXZ PROC 
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
ret	0
ENDP
?handleComputeMonthStart@BuddhistCalendar@icu_56@@MBEHHHC@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
pop	ecx
mov	DWORD PTR _this$[ebp], ecx
movzx	eax, BYTE PTR _useMonth$[ebp]
push	eax
...
ret	12					
ENDP
?handleComputeFields@BuddhistCalendar@icu_56@@MAEXHAAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
...
ret	8
ENDP
?handleGetLimit@BuddhistCalendar@icu_56@@MBEHW4UCalendarDateFields@@W4ELimitType@Calendar@2@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
jne	SHORT $LN2@handleGetL
xor	eax, eax
jmp	SHORT $LN3@handleGetL
jmp	SHORT $LN3@handleGetL
...
ret	8
ENDP
?haveDefaultCentury@BuddhistCalendar@icu_56@@MBECXZ PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
?defaultCenturyStart@BuddhistCalendar@icu_56@@MBENXZ PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
fstp	QWORD PTR _newStart$69311[ebp]
lea	eax, DWORD PTR _status$[ebp]
push	eax
push	1
lea	ecx, DWORD PTR _calendar$[ebp]
call	?get@Calendar@icu_56@@QBEHW4UCalendarDateFields@@AAW4UErrorCode@@@Z 
mov	DWORD PTR _newYear$69312[ebp], eax
mov	eax, DWORD PTR _newYear$69312[ebp]
mov	DWORD PTR _gSystemDefaultCenturyStartYear, eax
fld	QWORD PTR _newStart$69311[ebp]
...
ret	0
ENDP
?defaultCenturyStartYear@BuddhistCalendar@icu_56@@MBEHXZ PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
