...
add	esp, 12					
mov	DWORD PTR $T42111[ebp], eax
mov	esi, esp
lea	ecx, DWORD PTR $T35363[ebp]
call	DWORD PTR __imp_??1Locale@icu_56@@UAE@XZ
cmp	esi, esp
call	__RTC_CheckEsp
mov	eax, DWORD PTR $T42111[ebp]
pop	edi
pop	esi
pop	ebx
...
mov	eax, -858993460				
rep stosd
mov	eax, DWORD PTR _uplrules$[ebp]
mov	DWORD PTR $T42117[ebp], eax
mov	ecx, DWORD PTR $T42117[ebp]
mov	DWORD PTR $T42116[ebp], ecx
cmp	DWORD PTR $T42116[ebp], 0
je	SHORT $LN3@uplrules_c
mov	esi, esp
push	1
mov	edx, DWORD PTR $T42116[ebp]
mov	eax, DWORD PTR [edx]
mov	ecx, DWORD PTR $T42116[ebp]
mov	edx, DWORD PTR [eax]
call	edx
cmp	esi, esp
call	__RTC_CheckEsp
mov	DWORD PTR tv74[ebp], eax
jmp	SHORT $LN1@uplrules_c
...
movsx	edx, al
test	edx, edx
je	SHORT $LN2@uplrules_s
xor	eax, eax
jmp	$LN3@uplrules_s
cmp	DWORD PTR _keyword$[ebp], 0
jne	SHORT $LN5@uplrules_s
xor	eax, eax
cmp	DWORD PTR _capacity$[ebp], 0
setne	al
mov	DWORD PTR tv73[ebp], eax
jmp	SHORT $LN6@uplrules_s
xor	ecx, ecx
cmp	DWORD PTR _capacity$[ebp], 0
setl	cl
mov	DWORD PTR tv73[ebp], ecx
cmp	DWORD PTR tv73[ebp], 0
je	SHORT $LN1@uplrules_s
mov	eax, DWORD PTR _status$[ebp]
mov	DWORD PTR [eax], 1
xor	eax, eax
jmp	SHORT $LN3@uplrules_s
sub	esp, 8
fld	QWORD PTR _number$[ebp]
fstp	QWORD PTR [esp]
lea	eax, DWORD PTR _result$[ebp]
push	eax
mov	ecx, DWORD PTR _uplrules$[ebp]
...
cmp	esi, esp
call	__RTC_CheckEsp
mov	DWORD PTR $T42125[ebp], eax
mov	esi, esp
lea	ecx, DWORD PTR _result$[ebp]
call	DWORD PTR __imp_??1UnicodeString@icu_56@@UAE@XZ
cmp	esi, esp
call	__RTC_CheckEsp
mov	eax, DWORD PTR $T42125[ebp]
push	edx
mov	ecx, ebp
push	eax
lea	edx, DWORD PTR $LN9@uplrules_s
