...
ret	4
ENDP
_uregion_getRegionFromCode_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
push	eax
mov	ecx, DWORD PTR _regionCode$[ebp]
push	ecx
...
ret	0
ENDP
_uregion_getRegionFromNumericCode_56 PROC		
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
add	esp, 8
mov	DWORD PTR _strenum$[ebp], eax
mov	eax, DWORD PTR _status$[ebp]
push	eax
mov	ecx, DWORD PTR _strenum$[ebp]
push	ecx
...
cmp	eax, DWORD PTR _otherRegion$[ebp]
sete	al
pop	edi
pop	esi
pop	ebx
...
ret	0
ENDP
_uregion_getContainingRegion_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
mov	eax, -858993460				
rep stosd
mov	ecx, DWORD PTR _uregion$[ebp]
...
ret	0
ENDP
_uregion_getContainingRegionOfType_56 PROC		
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
_uregion_getContainedRegions_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
_uregion_getContainedRegionsOfType_56 PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
mov	eax, -858993460				
rep stosd
mov	eax, DWORD PTR _otherRegion$[ebp]
push	eax
mov	ecx, DWORD PTR _uregion$[ebp]
...
ret	0
ENDP
_uregion_getPreferredValues_56 PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
_uregion_getRegionCode_56 PROC				
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
_uregion_getNumericCode_56 PROC				
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
