...
ENDP
ENDP
?needsPluralRules@DigitAffixesAndPadding@icu_56@@QBECXZ PROC 
push	ebp
mov	ebp, esp
sub	esp, 208				
push	ebx
...
ret	0
ENDP
?formatInt32@DigitAffixesAndPadding@icu_56@@QBEAAVUnicodeString@2@HABVValueFormatter@2@AAVFieldPositionHandler@2@PBVPluralRules@2@AAV32@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
...
DB	0
ENDP
__unwindfunclet$?formatInt32@DigitAffixesAndPadding@icu_56@@QBEAAVUnicodeString@2@HABVValueFormatter@2@AAVFieldPositionHandler@2@PBVPluralRules@2@AAV32@AAW4UErrorCode@@@Z$0 PROC
lea	ecx, DWORD PTR _digits$39851[ebp]
jmp	??1VisibleDigitsWithExponent@icu_56@@QAE@XZ
ENDP
__ehhandler$?formatInt32@DigitAffixesAndPadding@icu_56@@QBEAAVUnicodeString@2@HABVValueFormatter@2@AAVFieldPositionHandler@2@PBVPluralRules@2@AAV32@AAW4UErrorCode@@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ret	0
ENDP
?format@DigitAffixesAndPadding@icu_56@@QBEAAVUnicodeString@2@ABVVisibleDigitsWithExponent@2@ABVValueFormatter@2@AAVFieldPositionHandler@2@PBVPluralRules@2@AAV32@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
...
DD	$LN2@format
ENDP
__unwindfunclet$?format@DigitAffixesAndPadding@icu_56@@QBEAAVUnicodeString@2@ABVVisibleDigitsWithExponent@2@ABVValueFormatter@2@AAVFieldPositionHandler@2@PBVPluralRules@2@AAV32@AAW4UErrorCode@@@Z$0 PROC
mov	esi, esp
lea	ecx, DWORD PTR _count$39888[ebp]
call	DWORD PTR __imp_??1UnicodeString@icu_56@@UAE@XZ
cmp	esi, esp
jmp	__RTC_CheckEsp
ENDP
__ehhandler$?format@DigitAffixesAndPadding@icu_56@@QBEAAVUnicodeString@2@ABVVisibleDigitsWithExponent@2@ABVValueFormatter@2@AAVFieldPositionHandler@2@PBVPluralRules@2@AAV32@AAW4UErrorCode@@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ENDP
ENDP
?formatAffix@icu_56@@YAAAVUnicodeString@1@PBVDigitAffix@1@AAVFieldPositionHandler@1@AAV21@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
?countAffixChar32@icu_56@@YAHPBVDigitAffix@1@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
ret	0
ENDP
?format@DigitAffixesAndPadding@icu_56@@QBEAAVUnicodeString@2@AAVDigitList@2@ABVValueFormatter@2@AAVFieldPositionHandler@2@PBVPluralRules@2@AAV32@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
...
DB	0
ENDP
__unwindfunclet$?format@DigitAffixesAndPadding@icu_56@@QBEAAVUnicodeString@2@AAVDigitList@2@ABVValueFormatter@2@AAVFieldPositionHandler@2@PBVPluralRules@2@AAV32@AAW4UErrorCode@@@Z$0 PROC
lea	ecx, DWORD PTR _digits$[ebp]
jmp	??1VisibleDigitsWithExponent@icu_56@@QAE@XZ
ENDP
__ehhandler$?format@DigitAffixesAndPadding@icu_56@@QBEAAVUnicodeString@2@AAVDigitList@2@ABVValueFormatter@2@AAVFieldPositionHandler@2@PBVPluralRules@2@AAV32@AAW4UErrorCode@@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ENDP
ENDP
?appendPadding@DigitAffixesAndPadding@icu_56@@ABEAAVUnicodeString@2@HAAV32@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 216				
push	ebx
