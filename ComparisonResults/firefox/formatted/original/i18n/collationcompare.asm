...
cmp	DWORD PTR _$S1$72416[ebp], 384		
...
ret	4
ENDP
?compareUpToQuaternary@CollationCompare@icu_56@@SA?AW4UCollationResult@@AAVCollationIterator@2@0ABUCollationSettings@2@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 696				
push	ebx
...
cmp	DWORD PTR _leftPrimary$72459[ebp], 33554432 
...
cmp	DWORD PTR _rightPrimary$72476[ebp], 33554432 
...
add	eax, 1
jmp	$LN120@compareUpT
cmp	DWORD PTR _leftSecondary$72504[ebp], 256 
...
cmp	DWORD PTR _p$72522[ebp], 33554432	
...
call	?getCE@CollationIterator@icu_56@@QBE_JH@Z 
mov	DWORD PTR _leftCase$72564[ebp], eax
cmp	DWORD PTR _leftCase$72564[ebp], 65535	
...
call	?getCE@CollationIterator@icu_56@@QBE_JH@Z 
mov	DWORD PTR _rightCase$72566[ebp], eax
cmp	DWORD PTR _rightCase$72566[ebp], 65535	
...
cmp	DWORD PTR _leftTertiary$72601[ebp], 256	
jbe	SHORT $LN24@compareUpT
cmp	DWORD PTR _leftLower32$72600[ebp], 65535 
...
add	eax, 16384				
mov	DWORD PTR _leftTertiary$72601[ebp], eax
cmp	DWORD PTR _rightTertiary$72609[ebp], 256 
jbe	SHORT $LN25@compareUpT
cmp	DWORD PTR _rightLower32$72608[ebp], 65535 
...
cmp	DWORD PTR _leftQuaternary$72630[ebp], 256 
...
cmp	DWORD PTR _rightQuaternary$72639[ebp], 256 
