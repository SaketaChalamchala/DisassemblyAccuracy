...
ret	8
ENDP
??_GCECalendar@icu_56@@MAEPAXI@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
??_ECECalendar@icu_56@@MAEPAXI@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
??0CECalendar@icu_56@@IAE@ABVLocale@1@AAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$??0CECalendar@icu_56@@IAE@ABVLocale@1@AAW4UErrorCode@@@Z
...
ret	8
ENDP
__unwindfunclet$??0CECalendar@icu_56@@IAE@ABVLocale@1@AAW4UErrorCode@@@Z$0 PROC
mov	ecx, DWORD PTR _this$[ebp]
jmp	??1Calendar@icu_56@@UAE@XZ		
ENDP
__ehhandler$??0CECalendar@icu_56@@IAE@ABVLocale@1@AAW4UErrorCode@@@Z PROC
...
ENDP
ENDP
??0CECalendar@icu_56@@IAE@ABV01@@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
??1CECalendar@icu_56@@MAE@XZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
??4CECalendar@icu_56@@IAEAAV01@ABV01@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	4
ENDP
?handleComputeMonthStart@CECalendar@icu_56@@MBEHHHC@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	12					
ENDP
?handleGetLimit@CECalendar@icu_56@@MBEHW4UCalendarDateFields@@W4ELimitType@Calendar@2@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	8
ENDP
?inDaylightTime@CECalendar@icu_56@@MBECAAW4UErrorCode@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 208				
push	ebx
...
ret	0
ENDP
?haveDefaultCentury@CECalendar@icu_56@@MBECXZ PROC	
push	ebp
mov	ebp, esp
sub	esp, 204				
push	ebx
...
ret	0
ENDP
?ceToJD@CECalendar@icu_56@@KAHHHHH@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 192				
push	ebx
...
imul	esi, 365				
add	esi, DWORD PTR _jdEpochOffset$[ebp]
push	4
...
ret	0
ENDP
?jdToCE@CECalendar@icu_56@@KAXHHAAH00@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 232				
push	ebx
...
mov	eax, -858993460				
rep stosd
lea	eax, DWORD PTR _r4$[ebp]
push	eax
push	1461					
mov	ecx, DWORD PTR _julianDay$[ebp]
sub	ecx, DWORD PTR _jdEpochOffset$[ebp]
...
idiv	esi
sub	ecx, eax
mov	edx, DWORD PTR _c4$[ebp]
lea	eax, DWORD PTR [ecx+edx*4]
mov	ecx, DWORD PTR _year$[ebp]
mov	DWORD PTR [ecx], eax
cmp	DWORD PTR _r4$[ebp], 1460		
jne	SHORT $LN3@jdToCE
mov	DWORD PTR tv77[ebp], 365		
jmp	SHORT $LN4@jdToCE
mov	eax, DWORD PTR _r4$[ebp]
cdq
mov	ecx, 365				
idiv	ecx
