...
ret	8
ENDP
??0?$already_AddRefed@VPath@gfx@mozilla@@@@QAE@P80@AEXNM@Z@Z PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	4
ENDP
??_GScaledFontBase@gfx@mozilla@@UAEPAXI@Z PROC		
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	4
ENDP
?GetType@ScaledFontBase@gfx@mozilla@@UBE?AW4FontType@23@XZ PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	0
ENDP
?CopyGlyphsToBuilder@ScaledFontBase@gfx@mozilla@@UAEXABUGlyphBuffer@23@PAVPathBuilder@23@W4BackendType@23@PBVMatrix@23@@Z PROC 
push	ebp
mov	ebp, esp
push	ecx
push	esi
...
ret	16					
ENDP
?GetPathForGlyphs@ScaledFontBase@gfx@mozilla@@UAE?AU?$already_AddRefed@VPath@gfx@mozilla@@@@ABUGlyphBuffer@23@PBVDrawTarget@23@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 8
...
ret	12					
ENDP
??1ScaledFontBase@gfx@mozilla@@UAE@XZ PROC		
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	0
ENDP
??0ScaledFontBase@gfx@mozilla@@QAE@M@Z PROC		
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	4
ENDP
??_GScaledFont@gfx@mozilla@@UAEPAXI@Z PROC		
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	4
ENDP
??0ScaledFont@gfx@mozilla@@IAE@XZ PROC			
push	ebp
mov	ebp, esp
push	-1
...
ret	0
ENDP
__unwindfunclet$??0ScaledFont@gfx@mozilla@@IAE@XZ$0 PROC
mov	ecx, DWORD PTR _this$[ebp]
add	ecx, 4
jmp	??1?$RefCounted@VScaledFont@gfx@mozilla@@@mozilla@@QAE@XZ 
ENDP
__ehhandler$??0ScaledFont@gfx@mozilla@@IAE@XZ PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ENDP
ENDP
?GetFontFileData@ScaledFont@gfx@mozilla@@UAE_NP6AXPBEIIMPAX@Z1@Z PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	8
ENDP
??1ScaledFont@gfx@mozilla@@UAE@XZ PROC			
push	ebp
mov	ebp, esp
push	-1
...
ret	0
ENDP
__unwindfunclet$??1ScaledFont@gfx@mozilla@@UAE@XZ$0 PROC
mov	ecx, DWORD PTR _this$[ebp]
add	ecx, 4
jmp	??1?$RefCounted@VScaledFont@gfx@mozilla@@@mozilla@@QAE@XZ 
ENDP
__ehhandler$??1ScaledFont@gfx@mozilla@@UAE@XZ PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
mov	ecx, DWORD PTR [edx-8]
xor	ecx, eax
...
ENDP
ENDP
??0?$RefCounted@VScaledFont@gfx@mozilla@@@mozilla@@QAE@XZ PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	0
ENDP
??1?$RefCounted@VScaledFont@gfx@mozilla@@@mozilla@@QAE@XZ PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	0
ENDP
??1?$RefCounted@VScaledFont@gfx@mozilla@@$00@detail@mozilla@@IAE@XZ PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
...
ret	0
ENDP
??0?$RefCounted@VScaledFont@gfx@mozilla@@$00@detail@mozilla@@IAE@XZ PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR [ebp-4], -858993460		
