...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	94CF40C3FD0FBB8E097AF3B904B0CC96
; Input	CRC32 :	7FC11721

; File Name   :	D:\compspace\dlls\firefox\dll\full\AccessibleMarshal_full.dll
...
; Debug	Directory entries
		...
		dd 56E8A98Eh		; TimeDateStamp: Wed Mar 16 00:32:14 2016
		dw 0			; MajorVersion
		dw 0			; MinorVersion
...
asc_10003B10	db 'RSDS'               ; DATA XREF: .rdata:10003104o
					; CV signature
		dd 169E7545h		; Data1	; GUID
		dw 146Ah		; Data2
		dw 47B5h		; Data3
		db 0B9h, 35h, 20h, 57h,	0D9h, 36h, 5Fh,	13h; Data4
		dd 2			; Age
...
word_10004092	dw 217h			; DATA XREF: .rdata:10003DC4o
		db '_amsg_exit',0
		align 10h
word_100040A0	dw 68h			; DATA XREF: .rdata:off_10003E38o
		db 'frex',0
		align 4
