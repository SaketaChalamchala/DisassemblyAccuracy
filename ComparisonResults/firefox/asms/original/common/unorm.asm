; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	D:\mozilla\intl\icu\source\common\unorm.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	SEGMENT
tv85 = -229						; size = 1
_textLength$35033 = -32					; size = 4
_len$35032 = -20					; size = 4
_this$ = -8						; size = 4
_text$ = 8						; size = 4
...
__unwindfunclet$?normalize@Normalizer2@icu_56@@QBE?AVUnicodeString@2@ABV32@AAW4UErrorCode@@@Z$1:
	...
	and	eax, 1
	je	$LN5@normalize
	and	DWORD PTR $T78661[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1UnicodeString@icu_56@@UAE@XZ		; icu_56::UnicodeString::~UnicodeString
$LN5@normalize:
	ret	0
...
$LN3@operator@3:
	cmp	DWORD PTR _$S1$70514[ebp], 384		; 00000180H
...
EXTRN	_unorm2_quickCheck_56:PROC
...
_unorm_quickCheck_56 PROC				; COMDAT
; File d:\mozilla\intl\icu\source\common\unorm.cpp
; Line 48
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
...
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT _unorm_quickCheckWithOptions_56
_TEXT	SEGMENT
$T78875 = -232						; size = 4
_fn2$71182 = -28					; size = 12
_n2$ = -8						; size = 4
_src$ = 8						; size = 4
_srcLength$ = 12					; size = 4
_mode$ = 16						; size = 4
...
_unorm_quickCheckWithOptions_56 PROC			; COMDAT
; Line 56
	push	ebp
	mov	ebp, esp
...
EXTRN	_unorm2_isNormalized_56:PROC
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT _unorm_isNormalized_56
_TEXT	SEGMENT
_n2$ = -8						; size = 4
_src$ = 8						; size = 4
_srcLength$ = 12					; size = 4
_mode$ = 16						; size = 4
_pErrorCode$ = 20					; size = 4
_unorm_isNormalized_56 PROC				; COMDAT
; Line 71
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
...
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT _unorm_isNormalizedWithOptions_56
_TEXT	SEGMENT
$T78883 = -229						; size = 1
_fn2$71205 = -28					; size = 12
_n2$ = -8						; size = 4
_src$ = 8						; size = 4
_srcLength$ = 12					; size = 4
_mode$ = 16						; size = 4
_options$ = 20						; size = 4
_pErrorCode$ = 24					; size = 4
_unorm_isNormalizedWithOptions_56 PROC			; COMDAT
; Line 79
	push	ebp
	mov	ebp, esp
	sub	esp, 236				; 000000ecH
...
EXTRN	_unorm2_normalize_56:PROC
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT _unorm_normalize_56
_TEXT	SEGMENT
$T78889 = -232						; size = 4
_fn2$71222 = -28					; size = 12
_n2$ = -8						; size = 4
_src$ = 8						; size = 4
_srcLength$ = 12					; size = 4
_mode$ = 16						; size = 4
...
_unorm_normalize_56 PROC				; COMDAT
; Line 98
	push	ebp
	mov	ebp, esp
	sub	esp, 236				; 000000ecH
...
_mode$ = 20						; size = 4
_options$ = 24						; size = 4
_doNormalize$ = 28					; size = 1
_pNeededToNormalize$ = 32				; size = 4
_pErrorCode$ = 36					; size = 4
_unorm_previous_56 PROC					; COMDAT
; Line 199
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
...
; Line 204
	...
	mov	ecx, DWORD PTR _src$[ebp]
	push	ecx
	call	?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z ; unorm_iterate
...
__unwindtable$?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z$0
__ehfuncinfo$?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu /ZI
xdata$x	ENDS
;	COMDAT ?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z
_TEXT	SEGMENT
$T78897 = -256						; size = 4
_fn2$71279 = -52					; size = 12
_uni32$71277 = -32					; size = 4
_n2$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
_src$ = 8						; size = 4
_forward$ = 12						; size = 1
...
_pNeededToNormalize$ = 36				; size = 4
_pErrorCode$ = 40					; size = 4
?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z PROC ; unorm_iterate, COMDAT
; Line 179
	push	ebp
	mov	ebp, esp
	push	-1
...
; Line 188
	...
	mov	ecx, DWORD PTR _src$[ebp]
	push	ecx
	call	?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z ; _iterate
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z$0:
	lea	ecx, DWORD PTR _fn2$71279[ebp]
	jmp	??1FilteredNormalizer2@icu_56@@UAE@XZ	; icu_56::FilteredNormalizer2::~FilteredNormalizer2
__ehhandler$?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	jmp	___CxxFrameHandler3
text$x	ENDS
?unorm_iterate@@YAHPAUUCharIterator@@CPA_WHW4UNormalizationMode@@HCPACPAW4UErrorCode@@@Z ENDP ; unorm_iterate
; Function compile flags: /Odtp /RTCsu /ZI
...
__unwindtable$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z$1
__ehfuncinfo$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu /ZI
xdata$x	ENDS
;	COMDAT ?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z
_TEXT	SEGMENT
tv81 = -389						; size = 1
$T78915 = -384						; size = 4
$T78916 = -372						; size = 4
_destString$ = -168					; size = 64
_c$ = -96						; size = 4
_buffer$ = -84						; size = 64
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
_pNeededToNormalize$ = 32				; size = 4
_pErrorCode$ = 36					; size = 4
?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z PROC ; _iterate, COMDAT
; Line 119
	push	ebp
	mov	ebp, esp
	push	-1
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z$0:
	lea	ecx, DWORD PTR _buffer$[ebp]
	jmp	??1UnicodeString@icu_56@@UAE@XZ		; icu_56::UnicodeString::~UnicodeString
__unwindfunclet$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z$1:
	lea	ecx, DWORD PTR _destString$[ebp]
	jmp	??1UnicodeString@icu_56@@UAE@XZ		; icu_56::UnicodeString::~UnicodeString
__ehhandler$?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	jmp	___CxxFrameHandler3
text$x	ENDS
?_iterate@@YAHPAUUCharIterator@@CPA_WHPBVNormalizer2@icu_56@@CPACPAW4UErrorCode@@@Z ENDP ; _iterate
; Function compile flags: /Odtp /RTCsu /ZI
...
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT _unorm_concatenate_56
_TEXT	SEGMENT
$T78935 = -244						; size = 4
_fn2$71338 = -40					; size = 12
_uni32$71336 = -20					; size = 4
_n2$ = -8						; size = 4
_left$ = 8						; size = 4
...
_options$ = 36						; size = 4
_pErrorCode$ = 40					; size = 4
_unorm_concatenate_56 PROC				; COMDAT
; Line 263
	push	ebp
	mov	ebp, esp
	sub	esp, 248				; 000000f8H
...
; Line 272
	...
	push	ecx
	call	?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z ; _concatenate
	add	esp, 32					; 00000020H
...
EXTRN	?setTo@UnicodeString@icu_56@@QAEAAV12@PA_WHH@Z:PROC ; icu_56::UnicodeString::setTo
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z$1
__ehfuncinfo$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu /ZI
xdata$x	ENDS
;	COMDAT ?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z
_TEXT	SEGMENT
tv155 = -372						; size = 4
tv86 = -368						; size = 4
$T78942 = -360						; size = 4
$T71321 = -348						; size = 64
_destString$ = -84					; size = 64
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
_left$ = 8						; size = 4
_leftLength$ = 12					; size = 4
...
_n2$ = 32						; size = 4
_pErrorCode$ = 36					; size = 4
?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z PROC ; _concatenate, COMDAT
; Line 227
	push	ebp
	mov	ebp, esp
	push	-1
...
; Line 249
	...
	push	edx
	lea	ecx, DWORD PTR _destString$[ebp]
	call	?setTo@UnicodeString@icu_56@@QAEAAV12@PA_WHH@Z ; icu_56::UnicodeString::setTo
; Line 250
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z$0:
	lea	ecx, DWORD PTR _destString$[ebp]
	jmp	??1UnicodeString@icu_56@@UAE@XZ		; icu_56::UnicodeString::~UnicodeString
__unwindfunclet$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z$1:
	lea	ecx, DWORD PTR $T71321[ebp]
	jmp	??1UnicodeString@icu_56@@UAE@XZ		; icu_56::UnicodeString::~UnicodeString
__ehhandler$?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	jmp	___CxxFrameHandler3
text$x	ENDS
?_concatenate@@YAHPB_WH0HPA_WHPBVNormalizer2@icu_56@@PAW4UErrorCode@@@Z ENDP ; _concatenate
