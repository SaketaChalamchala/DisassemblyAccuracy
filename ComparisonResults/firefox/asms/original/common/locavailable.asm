; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	D:\mozilla\intl\icu\source\common\locavailable.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__installedLocales DD 01H DUP (?)
__installedLocalesCount DD 01H DUP (?)
_BSS	ENDS
CONST	SEGMENT
__kIndexLocaleName DB 'res_index', 00H
	ORG $+2
__kIndexTag DB	'InstalledLocales', 00H
CONST	ENDS
...
PUBLIC	?locale_available_init@icu_56@@YAXXZ		; icu_56::locale_available_init
EXTRN	_ucln_common_registerCleanup_56:PROC
EXTRN	?setFromPOSIXID@Locale@icu_56@@IAEXPBD@Z:PROC	; icu_56::Locale::setFromPOSIXID
...
_BSS	ENDS
;	COMDAT xdata$x
; File d:\mozilla\intl\icu\source\common\locavailable.cpp
xdata$x	SEGMENT
__unwindtable$?locale_available_init@icu_56@@YAXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?locale_available_init@icu_56@@YAXXZ$0
__ehfuncinfo$?locale_available_init@icu_56@@YAXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?locale_available_init@icu_56@@YAXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu /ZI
xdata$x	ENDS
;	COMDAT ?locale_available_init@icu_56@@YAXXZ
_TEXT	SEGMENT
tv92 = -260						; size = 4
tv81 = -256						; size = 4
$T75935 = -248						; size = 4
$T75936 = -236						; size = 4
$T75937 = -224						; size = 4
_locCount$68744 = -20					; size = 4
__$EHRec$ = -12						; size = 12
?locale_available_init@icu_56@@YAXXZ PROC		; icu_56::locale_available_init, COMDAT
; Line 60
	push	ebp
	mov	ebp, esp
	push	-1
...
; Line 74
	...
	call	?setFromPOSIXID@Locale@icu_56@@IAEXPBD@Z ; icu_56::Locale::setFromPOSIXID
; Line 75
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?locale_available_init@icu_56@@YAXXZ$0:
	mov	eax, DWORD PTR $T75937[ebp]
	push	eax
	call	??_VUMemory@icu_56@@SAXPAX@Z		; icu_56::UMemory::operator delete[]
	pop	ecx
	ret	0
__ehhandler$?locale_available_init@icu_56@@YAXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	jmp	___CxxFrameHandler3
text$x	ENDS
?locale_available_init@icu_56@@YAXXZ ENDP		; icu_56::locale_available_init
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??_U@YAPAXI@Z
_TEXT	SEGMENT
_q$ = -8						; size = 4
...
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT _locale_available_cleanup
_TEXT	SEGMENT
tv80 = -236						; size = 4
tv79 = -232						; size = 4
$T75953 = -224						; size = 4
$T75954 = -212						; size = 4
$T75955 = -200						; size = 4
_locale_available_cleanup PROC				; COMDAT
; File d:\mozilla\intl\icu\source\common\locavailable.cpp
; Line 43
	push	ebp
	mov	ebp, esp
...
PUBLIC	?getAvailableLocales@Locale@icu_56@@SAPBV12@AAH@Z ; icu_56::Locale::getAvailableLocales
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?getAvailableLocales@Locale@icu_56@@SAPBV12@AAH@Z
_TEXT	SEGMENT
_count$ = 8						; size = 4
?getAvailableLocales@Locale@icu_56@@SAPBV12@AAH@Z PROC	; icu_56::Locale::getAvailableLocales, COMDAT
; File d:\mozilla\intl\icu\source\common\locavailable.cpp
; Line 81
	push	ebp
	mov	ebp, esp
	...
	rep stosd
; Line 82
	push	OFFSET ?locale_available_init@icu_56@@YAXXZ ; icu_56::locale_available_init
...
; Line 85
	...
	pop	ebp
	ret	0
?getAvailableLocales@Locale@icu_56@@SAPBV12@AAH@Z ENDP	; icu_56::Locale::getAvailableLocales
_TEXT	ENDS
...
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
;	COMDAT _uloc_getAvailable_56
_TEXT	SEGMENT
_offset$ = 8						; size = 4
_uloc_getAvailable_56 PROC				; COMDAT
; File d:\mozilla\intl\icu\source\common\locavailable.cpp
; Line 164
	push	ebp
	mov	ebp, esp
	...
	rep stosd
; Line 166
	call	?_load_installedLocales@@YAXXZ		; _load_installedLocales
; Line 168
	mov	eax, DWORD PTR _offset$[ebp]
...
_TEXT	ENDS
_BSS	SEGMENT
__installedLocalesInitOnce DQ 01H DUP (?)
; Function compile flags: /Odtp /RTCsu /ZI
_BSS	ENDS
;	COMDAT ?_load_installedLocales@@YAXXZ
_TEXT	SEGMENT
?_load_installedLocales@@YAXXZ PROC			; _load_installedLocales, COMDAT
; Line 158
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
	...
	rep stosd
; Line 159
	push	OFFSET ?loadInstalledLocales@@YAXXZ	; loadInstalledLocales
...
; Line 160
	...
	pop	ebp
	ret	0
?_load_installedLocales@@YAXXZ ENDP			; _load_installedLocales
_TEXT	ENDS
PUBLIC	??_C@_1DI@KGLACONK@?$AA_?$AAi?$AAn?$AAs?$AAt?$AAa?$AAl?$AAl?$AAe?$AAd?$AAL?$AAo?$AAc?$AAa?$AAl?$AAe?$AAs?$AAC?$AAo?$AAu?$AAn?$AAt?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AA0?$AA?$AA@ ; `string'
PUBLIC	??_C@_1CO@PBAFHHKH@?$AA_?$AAi?$AAn?$AAs?$AAt?$AAa?$AAl?$AAl?$AAe?$AAd?$AAL?$AAo?$AAc?$AAa?$AAl?$AAe?$AAs?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AA0?$AA?$AA@ ; `string'
PUBLIC	??_C@_1GG@KAFNJANC@?$AAd?$AA?3?$AA?2?$AAm?$AAo?$AAz?$AAi?$AAl?$AAl?$AAa?$AA?2?$AAi?$AAn?$AAt?$AAl?$AA?2?$AAi?$AAc?$AAu?$AA?2?$AAs?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAc?$AAo?$AAm?$AAm?$AAo@ ; `string'
PUBLIC	?__LINE__Var@?1??loadInstalledLocales@@YAXXZ@4JA@47c81ba2 ; `loadInstalledLocales'::`2'::__LINE__Var
PUBLIC	__$ArrayPad$
...
;	COMDAT ??_C@_1DI@KGLACONK@?$AA_?$AAi?$AAn?$AAs?$AAt?$AAa?$AAl?$AAl?$AAe?$AAd?$AAL?$AAo?$AAc?$AAa?$AAl?$AAe?$AAs?$AAC?$AAo?$AAu?$AAn?$AAt?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AA0?$AA?$AA@
CONST	SEGMENT
??_C@_1DI@KGLACONK@?$AA_?$AAi?$AAn?$AAs?$AAt?$AAa?$AAl?$AAl?$AAe?$AAd?$AAL?$AAo?$AAc?$AAa?$AAl?$AAe?$AAs?$AAC?$AAo?$AAu?$AAn?$AAt?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AA0?$AA?$AA@ DB '_'
	DB	00H, 'i', 00H, 'n', 00H, 's', 00H, 't', 00H, 'a', 00H, 'l', 00H
	DB	'l', 00H, 'e', 00H, 'd', 00H, 'L', 00H, 'o', 00H, 'c', 00H, 'a'
	DB	00H, 'l', 00H, 'e', 00H, 's', 00H, 'C', 00H, 'o', 00H, 'u', 00H
	DB	'n', 00H, 't', 00H, ' ', 00H, '=', 00H, '=', 00H, ' ', 00H, '0'
	DB	00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_1CO@PBAFHHKH@?$AA_?$AAi?$AAn?$AAs?$AAt?$AAa?$AAl?$AAl?$AAe?$AAd?$AAL?$AAo?$AAc?$AAa?$AAl?$AAe?$AAs?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AA0?$AA?$AA@
CONST	SEGMENT
??_C@_1CO@PBAFHHKH@?$AA_?$AAi?$AAn?$AAs?$AAt?$AAa?$AAl?$AAl?$AAe?$AAd?$AAL?$AAo?$AAc?$AAa?$AAl?$AAe?$AAs?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AA0?$AA?$AA@ DB '_'
	DB	00H, 'i', 00H, 'n', 00H, 's', 00H, 't', 00H, 'a', 00H, 'l', 00H
	DB	'l', 00H, 'e', 00H, 'd', 00H, 'L', 00H, 'o', 00H, 'c', 00H, 'a'
	DB	00H, 'l', 00H, 'e', 00H, 's', 00H, ' ', 00H, '=', 00H, '=', 00H
	DB	' ', 00H, '0', 00H, 00H, 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_1GG@KAFNJANC@?$AAd?$AA?3?$AA?2?$AAm?$AAo?$AAz?$AAi?$AAl?$AAl?$AAa?$AA?2?$AAi?$AAn?$AAt?$AAl?$AA?2?$AAi?$AAc?$AAu?$AA?2?$AAs?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAc?$AAo?$AAm?$AAm?$AAo@
CONST	SEGMENT
??_C@_1GG@KAFNJANC@?$AAd?$AA?3?$AA?2?$AAm?$AAo?$AAz?$AAi?$AAl?$AAl?$AAa?$AA?2?$AAi?$AAn?$AAt?$AAl?$AA?2?$AAi?$AAc?$AAu?$AA?2?$AAs?$AAo?$AAu?$AAr?$AAc?$AAe?$AA?2?$AAc?$AAo?$AAm?$AAm?$AAo@ DB 'd'
	DB	00H, ':', 00H, '\', 00H, 'm', 00H, 'o', 00H, 'z', 00H, 'i', 00H
	DB	'l', 00H, 'l', 00H, 'a', 00H, '\', 00H, 'i', 00H, 'n', 00H, 't'
	DB	00H, 'l', 00H, '\', 00H, 'i', 00H, 'c', 00H, 'u', 00H, '\', 00H
	DB	's', 00H, 'o', 00H, 'u', 00H, 'r', 00H, 'c', 00H, 'e', 00H, '\'
	DB	00H, 'c', 00H, 'o', 00H, 'm', 00H, 'm', 00H, 'o', 00H, 'n', 00H
	DB	'\', 00H, 'l', 00H, 'o', 00H, 'c', 00H, 'a', 00H, 'v', 00H, 'a'
	DB	00H, 'i', 00H, 'l', 00H, 'a', 00H, 'b', 00H, 'l', 00H, 'e', 00H
	DB	'.', 00H, 'c', 00H, 'p', 00H, 'p', 00H, 00H, 00H ; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?1??loadInstalledLocales@@YAXXZ@4JA@47c81ba2
_DATA	SEGMENT
?__LINE__Var@?1??loadInstalledLocales@@YAXXZ@4JA@47c81ba2 DD 07dH ; `loadInstalledLocales'::`2'::__LINE__Var
; Function compile flags: /Odtp /RTCsu /ZI
_DATA	ENDS
;	COMDAT ?loadInstalledLocales@@YAXXZ
_TEXT	SEGMENT
tv138 = -408						; size = 4
_localeCount$ = -208					; size = 4
_i$ = -196						; size = 4
_status$ = -184						; size = 4
_installed$ = -172					; size = 152
_indexLocale$ = -12					; size = 4
__$ArrayPad$ = -4					; size = 4
?loadInstalledLocales@@YAXXZ PROC			; loadInstalledLocales, COMDAT
; Line 125
	push	ebp
	mov	ebp, esp
...
; Line 150
	push	OFFSET ?uloc_cleanup@@YACXZ		; uloc_cleanup
	push	7
	call	_ucln_common_registerCleanup_56
	add	esp, 8
$LN4@loadInstal:
...
$LN9@loadInstal:
	...
	DB	100					; 00000064H
	DB	0
?loadInstalledLocales@@YAXXZ ENDP			; loadInstalledLocales
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
...
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?uloc_cleanup@@YACXZ
_TEXT	SEGMENT
_temp$ = -8						; size = 4
?uloc_cleanup@@YACXZ PROC				; uloc_cleanup, COMDAT
; File d:\mozilla\intl\icu\source\common\locavailable.cpp
; Line 107
	push	ebp
	mov	ebp, esp
...
; Line 120
	...
	pop	ebp
	ret	0
?uloc_cleanup@@YACXZ ENDP				; uloc_cleanup
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
;	COMDAT _uloc_countAvailable_56
_TEXT	SEGMENT
_uloc_countAvailable_56 PROC				; COMDAT
; Line 175
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
