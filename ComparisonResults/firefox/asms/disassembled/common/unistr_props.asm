...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	533F1E744044688E07469ED95F39703F
; Input	CRC32 :	865F1FE8

; File Name   :	D:\compspace\objfiles\firefox\common\unistr_props.obj
...
?getArrayStart@UnicodeString@icu_56@@AAEPA_WXZ proc near
					; CODE XREF: icu_56::UnicodeString::trim(void)+3Dp
...
; struct icu_56::UnicodeString *__thiscall icu_56::UnicodeString::trim(icu_56::UnicodeString *__hidden this)
		public ?trim@UnicodeString@icu_56@@QAEAAV12@XZ
?trim@UnicodeString@icu_56@@QAEAAV12@XZ	proc near
...
loc_3E6E:				; CODE XREF: icu_56::UnicodeString::trim(void)+30j
		mov	ecx, [ebp+var_8] ; this
...
loc_3E8A:				; CODE XREF: icu_56::UnicodeString::trim(void):loc_3F1Dj
		mov	eax, [ebp+var_38]
		mov	[ebp+var_44], eax
		cmp	[ebp+var_38], 0
		jg	short loc_3E9B
...
loc_3E9B:				; CODE XREF: icu_56::UnicodeString::trim(void)+60j
		mov	eax, [ebp+var_38]
		sub	eax, 1
		mov	[ebp+var_38], eax
		mov	ecx, [ebp+var_38]
...
loc_3F02:				; CODE XREF: icu_56::UnicodeString::trim(void)+8Aj
					; icu_56::UnicodeString::trim(void)+90j ...
		cmp	[ebp+var_20], 20h ; ' '
		jz	short loc_3F1D
		mov	eax, [ebp+var_20]
		push	eax
...
loc_3F1D:				; CODE XREF: icu_56::UnicodeString::trim(void)+D2j
					; icu_56::UnicodeString::trim(void)+E5j
		jmp	loc_3E8A
; ---------------------------------------------------------------------------

loc_3F22:				; CODE XREF: icu_56::UnicodeString::trim(void)+62j
					; icu_56::UnicodeString::trim(void)+E7j
		mov	eax, [ebp+var_44]
		cmp	eax, [ebp+var_2C]
		jge	short loc_3F36
		mov	eax, [ebp+var_44]
...
loc_3F36:				; CODE XREF: icu_56::UnicodeString::trim(void)+F4j
		mov	[ebp+var_38], 0

loc_3F3D:				; CODE XREF: icu_56::UnicodeString::trim(void):loc_3FD3j
		mov	eax, [ebp+var_38]
		mov	[ebp+var_5C], eax
		mov	eax, [ebp+var_38]
		cmp	eax, [ebp+var_44]
...
loc_3F50:				; CODE XREF: icu_56::UnicodeString::trim(void)+115j
		mov	eax, [ebp+var_38]
		mov	ecx, [ebp+var_14]
...
loc_3FB8:				; CODE XREF: icu_56::UnicodeString::trim(void)+13Fj
					; icu_56::UnicodeString::trim(void)+147j ...
		cmp	[ebp+var_20], 20h ; ' '
		jz	short loc_3FD3
		mov	eax, [ebp+var_20]
		push	eax
...
loc_3FD3:				; CODE XREF: icu_56::UnicodeString::trim(void)+188j
					; icu_56::UnicodeString::trim(void)+19Bj
		jmp	loc_3F3D
; ---------------------------------------------------------------------------

loc_3FD8:				; CODE XREF: icu_56::UnicodeString::trim(void)+117j
					; icu_56::UnicodeString::trim(void)+19Dj
		cmp	[ebp+var_5C], 0
		jle	short loc_3FF2
		push	0		; int
		push	0		; int
...
loc_3FF2:				; CODE XREF: icu_56::UnicodeString::trim(void)+1A8j
		mov	eax, [ebp+var_8]

loc_3FF5:				; CODE XREF: icu_56::UnicodeString::trim(void)+35j
		pop	edi
		pop	esi
		pop	ebx
		add	esp, 12Ch
...
loc_4000:				; DATA XREF: .rdata:std::_Iosb<int>::_Fmtflags const std::_Iosb<int>::boolalphao
		...
		pop	ebp
		retn
?trim@UnicodeString@icu_56@@QAEAAV12@XZ	endp ; sp-analysis failed
...
loc_40F6:				; CODE XREF: std::basic_string<char,std::char_traits<char>,std::allocator<char>>::_Myptr(void)+2Aj
		mov	eax, [ebp+var_8]
		add	eax, 4
		mov	[ebp+var_D0], eax

loc_4102:				; CODE XREF: std::basic_string<char,std::char_traits<char>,std::allocator<char>>::_Myptr(void)+38j
		mov	eax, [ebp+var_D0]
		pop	edi
		pop	esi
		pop	ebx
...
; struct icu_56::UnicodeString *__thiscall icu_56::UnicodeString::doReverse(icu_56::UnicodeString *__hidden this, int, int)
		...
		extrn _u_isWhitespace_56:near
					; CODE XREF: icu_56::UnicodeString::trim(void)+D8p
					; icu_56::UnicodeString::trim(void)+18Ep
