...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	009512960CB11B4B04BFD153B3EB91BA
; Input	CRC32 :	44098D34

; File Name   :	D:\compspace\objfiles\firefox\common\unistr_case.obj
...
?getArrayStart@UnicodeString@icu_56@@AAEPA_WXZ proc near
					; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+8Cp
					; icu_56::UnicodeString::caseMap(UCaseMap const	*,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode	*))+10Cp
...
?getShortLength@UnicodeString@icu_56@@ABEHXZ proc near
					...
					; icu_56::UnicodeString::caseMap(UCaseMap const	*,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode	*))+68p
...
?getCapacity@UnicodeString@icu_56@@QBEHXZ proc near
					; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+103p
...
?hashCode@UnicodeString@icu_56@@QBEHXZ proc near
					; CODE XREF: _uhash_hashCaselessUnicodeString_56+50p
...
?isWritable@UnicodeString@icu_56@@ABECXZ proc near
					; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+3Fp
...
?caseCompare@UnicodeString@icu_56@@QBECABV12@I@Z proc near
					; CODE XREF: _uhash_compareCaselessUnicodeString_56+4Fp
...
?isEmpty@UnicodeString@icu_56@@QBECXZ proc near
					; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+30p
...
; signed __int8	__thiscall icu_56::UnicodeString::doCaseCompare(icu_56::UnicodeString *this, int, int, const wchar_t *,	int, int, unsigned int)
		public ?doCaseCompare@UnicodeString@icu_56@@ABECHHPB_WHHI@Z
?doCaseCompare@UnicodeString@icu_56@@ABECHHPB_WHHI@Z proc near
...
loc_3E6D:				; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+30j
		lea	eax, [ebp+arg_4]
		push	eax		; int *
		lea	ecx, [ebp+arg_0]
		push	ecx		; int *
...
loc_3E90:				; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+4Dj
		mov	ecx, [ebp+var_8] ; this
		call	?getArrayStart@UnicodeString@icu_56@@ABEPB_WXZ ; icu_56::UnicodeString::getArrayStart(void)
		mov	[ebp+var_14], eax
		mov	eax, [ebp+arg_0]
...
loc_3EB9:				; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+77j
		mov	eax, [ebp+var_14]
		cmp	eax, [ebp+arg_8]
		jz	short loc_3F04
		mov	[ebp+var_20], 0
...
loc_3F02:				; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+C1j
		jmp	short loc_3F35
; ---------------------------------------------------------------------------

loc_3F04:				; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+8Bj
		cmp	[ebp+arg_10], 0
		jge	short loc_3F1F
		mov	eax, [ebp+arg_C]
		mov	ecx, [ebp+arg_8]
...
loc_3F1F:				; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+D4j
		mov	eax, [ebp+arg_4]
		cmp	eax, [ebp+arg_10]
		jz	short loc_3F35
		mov	eax, [ebp+arg_4]
...
loc_3F35:				; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint):loc_3F02j
					; icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const *,int,int,uint)+F1j
		xor	al, al

loc_3F37:				; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+34j
					; icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const *,int,int,uint)+CCj ...
		push	edx
		mov	ecx, ebp
		push	eax
		lea	edx, $LN13
		...
		pop	ebp
		retn	18h
?doCaseCompare@UnicodeString@icu_56@@ABECHHPB_WHHI@Z endp

; ---------------------------------------------------------------------------
		align 10h
$LN13		dd 1			; DATA XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+107o
		dd offset $LN12
$LN12		dd 0FFFFFFE0h, 4	; DATA XREF: .text:00003F64o
		dd offset $LN11		; "errorCode"
$LN11		db 'errorCode',0        ; DATA XREF: .text:00003F70o
		align 10h
_text		ends
...
; struct icu_56::UnicodeString *__thiscall icu_56::UnicodeString::caseMap(icu_56::UnicodeString	*this, const struct UCaseMap *,	int (__cdecl *)(const struct UCaseMap *, wchar_t *, int, const wchar_t *, int, enum UErrorCode *))
		public ?caseMap@UnicodeString@icu_56@@AAEAAV12@PBUUCaseMap@@P6AH0PA_WHPB_WHPAW4UErrorCode@@@Z@Z
?caseMap@UnicodeString@icu_56@@AAEAAV12@PBUUCaseMap@@P6AH0PA_WHPB_WHPAW4UErrorCode@@@Z@Z proc near
					; CODE XREF: icu_56::UnicodeString::foldCase(uint)+85p
...
loc_3FCB:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+3Aj
		mov	eax, [ebp+var_C]
		jmp	loc_4117
; ---------------------------------------------------------------------------

loc_3FD3:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+49j
		mov	eax, [ebp+var_C]
		movsx	ecx, word ptr [eax+4]
		and	ecx, 2
		jz	short loc_4009
...
loc_4009:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+5Dj
		mov	ecx, [ebp+var_C] ; this
...
loc_401F:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+87j
		cmp	[ebp+var_68], 1Dh
		jg	short loc_402E
		mov	[ebp+var_74], 1Dh
		jmp	short loc_4037
...
loc_402E:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+A3j
		mov	eax, [ebp+var_68]
		add	eax, 14h
		mov	[ebp+var_74], eax

loc_4037:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+ACj
		mov	[ebp+var_80], 0
...
loc_4065:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+DBj
					; icu_56::UnicodeString::caseMap(UCaseMap const	*,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode	*))+162j
		mov	[ebp+var_8C], 0
		mov	esi, esp
		lea	eax, [ebp+var_8C]
		push	eax
...
loc_40E4:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+13Fj
		cmp	[ebp+var_80], 0
		jz	short loc_40F6
		mov	eax, [ebp+var_80]
		push	eax
...
loc_40F6:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+168j
		mov	eax, [ebp+var_8C]
		push	eax
...
loc_4114:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+18Aj
		mov	eax, [ebp+var_C]

loc_4117:				; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+4Ej
					; icu_56::UnicodeString::caseMap(UCaseMap const	*,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode	*))+E0j
		push	edx
		mov	ecx, ebp
		push	eax
		lea	edx, $LN20
		...
		pop	ebp
		retn	8
?caseMap@UnicodeString@icu_56@@AAEAAV12@PBUUCaseMap@@P6AH0PA_WHPB_WHPAW4UErrorCode@@@Z@Z endp

; ---------------------------------------------------------------------------
$LN20		dd 3			; DATA XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+19Bo
		dd offset $LN19
$LN19		dd 0FFFFFFB0h, 3Ah	; DATA XREF: .text:0000414Co
		dd offset $LN16		; "oldStackBuffer"
		dd 0FFFFFF80h, 4
		dd offset $LN17		; "bufferToDelete"
		dd 0FFFFFF74h, 4
		dd offset $LN18		; "errorCode"
$LN18		db 'errorCode',0        ; DATA XREF: .text:00004170o
$LN17		db 'bufferToDelete',0   ; DATA XREF: .text:00004164o
$LN16		db 'oldStackBuffer',0   ; DATA XREF: .text:00004158o
_text		ends
...
?U_FAILURE@@YACW4UErrorCode@@@Z	proc near
					; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+17Dp
...
; struct icu_56::UnicodeString *__thiscall icu_56::UnicodeString::foldCase(icu_56::UnicodeString *this,	unsigned int)
		public ?foldCase@UnicodeString@icu_56@@QAEAAV12@I@Z
?foldCase@UnicodeString@icu_56@@QAEAAV12@I@Z proc near
					; CODE XREF: _uhash_hashCaselessUnicodeString_56+49p
...
arg_0		= dword	ptr  8
		...
		mov	eax, [ebp+arg_0]
		mov	[ebp+var_18], eax
		push	offset _ustrcase_internalFold_56 ; int (__cdecl	*)(const struct	UCaseMap *, wchar_t *, int, const wchar_t *, int, enum UErrorCode *)
		lea	eax, [ebp+var_44]
		push	eax		; struct UCaseMap *
		mov	ecx, [ebp+var_C] ; this
		call	?caseMap@UnicodeString@icu_56@@AAEAAV12@PBUUCaseMap@@P6AH0PA_WHPB_WHPAW4UErrorCode@@@Z@Z ; icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const	*,int,UErrorCode *))
		push	edx
		mov	ecx, ebp
		push	eax
		lea	edx, $LN5
		...
		pop	ebp
		retn	4
?foldCase@UnicodeString@icu_56@@QAEAAV12@I@Z endp

; ---------------------------------------------------------------------------
		align 4
$LN5		dd 1			; DATA XREF: icu_56::UnicodeString::foldCase(uint)+8Eo
		dd offset $LN4
$LN4		dd 0FFFFFFBCh, 30h	; DATA XREF: .text:00004288o
		dd offset $LN3
$LN3		dd 6D7363h		; DATA XREF: .text:00004294o
_text		ends
...
; Attributes: bp-based frame
		...
		public _uhash_hashCaselessUnicodeString_56
_uhash_hashCaselessUnicodeString_56 proc near
...
loc_42D4:				; CODE XREF: _uhash_hashCaselessUnicodeString_56+32j
		mov	eax, [ebp+var_C]
		push	eax		; struct icu_56::UnicodeString *
...
loc_4305:				; CODE XREF: _uhash_hashCaselessUnicodeString_56+36j
		push	edx
		mov	ecx, ebp
		push	eax
		lea	edx, $LN6
		...
		pop	ebp
		retn
_uhash_hashCaselessUnicodeString_56 endp

; ---------------------------------------------------------------------------
$LN6		dd 1			; DATA XREF: _uhash_hashCaselessUnicodeString_56+6Do
		dd offset $LN5_0
$LN5_0		dd 0FFFFFFACh, 40h	; DATA XREF: .text:00004338o
		dd offset $LN4_0	; "copy"
$LN4_0		db 'copy',0             ; DATA XREF: .text:00004344o
		align 10h
_text		ends
...
; Attributes: bp-based frame
		...
		public _uhash_compareCaselessUnicodeString_56
_uhash_compareCaselessUnicodeString_56 proc near
...
loc_4386:				; CODE XREF: _uhash_compareCaselessUnicodeString_56+30j
		cmp	[ebp+var_8], 0
		jz	short loc_4392
		cmp	[ebp+var_14], 0
		jnz	short loc_4396

loc_4392:				; CODE XREF: _uhash_compareCaselessUnicodeString_56+3Aj
		xor	al, al
		jmp	short loc_43AC
; ---------------------------------------------------------------------------

loc_4396:				; CODE XREF: _uhash_compareCaselessUnicodeString_56+40j
		push	0		; unsigned int
		mov	eax, [ebp+var_14]
		push	eax		; struct icu_56::UnicodeString *
		mov	ecx, [ebp+var_8] ; this
		call	?caseCompare@UnicodeString@icu_56@@QBECABV12@I@Z ; icu_56::UnicodeString::caseCompare(icu_56::UnicodeString const &,uint)
		movsx	ecx, al
		test	ecx, ecx
		setz	al

loc_43AC:				; CODE XREF: _uhash_compareCaselessUnicodeString_56+34j
					; _uhash_compareCaselessUnicodeString_56+44j
		pop	edi
		pop	esi
		pop	ebx
		add	esp, 0D8h
		...
		pop	ebp
		retn
_uhash_compareCaselessUnicodeString_56 endp
...
loc_44AA:				; CODE XREF: std::basic_string<char,std::char_traits<char>,std::allocator<char>>::_Myptr(void)+2Aj
		mov	eax, [ebp+var_8]
		add	eax, 4
		mov	[ebp+var_D0], eax

loc_44B6:				; CODE XREF: std::basic_string<char,std::char_traits<char>,std::allocator<char>>::_Myptr(void)+38j
		mov	eax, [ebp+var_D0]
		pop	edi
		pop	esi
		pop	ebx
...
; struct icu_56::UnicodeString *__thiscall icu_56::UnicodeString::doReverse(icu_56::UnicodeString *__hidden this, int, int)
		...
		extrn _u_strcmpFold_56:near
					; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+B2p
; __fastcall _RTC_CheckStackVars(x, x)
		extrn @_RTC_CheckStackVars@8:near
					; CODE XREF: icu_56::UnicodeString::doCaseCompare(int,int,wchar_t const	*,int,int,uint)+10Dp
					; icu_56::UnicodeString::caseMap(UCaseMap const	*,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode	*))+1A1p ...
; void __thiscall icu_56::UnicodeString::setToBogus(icu_56::UnicodeString *__hidden this)
		extrn ?setToBogus@UnicodeString@icu_56@@QAEXXZ:near
					; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+18Fp
		extrn _uprv_free_56:near
					; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+16Ep
; signed __int8	__thiscall icu_56::UnicodeString::cloneArrayIfNeeded(icu_56::UnicodeString *__hidden this, int,	int, signed __int8, int	**, signed __int8)
		extrn ?cloneArrayIfNeeded@UnicodeString@icu_56@@AAECHHCPAPAHC@Z:near
					; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+D1p
					; icu_56::UnicodeString::caseMap(UCaseMap const	*,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode	*))+158p
		extrn _u_memcpy_56:near	; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *)):loc_3FFFp
		extrn ___security_cookie:near
					; DATA XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+20r
					; icu_56::UnicodeString::foldCase(uint)+20r ...
; __fastcall __security_check_cookie(x)
		extrn @__security_check_cookie@4:near
					; CODE XREF: icu_56::UnicodeString::caseMap(UCaseMap const *,int (*)(UCaseMap const *,wchar_t *,int,wchar_t const *,int,UErrorCode *))+1B0p
					; icu_56::UnicodeString::foldCase(uint)+A3p ...
; int __cdecl ustrcase_internalFold_56(const struct UCaseMap *,	wchar_t	*, int,	const wchar_t *, int, enum UErrorCode *)
		extrn _ustrcase_internalFold_56:near
					; DATA XREF: icu_56::UnicodeString::foldCase(uint)+79o
		extrn _ucase_getSingleton_56:near
					; CODE XREF: icu_56::UnicodeString::foldCase(uint)+6Bp
; _DWORD __thiscall icu_56::UnicodeString::UnicodeString(icu_56::UnicodeString *__hidden this, const struct icu_56::UnicodeString *)
		extrn ??0UnicodeString@icu_56@@QAE@ABV01@@Z:near
					; CODE XREF: _uhash_hashCaselessUnicodeString_56+3Fp
