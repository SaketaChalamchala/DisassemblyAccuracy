??$_Uninit_move@PAUiconLocator@@PAU1@V?$allocator@UiconLocator@@@std@@U1@@std@@YAPAUiconLocator@@PAU1@00AAU?$_Wrap_alloc@V?$allocator@UiconLocator@@@std@@@0@0U_Nonscalar_ptr_iterator_tag@0@@Z
original code :
...
end ??$_Uninit_move@PAUiconLocator@@PAU1@V?$allocator@UiconLocator@@@std@@U1@@std@@YAPAUiconLocator@@PAU1@00AAU?$_Wrap_alloc@V?$allocator@UiconLocator@@@std@@@0@0U_Nonscalar_ptr_iterator_tag@0@@Z
??$_Uninit_move@PAUtDynamicList@@PAU1@V?$allocator@UtDynamicList@@@std@@U1@@std@@YAPAUtDynamicList@@PAU1@00AAU?$_Wrap_alloc@V?$allocator@UtDynamicList@@@std@@@0@0U_Nonscalar_ptr_iterator_tag@0@@Z
original code :
push|mov|push|push|mov|push|push|push|push|push|push|mov|xor|push|lea|mov|mov|push|push|mov|push|mov|push|call|add|push|push|mov|push|call|add|mov|mov|mov|jmp|mov|add|mov|mov|add|mov|mov|cmp|je|mov|push|mov|push|mov|call|jmp|jmp|jmp|mov|add|mov|mov|cmp|je|mov|push|mov|call|jmp|push|push|call|mov|ret|mov|jmp|mov|mov|mov|mov|pop|pop|pop|pop|mov|pop|ret|
disassembled code :
push|mov|push|push|mov|push|push|push|push|push|push|mov|xor|push|lea|mov|mov|push|push|mov|push|mov|push|call|add|push|push|mov|push|call|add|mov|mov|mov|jmp|mov|add|mov|mov|add|mov|mov|cmp|je|mov|push|mov|push|mov|call|jmp|jmp|

end ??$_Uninit_move@PAUtDynamicList@@PAU1@V?$allocator@UtDynamicList@@@std@@U1@@std@@YAPAUtDynamicList@@PAU1@00AAU?$_Wrap_alloc@V?$allocator@UtDynamicList@@@std@@@0@0U_Nonscalar_ptr_iterator_tag@0@@Z
...
?_Reallocate@?$vector@UiconLocator@@V?$allocator@UiconLocator@@@std@@@std@@IAEXI@Z
original code :
...
end ?_Reallocate@?$vector@UiconLocator@@V?$allocator@UiconLocator@@@std@@@std@@IAEXI@Z
?_Reallocate@?$vector@UtDynamicList@@V?$allocator@UtDynamicList@@@std@@@std@@IAEXI@Z
original code :
push|mov|push|push|mov|push|push|sub|push|push|push|mov|xor|push|lea|mov|mov|mov|mov|push|lea|push|mov|call|mov|call|mov|mov|mov|push|mov|mov|push|mov|mov|push|mov|call|jmp|mov|push|mov|push|lea|push|mov|call|mov|call|push|push|call|mov|ret|mov|jmp|mov|mov|call|mov|mov|cmp|je|mov|mov|push|mov|mov|push|mov|call|mov|mov|mov|sub|cdq
|mov|idiv|push|mov|mov|push|lea|push|mov|call|mov|call|mov|call|imul|add|mov|mov|imul|add|mov|mov|mov|mov|mov|mov|mov|pop|pop|pop|pop|mov|pop|ret|
disassembled code :
...
end ?_Reallocate@?$vector@UtDynamicList@@V?$allocator@UtDynamicList@@@std@@@std@@IAEXI@Z
