??$_Uninit_move@PAVUserCommand@@PAV1@V?$allocator@VUserCommand@@@std@@V1@@std@@YAPAVUserCommand@@PAV1@00AAU?$_Wrap_alloc@V?$allocator@VUserCommand@@@std@@@0@0U_Nonscalar_ptr_iterator_tag@0@@Z
original code :
...
end ??$_Uninit_move@PAVUserCommand@@PAV1@V?$allocator@VUserCommand@@@std@@V1@@std@@YAPAVUserCommand@@PAV1@00AAU?$_Wrap_alloc@V?$allocator@VUserCommand@@@std@@@0@0U_Nonscalar_ptr_iterator_tag@0@@Z
?_Reallocate@?$vector@VUserCommand@@V?$allocator@VUserCommand@@@std@@@std@@IAEXI@Z
original code :
...
end ?_Reallocate@?$vector@VUserCommand@@V?$allocator@VUserCommand@@@std@@@std@@IAEXI@Z
