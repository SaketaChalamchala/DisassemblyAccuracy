...
?doOpenSingleFileDlg@FileDialog@@QAEPA_WXZ
original code :
push|mov|push|push|mov|push|push|sub|mov|xor|mov|push|push|push|push|lea|mov|mov|mov|lea|push|push|call|call|mov|mov|call|mov|mov|mov|mov|or|mov|mov|mov|mov|mov|add|push|call|test|je|mov|mov|jmp|mov|mov|mov|mov|call|cmp|jne|lea|push|push|call|lea|push|mov|call|jmp|mov|push|push|lea|call|push|push|call|mov|lea|call|mov|ret|push|push|push|push|call|mov|ret|mov|jmp|mov|jmp|jmp|mov|lea|push|call|mov|mov|mov|pop|pop|pop|pop|mov|xor|call|mov|pop|ret|
disassembled code :
push|mov|push|push|mov|push|push|sub|mov|xor|mov|push|push|push|push|lea|mov|mov|mov|lea|push|push|call|call|mov|mov|call|mov|mov|mov|mov|or|mov|mov|mov|mov|mov|add|push|call|test|je|mov|mov|jmp|mov|mov|mov|mov|call|cmp|jne|lea|push|push|call|lea|push|mov|call|jmp|

end ?doOpenSingleFileDlg@FileDialog@@QAEPA_WXZ
?doSaveDlg@FileDialog@@QAEPA_WXZ
original code :
push|mov|push|push|mov|push|push|sub|mov|xor|mov|push|push|push|push|lea|mov|mov|mov|lea|push|push|call|call|mov|mov|call|mov|mov|mov|mov|or|mov|mov|mov|mov|or|mov|mov|mov|mov|mov|mov|mov|add|push|call|test|je|mov|mov|jmp|mov|mov|mov|mov|call|cmp|jne|lea|push|push|call|lea|push|mov|call|jmp|mov|push|push|lea|call|push|push|call|mov|lea|call|mov|ret|push|push|push|push|call|mov|ret|mov|jmp|mov|jmp|jmp|mov|lea|push|call|mov|mov|mov|pop|pop|pop|pop|mov|xor|call|mov|pop|ret|
disassembled code :
push|mov|push|push|mov|push|push|sub|mov|xor|mov|push|push|push|push|lea|mov|mov|mov|lea|push|push|call|call|mov|mov|call|mov|mov|mov|mov|or|mov|mov|mov|mov|or|mov|mov|mov|mov|mov|mov|mov|add|push|call|test|je|mov|mov|jmp|mov|mov|mov|mov|call|cmp|jne|lea|push|push|call|lea|push|mov|call|jmp|

end ?doSaveDlg@FileDialog@@QAEPA_WXZ
