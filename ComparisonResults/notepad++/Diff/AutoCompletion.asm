??$_Uninit_move@PAUMatchedCharInserted@@PAU1@V?$allocator@UMatchedCharInserted@@@std@@U1@@std@@YAPAUMatchedCharInserted@@PAU1@00AAU?$_Wrap_alloc@V?$allocator@UMatchedCharInserted@@@std@@@0@0U_Nonscalar_ptr_iterator_tag@0@@Z
original code :
...
end ??$_Uninit_move@PAUMatchedCharInserted@@PAU1@V?$allocator@UMatchedCharInserted@@@std@@U1@@std@@YAPAUMatchedCharInserted@@PAU1@00AAU?$_Wrap_alloc@V?$allocator@UMatchedCharInserted@@@std@@@0@0U_Nonscalar_ptr_iterator_tag@0@@Z
...
?_Reallocate@?$vector@UMatchedCharInserted@@V?$allocator@UMatchedCharInserted@@@std@@@std@@IAEXI@Z
original code :
...
end ?_Reallocate@?$vector@UMatchedCharInserted@@V?$allocator@UMatchedCharInserted@@@std@@@std@@IAEXI@Z
