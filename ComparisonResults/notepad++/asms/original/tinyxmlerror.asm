; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	C:\workspace\notepad-plus-plus-6.7.9.2\PowerEditor\src\TinyXml\tinyxmlerror.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?errorString@TiXmlBase@@1PAPB_WA		; TiXmlBase::errorString
_DATA	SEGMENT
?errorString@TiXmlBase@@1PAPB_WA DD FLAT:$SG95533	; TiXmlBase::errorString
	DD	FLAT:$SG95534
	DD	FLAT:$SG95535
	DD	FLAT:$SG95536
	DD	FLAT:$SG95537
...
_DATA	ENDS
CONST	SEGMENT
$SG95533 DB	'N', 00H, 'o', 00H, ' ', 00H, 'e', 00H, 'r', 00H, 'r', 00H
	DB	'o', 00H, 'r', 00H, 00H, 00H
	ORG $+2
$SG95534 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, 00H, 00H
$SG95535 DB	'F', 00H, 'a', 00H, 'i', 00H, 'l', 00H, 'e', 00H, 'd', 00H
	DB	' ', 00H, 't', 00H, 'o', 00H, ' ', 00H, 'o', 00H, 'p', 00H, 'e'
	DB	00H, 'n', 00H, ' ', 00H, 'f', 00H, 'i', 00H, 'l', 00H, 'e', 00H
	DB	00H, 00H
$SG95536 DB	'M', 00H, 'e', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H
	DB	' ', 00H, 'a', 00H, 'l', 00H, 'l', 00H, 'o', 00H, 'c', 00H, 'a'
	DB	00H, 't', 00H, 'i', 00H, 'o', 00H, 'n', 00H, ' ', 00H, 'f', 00H
	DB	'a', 00H, 'i', 00H, 'l', 00H, 'e', 00H, 'd', 00H, '.', 00H, 00H
	DB	00H
$SG95537 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ' ', 00H
	DB	'p', 00H, 'a', 00H, 'r', 00H, 's', 00H, 'i', 00H, 'n', 00H, 'g'
	DB	00H, ' ', 00H, 'E', 00H, 'l', 00H, 'e', 00H, 'm', 00H, 'e', 00H
	DB	'n', 00H, 't', 00H, '.', 00H, 00H, 00H
	ORG $+2
$SG95538 DB	'F', 00H, 'a', 00H, 'i', 00H, 'l', 00H, 'e', 00H, 'd', 00H
	DB	' ', 00H, 't', 00H, 'o', 00H, ' ', 00H, 'r', 00H, 'e', 00H, 'a'
	DB	00H, 'd', 00H, ' ', 00H, 'E', 00H, 'l', 00H, 'e', 00H, 'm', 00H
	DB	'e', 00H, 'n', 00H, 't', 00H, ' ', 00H, 'n', 00H, 'a', 00H, 'm'
	DB	00H, 'e', 00H, 00H, 00H
$SG95539 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ' ', 00H
	DB	'r', 00H, 'e', 00H, 'a', 00H, 'd', 00H, 'i', 00H, 'n', 00H, 'g'
	DB	00H, ' ', 00H, 'E', 00H, 'l', 00H, 'e', 00H, 'm', 00H, 'e', 00H
	DB	'n', 00H, 't', 00H, ' ', 00H, 'v', 00H, 'a', 00H, 'l', 00H, 'u'
	DB	00H, 'e', 00H, '.', 00H, 00H, 00H
	ORG $+2
$SG95540 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ' ', 00H
	DB	'r', 00H, 'e', 00H, 'a', 00H, 'd', 00H, 'i', 00H, 'n', 00H, 'g'
	DB	00H, ' ', 00H, 'A', 00H, 't', 00H, 't', 00H, 'r', 00H, 'i', 00H
	DB	'b', 00H, 'u', 00H, 't', 00H, 'e', 00H, 's', 00H, '.', 00H, 00H
	DB	00H
$SG95541 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ':', 00H
	DB	' ', 00H, 'e', 00H, 'm', 00H, 'p', 00H, 't', 00H, 'y', 00H, ' '
	DB	00H, 't', 00H, 'a', 00H, 'g', 00H, '.', 00H, 00H, 00H
$SG95542 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ' ', 00H
	DB	'r', 00H, 'e', 00H, 'a', 00H, 'd', 00H, 'i', 00H, 'n', 00H, 'g'
	DB	00H, ' ', 00H, 'e', 00H, 'n', 00H, 'd', 00H, ' ', 00H, 't', 00H
	DB	'a', 00H, 'g', 00H, '.', 00H, 00H, 00H
	ORG $+2
$SG95543 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ' ', 00H
	DB	'p', 00H, 'a', 00H, 'r', 00H, 's', 00H, 'i', 00H, 'n', 00H, 'g'
	DB	00H, ' ', 00H, 'U', 00H, 'n', 00H, 'k', 00H, 'n', 00H, 'o', 00H
	DB	'w', 00H, 'n', 00H, '.', 00H, 00H, 00H
	ORG $+2
$SG95544 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ' ', 00H
	DB	'p', 00H, 'a', 00H, 'r', 00H, 's', 00H, 'i', 00H, 'n', 00H, 'g'
	DB	00H, ' ', 00H, 'C', 00H, 'o', 00H, 'm', 00H, 'm', 00H, 'e', 00H
	DB	'n', 00H, 't', 00H, '.', 00H, 00H, 00H
	ORG $+2
$SG95545 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ' ', 00H
	DB	'p', 00H, 'a', 00H, 'r', 00H, 's', 00H, 'i', 00H, 'n', 00H, 'g'
	DB	00H, ' ', 00H, 'D', 00H, 'e', 00H, 'c', 00H, 'l', 00H, 'a', 00H
	DB	'r', 00H, 'a', 00H, 't', 00H, 'i', 00H, 'o', 00H, 'n', 00H, '.'
	DB	00H, 00H, 00H
	ORG $+2
$SG95546 DB	'E', 00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ' ', 00H
	DB	'd', 00H, 'o', 00H, 'c', 00H, 'u', 00H, 'm', 00H, 'e', 00H, 'n'
	DB	00H, 't', 00H, ' ', 00H, 'e', 00H, 'm', 00H, 'p', 00H, 't', 00H
	DB	'y', 00H, '.', 00H, 00H, 00H
CONST	ENDS
PUBLIC	_hypot
