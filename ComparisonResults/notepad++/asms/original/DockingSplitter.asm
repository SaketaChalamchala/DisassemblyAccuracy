; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	C:\workspace\notepad-plus-plus-6.7.9.2\PowerEditor\src\WinControls\DockingWnd\DockingSplitter.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?_isVertReg@DockingSplitter@@0HA		; DockingSplitter::_isVertReg
PUBLIC	?_isHoriReg@DockingSplitter@@0HA		; DockingSplitter::_isHoriReg
_BSS	SEGMENT
?_isVertReg@DockingSplitter@@0HA DD 01H DUP (?)		; DockingSplitter::_isVertReg
?_isHoriReg@DockingSplitter@@0HA DD 01H DUP (?)		; DockingSplitter::_isHoriReg
_hWndMouse DD	01H DUP (?)
_hookMouse DD	01H DUP (?)
_BSS	ENDS
CONST	SEGMENT
$SG123139 DB	'n', 00H, 's', 00H, 'd', 00H, 'o', 00H, 'c', 00H, 'k', 00H
	DB	's', 00H, 'p', 00H, 'l', 00H, 'i', 00H, 't', 00H, 'e', 00H, 'r'
	DB	00H, 00H, 00H
$SG123144 DB	'w', 00H, 'e', 00H, 'd', 00H, 'o', 00H, 'c', 00H, 'k', 00H
	DB	's', 00H, 'p', 00H, 'l', 00H, 'i', 00H, 't', 00H, 'e', 00H, 'r'
	DB	00H, 00H, 00H
$SG123152 DB	'DockingSplitter::init : RegisterClass() function failed', 00H
$SG123161 DB	00H, 00H
	ORG $+2
$SG123165 DB	'DockingSplitter::init : CreateWindowEx() function return'
	DB	' null', 00H
	ORG $+2
$SG123200 DB	'G', 00H, 'e', 00H, 't', 00H, 'L', 00H, 'a', 00H, 's', 00H
	...
	ORG $+4
$SG123201 DB	'S', 00H, 'e', 00H, 't', 00H, 'W', 00H, 'i', 00H, 'n', 00H
	...
	DB	00H, 'o', 00H, 'c', 00H, 00H, 00H
CONST	ENDS
PUBLIC	?init@Window@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z	; Window::init
PUBLIC	?init@DockingSplitter@@QAEXPAUHINSTANCE__@@PAUHWND__@@1I@Z ; DockingSplitter::init
PUBLIC	?staticWinProc@DockingSplitter@@KGJPAUHWND__@@IIJ@Z ; DockingSplitter::staticWinProc
PUBLIC	?runProc@DockingSplitter@@IAEJPAUHWND__@@IIJ@Z	; DockingSplitter::runProc
PUBLIC	_hypot
...
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
?runProc@DockingSplitter@@IAEJPAUHWND__@@IIJ@Z PROC	; DockingSplitter::runProc
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\dockingwnd\dockingsplitter.cpp
; Line 147
	push	ebp
...
; Line 208
	...
	pop	ebp
	ret	16					; 00000010H
?runProc@DockingSplitter@@IAEJPAUHWND__@@IIJ@Z ENDP	; DockingSplitter::runProc
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv64 = -8						; size = 4
_pDockingSplitter$ = -4					; size = 4
_hwnd$ = 8						; size = 4
_message$ = 12						; size = 4
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
?staticWinProc@DockingSplitter@@KGJPAUHWND__@@IIJ@Z PROC ; DockingSplitter::staticWinProc
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\dockingwnd\dockingsplitter.cpp
; Line 127
	push	ebp
	mov	ebp, esp
...
; Line 141
	...
	call	?runProc@DockingSplitter@@IAEJPAUHWND__@@IIJ@Z ; DockingSplitter::runProc
$LN6@staticWinP:
; Line 143
	mov	esp, ebp
	pop	ebp
	ret	16					; 00000010H
?staticWinProc@DockingSplitter@@KGJPAUHWND__@@IIJ@Z ENDP ; DockingSplitter::staticWinProc
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_wc$ = -68						; size = 40
...
_hMessage$ = 16						; size = 4
_flags$ = 20						; size = 4
?init@DockingSplitter@@QAEXPAUHINSTANCE__@@PAUHWND__@@1I@Z PROC ; DockingSplitter::init
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\dockingwnd\dockingsplitter.cpp
; Line 67
	push	ebp
...
$LN9@init:
; Line 88
	cmp	DWORD PTR ?_isHoriReg@DockingSplitter@@0HA, 0 ; DockingSplitter::_isHoriReg
	jne	SHORT $LN6@init
	mov	ecx, DWORD PTR _flags$[ebp]
	and	ecx, 2
	jne	SHORT $LN7@init
$LN6@init:
	cmp	DWORD PTR ?_isVertReg@DockingSplitter@@0HA, 0 ; DockingSplitter::_isVertReg
	jne	$LN8@init
	mov	edx, DWORD PTR _flags$[ebp]
	and	edx, 1
	je	$LN8@init
...
; Line 91
	mov	DWORD PTR _wc$[ebp+4], OFFSET ?staticWinProc@DockingSplitter@@KGJPAUHWND__@@IIJ@Z ; DockingSplitter::staticWinProc
; Line 92
...
; Line 103
	...
	je	SHORT $LN3@init
; Line 105
	mov	DWORD PTR ?_isHoriReg@DockingSplitter@@0HA, 1 ; DockingSplitter::_isHoriReg
; Line 107
	jmp	SHORT $LN8@init
$LN3@init:
; Line 109
	mov	DWORD PTR ?_isVertReg@DockingSplitter@@0HA, 1 ; DockingSplitter::_isVertReg
$LN8@init:
; Line 116
	mov	eax, DWORD PTR _this$[ebp]
	push	eax
...
; Line 122
	...
	pop	ebp
	ret	16					; 00000010H
?init@DockingSplitter@@QAEXPAUHINSTANCE__@@PAUHWND__@@1I@Z ENDP ; DockingSplitter::init
_TEXT	ENDS
; Function compile flags: /Odtp
