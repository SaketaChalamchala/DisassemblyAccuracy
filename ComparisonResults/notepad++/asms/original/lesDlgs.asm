; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	C:\workspace\notepad-plus-plus-6.7.9.2\PowerEditor\src\lesDlgs.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?init@ValueDlg@@QAEXPAUHINSTANCE__@@PAUHWND__@@HPB_W@Z ; ValueDlg::init
PUBLIC	?doDialog@ValueDlg@@QAEHUtagPOINT@@_N@Z		; ValueDlg::doDialog
PUBLIC	?reSizeValueBox@ValueDlg@@QAEHXZ		; ValueDlg::reSizeValueBox
PUBLIC	?run_dlgProc@ValueDlg@@MAGHIIJ@Z		; ValueDlg::run_dlgProc
PUBLIC	?doDialog@ButtonDlg@@QAEX_N@Z			; ButtonDlg::doDialog
PUBLIC	?getButtonStatus@ButtonDlg@@QBEHXZ		; ButtonDlg::getButtonStatus
PUBLIC	?run_dlgProc@ButtonDlg@@MAGHIIJ@Z		; ButtonDlg::run_dlgProc
...
tv64 = -12						; size = 4
_cmd$2 = -8						; size = 4
_isPostIt$3 = -2					; size = 1
_isFullScreen$4 = -1					; size = 1
_this$ = 8						; size = 4
_Message$ = 12						; size = 4
_wParam$ = 16						; size = 4
___formal$ = 20						; size = 4
?run_dlgProc@ButtonDlg@@MAGHIIJ@Z PROC			; ButtonDlg::run_dlgProc
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\lesdlgs.cpp
; Line 126
	push	ebp
	mov	ebp, esp
...
; Line 136
	...
	cmp	DWORD PTR tv65[ebp], 2411		; 0000096bH
	je	SHORT $LN8@run_dlgPro
	jmp	$LN2@run_dlgPro
$LN8@run_dlgPro:
; Line 140
	mov	ecx, DWORD PTR _this$[ebp]
	call	?getButtonStatus@ButtonDlg@@QBEHXZ	; ButtonDlg::getButtonStatus
...
; Line 144
	...
	je	SHORT $LN7@run_dlgPro
; Line 147
	mov	DWORD PTR _cmd$2[ebp], 44009		; 0000abe9H
...
; Line 151
	mov	DWORD PTR _cmd$2[ebp], 44032		; 0000ac00H
	jmp	SHORT $LN6@run_dlgPro
$LN5@run_dlgPro:
; Line 153
...
; Line 169
	...
	pop	ebp
	ret	16					; 00000010H
?run_dlgProc@ButtonDlg@@MAGHIIJ@Z ENDP			; ButtonDlg::run_dlgProc
_TEXT	ENDS
; Function compile flags: /Odtp
;	COMDAT ?getButtonStatus@ButtonDlg@@QBEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getButtonStatus@ButtonDlg@@QBEHXZ PROC			; ButtonDlg::getButtonStatus, COMDAT
; _this$ = ecx
...
; Line 78
	...
	pop	ebp
	ret	0
?getButtonStatus@ButtonDlg@@QBEHXZ ENDP			; ButtonDlg::getButtonStatus
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_isRTL$ = 8						; size = 1
?doDialog@ButtonDlg@@QAEX_N@Z PROC			; ButtonDlg::doDialog
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\lesdlgs.cpp
; Line 175
	push	ebp
...
; Line 179
	...
	pop	ebp
	ret	4
?doDialog@ButtonDlg@@QAEX_N@Z ENDP			; ButtonDlg::doDialog
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_i$1 = -36						; size = 4
...
_wParam$ = 16						; size = 4
___formal$ = 20						; size = 4
?run_dlgProc@ValueDlg@@MAGHIIJ@Z PROC			; ValueDlg::run_dlgProc
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\lesdlgs.cpp
; Line 83
	push	ebp
	mov	ebp, esp
...
; Line 93
	mov	ecx, DWORD PTR _this$[ebp]
	call	?reSizeValueBox@ValueDlg@@QAEHXZ	; ValueDlg::reSizeValueBox
...
; Line 121
	...
	pop	ebp
	ret	16					; 00000010H
?run_dlgProc@ValueDlg@@MAGHIIJ@Z ENDP			; ValueDlg::run_dlgProc
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_unit$ = -52						; size = 4
...
_hEdit$ = -36						; size = 4
_w$ = -32						; size = 4
_extraSize$ = -28					; size = 4
_this$ = -24						; size = 4
_rect$ = -20						; size = 16
__$ArrayPad$ = -4					; size = 4
?reSizeValueBox@ValueDlg@@QAEHXZ PROC			; ValueDlg::reSizeValueBox
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\lesdlgs.cpp
; Line 57
	push	ebp
...
; Line 80
	...
	pop	ebp
	ret	0
?reSizeValueBox@ValueDlg@@QAEHXZ ENDP			; ValueDlg::reSizeValueBox
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_result$1 = -16						; size = 4
...
_p$ = 8							; size = 8
_isRTL$ = 16						; size = 1
?doDialog@ValueDlg@@QAEHUtagPOINT@@_N@Z PROC		; ValueDlg::doDialog
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\lesdlgs.cpp
; Line 42
	push	ebp
...
; Line 53
	...
	pop	ebp
	ret	12					; 0000000cH
?doDialog@ValueDlg@@QAEHUtagPOINT@@_N@Z ENDP		; ValueDlg::doDialog
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_hInst$ = 8						; size = 4
_parent$ = 12						; size = 4
_valueToSet$ = 16					; size = 4
_text$ = 20						; size = 4
?init@ValueDlg@@QAEXPAUHINSTANCE__@@PAUHWND__@@HPB_W@Z PROC ; ValueDlg::init
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\lesdlgs.cpp
; Line 35
	push	ebp
...
; Line 39
	...
	pop	ebp
	ret	16					; 00000010H
?init@ValueDlg@@QAEXPAUHINSTANCE__@@PAUHWND__@@HPB_W@Z ENDP ; ValueDlg::init
_TEXT	ENDS
; Function compile flags: /Odtp
