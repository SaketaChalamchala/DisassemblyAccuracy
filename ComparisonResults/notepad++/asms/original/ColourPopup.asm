; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	C:\workspace\notepad-plus-plus-6.7.9.2\PowerEditor\src\WinControls\ColourPicker\ColourPopup.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?colourItems@@3PAKA				; colourItems
CONST	SEGMENT
$SG91700 DB	'ColourPopup::create : CreateDialogParam() function retur'
	DB	'n null', 00H
$SG91740 DB	00H
CONST	ENDS
_DATA	SEGMENT
?colourItems@@3PAKA DD 00H				; colourItems
	DD	040H
	DD	080H
	DD	0404080H
	DD	0ffH
...
PUBLIC	?create@ColourPopup@@QAEXH@Z			; ColourPopup::create
PUBLIC	?dlgProc@ColourPopup@@CGHPAUHWND__@@IIJ@Z	; ColourPopup::dlgProc
PUBLIC	?run_dlgProc@ColourPopup@@AAGHIIJ@Z		; ColourPopup::run_dlgProc
...
EXTRN	__imp__DrawFocusRect@8:PROC
...
CONST	ENDS
;	COMDAT ?acrCustClr@?BG@??run_dlgProc@ColourPopup@@AAGHIIJ@Z@4PAKA
_DATA	SEGMENT
?acrCustClr@?BG@??run_dlgProc@ColourPopup@@AAGHIIJ@Z@4PAKA DD 0ffffffH ; `ColourPopup::run_dlgProc'::`22'::acrCustClr
	DD	0ffffffH
	DD	0ffffffH
	DD	0ffffffH
	DD	0ffffffH
...
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
?run_dlgProc@ColourPopup@@AAGHIIJ@Z PROC		; ColourPopup::run_dlgProc
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\colourpicker\colourpopup.cpp
; Line 89
	push	ebp
	mov	ebp, esp
...
$LN28@run_dlgPro:
	cmp	DWORD PTR _nColor$7[ebp], 48		; 00000030H
...
; Line 126
	...
	cmp	DWORD PTR tv135[ebp], 2101		; 00000835H
...
; Line 180
	...
	cmp	DWORD PTR tv222[ebp], 2101		; 00000835H
	je	$LN5@run_dlgPro
	jmp	$LN3@run_dlgPro
$LN8@run_dlgPro:
; Line 194
...
; Line 242
	...
	pop	ebp
	ret	16					; 00000010H
?run_dlgProc@ColourPopup@@AAGHIIJ@Z ENDP		; ColourPopup::run_dlgProc
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv64 = -36						; size = 4
_pColourPopup$1 = -32					; size = 4
_pColourPopup$2 = -28					; size = 4
_lpmis$3 = -24						; size = 4
_rc$4 = -20						; size = 16
__$ArrayPad$ = -4					; size = 4
_hwnd$ = 8						; size = 4
...
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
?dlgProc@ColourPopup@@CGHPAUHWND__@@IIJ@Z PROC		; ColourPopup::dlgProc
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\colourpicker\colourpopup.cpp
; Line 56
	push	ebp
	mov	ebp, esp
...
; Line 74
	...
	push	ecx
	call	?run_dlgProc@ColourPopup@@AAGHIIJ@Z	; ColourPopup::run_dlgProc
; Line 75
	mov	eax, 1
	jmp	SHORT $LN7@dlgProc
$LN2@dlgProc:
...
; Line 86
	...
	pop	ebp
	ret	16					; 00000010H
?dlgProc@ColourPopup@@CGHPAUHWND__@@IIJ@Z ENDP		; ColourPopup::dlgProc
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
$T1 = -16						; size = 12
_this$ = -4						; size = 4
_dialogID$ = 8						; size = 4
?create@ColourPopup@@QAEXH@Z PROC			; ColourPopup::create
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\colourpicker\colourpopup.cpp
; Line 44
	push	ebp
...
; Line 45
	mov	eax, DWORD PTR _this$[ebp]
	push	eax
	push	OFFSET ?dlgProc@ColourPopup@@CGHPAUHWND__@@IIJ@Z ; ColourPopup::dlgProc
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	push	edx
...
; Line 53
	...
	pop	ebp
	ret	4
?create@ColourPopup@@QAEXH@Z ENDP			; ColourPopup::create
_TEXT	ENDS
; Function compile flags: /Odtp
