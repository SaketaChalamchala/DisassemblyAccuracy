; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	C:\workspace\notepad-plus-plus-6.7.9.2\PowerEditor\src\WinControls\AboutDlg\URLCtrl.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG94724 DB	00H, 00H
	ORG $+2
$SG94725 DB	'o', 00H, 'p', 00H, 'e', 00H, 'n', 00H, 00H, 00H
	ORG $+2
$SG94728 DB	'o', 00H, 'p', 00H, 'e', 00H, 'n', 00H, 00H, 00H
CONST	ENDS
_DATA	SEGMENT
_XORMask DB	0ffH
	DB	0ffH
...
PUBLIC	?create@URLCtrl@@QAEXPAUHWND__@@PA_WK@Z		; URLCtrl::create
PUBLIC	?create@URLCtrl@@QAEXPAUHWND__@@H0@Z		; URLCtrl::create
PUBLIC	?destroy@URLCtrl@@UAEXXZ			; URLCtrl::destroy
PUBLIC	?action@URLCtrl@@AAEXXZ				; URLCtrl::action
PUBLIC	?URLCtrlProc@URLCtrl@@KGJPAUHWND__@@IIJ@Z	; URLCtrl::URLCtrlProc
PUBLIC	?runProc@URLCtrl@@IAEJPAUHWND__@@IIJ@Z		; URLCtrl::runProc
...
EXTRN	__imp__CreateCursor@28:PROC
EXTRN	__imp__DestroyCursor@4:PROC
...
_hOld$2 = -724						; size = 4
_hf$3 = -720						; size = 4
_dwStyle$4 = -716					; size = 4
_hdc$5 = -712						; size = 4
_dwDTStyle$6 = -708					; size = 4
tv64 = -704						; size = 4
_this$ = -700						; size = 4
_ps$7 = -696						; size = 64
_lf$8 = -632						; size = 92
_rect$9 = -540						; size = 16
_szWinText$10 = -524					; size = 520
__$ArrayPad$ = -4					; size = 4
_hwnd$ = 8						; size = 4
_Message$ = 12						; size = 4
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
?runProc@URLCtrl@@IAEJPAUHWND__@@IIJ@Z PROC		; URLCtrl::runProc
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\aboutdlg\urlctrl.cpp
; Line 187
	push	ebp
...
; Line 188
	...
	cmp	DWORD PTR tv64[ebp], 244		; 000000f4H
	ja	$LN18@runProc
...
; Line 200
	mov	DWORD PTR _dwDTStyle$6[ebp], 32		; 00000020H
; Line 203
...
; Line 272
	mov	ecx, DWORD PTR _this$[ebp]
	call	?action@URLCtrl@@AAEXXZ			; URLCtrl::action
$LN6@runProc:
; Line 275
	jmp	SHORT $LN18@runProc
$LN5@runProc:
...
$LN23@runProc:
	...
	DB	4
	DB	3
?runProc@URLCtrl@@IAEJPAUHWND__@@IIJ@Z ENDP		; URLCtrl::runProc
_TEXT	ENDS
; Function compile flags: /Odtp
;	COMDAT ?URLCtrlProc@URLCtrl@@KGJPAUHWND__@@IIJ@Z
_TEXT	SEGMENT
_hwnd$ = 8						; size = 4
_Message$ = 12						; size = 4
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
?URLCtrlProc@URLCtrl@@KGJPAUHWND__@@IIJ@Z PROC		; URLCtrl::URLCtrlProc, COMDAT
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\aboutdlg\urlctrl.h
; Line 58
	push	ebp
	mov	ebp, esp
; Line 59
	...
	call	DWORD PTR __imp__GetWindowLongW@8
	mov	ecx, eax
	call	?runProc@URLCtrl@@IAEJPAUHWND__@@IIJ@Z	; URLCtrl::runProc
; Line 60
	pop	ebp
	ret	16					; 00000010H
?URLCtrlProc@URLCtrl@@KGJPAUHWND__@@IIJ@Z ENDP		; URLCtrl::URLCtrlProc
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv79 = -532						; size = 4
_this$ = -528						; size = 4
_szWinText$1 = -524					; size = 520
__$ArrayPad$ = -4					; size = 4
?action@URLCtrl@@AAEXXZ PROC				; URLCtrl::action
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\aboutdlg\urlctrl.cpp
; Line 160
	push	ebp
...
; Line 184
	...
	pop	ebp
	ret	0
?action@URLCtrl@@AAEXXZ ENDP				; URLCtrl::action
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?destroy@URLCtrl@@UAEXXZ PROC				; URLCtrl::destroy
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\aboutdlg\urlctrl.cpp
; Line 153
	push	ebp
...
; Line 158
	...
	pop	ebp
	ret	0
?destroy@URLCtrl@@UAEXXZ ENDP				; URLCtrl::destroy
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_itemHandle$ = 8					; size = 4
_cmd$ = 12						; size = 4
_msgDest$ = 16						; size = 4
?create@URLCtrl@@QAEXPAUHWND__@@H0@Z PROC		; URLCtrl::create
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\aboutdlg\urlctrl.cpp
; Line 132
	push	ebp
...
; Line 140
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+64], 16711680		; 00ff0000H
; Line 143
	push	OFFSET ?URLCtrlProc@URLCtrl@@KGJPAUHWND__@@IIJ@Z ; URLCtrl::URLCtrlProc
	push	-4					; fffffffcH
	mov	ecx, DWORD PTR _itemHandle$[ebp]
	push	ecx
	call	DWORD PTR __imp__SetWindowLongW@12
...
; Line 150
	...
	pop	ebp
	ret	12					; 0000000cH
?create@URLCtrl@@QAEXPAUHWND__@@H0@Z ENDP		; URLCtrl::create
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_itemHandle$ = 8					; size = 4
_link$ = 12						; size = 4
_linkColor$ = 16					; size = 4
?create@URLCtrl@@QAEXPAUHWND__@@PA_WK@Z PROC		; URLCtrl::create
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\aboutdlg\urlctrl.cpp
; Line 108
	push	ebp
...
; Line 120
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+68], 8388736		; 00800080H
; Line 123
	push	OFFSET ?URLCtrlProc@URLCtrl@@KGJPAUHWND__@@IIJ@Z ; URLCtrl::URLCtrlProc
	push	-4					; fffffffcH
	mov	eax, DWORD PTR _itemHandle$[ebp]
...
; Line 130
	...
	pop	ebp
	ret	12					; 0000000cH
?create@URLCtrl@@QAEXPAUHWND__@@PA_WK@Z ENDP		; URLCtrl::create
_TEXT	ENDS
; Function compile flags: /Odtp
