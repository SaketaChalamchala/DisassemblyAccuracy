...
PUBLIC	?HandleData@nsBig5Prober@@UAE?AW4nsProbingState@@PBDI@Z ; nsBig5Prober::HandleData
PUBLIC	?Reset@nsBig5Prober@@UAEXXZ			; nsBig5Prober::Reset
PUBLIC	?GetConfidence@nsBig5Prober@@UAEMXZ		; nsBig5Prober::GetConfidence
...
_distribCf$ = -8					; size = 4
_this$ = -4						; size = 4
?GetConfidence@nsBig5Prober@@UAEMXZ PROC		; nsBig5Prober::GetConfidence
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\uchardet\nsbig5prober.cpp
; Line 83
	push	ebp
...
; Line 87
	...
	pop	ebp
	ret	0
?GetConfidence@nsBig5Prober@@UAEMXZ ENDP		; nsBig5Prober::GetConfidence
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Reset@nsBig5Prober@@UAEXXZ PROC			; nsBig5Prober::Reset
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\uchardet\nsbig5prober.cpp
; Line 41
	push	ebp
...
; Line 45
	...
	pop	ebp
	ret	0
?Reset@nsBig5Prober@@UAEXXZ ENDP			; nsBig5Prober::Reset
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv198 = -20						; size = 4
...
_aBuf$ = 8						; size = 4
_aLen$ = 12						; size = 4
?HandleData@nsBig5Prober@@UAE?AW4nsProbingState@@PBDI@Z PROC ; nsBig5Prober::HandleData
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\uchardet\nsbig5prober.cpp
; Line 48
	push	ebp
...
; Line 80
	...
	pop	ebp
	ret	8
?HandleData@nsBig5Prober@@UAE?AW4nsProbingState@@PBDI@Z ENDP ; nsBig5Prober::HandleData
_TEXT	ENDS
; Function compile flags: /Odtp
