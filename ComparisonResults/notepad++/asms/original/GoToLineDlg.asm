; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	C:\workspace\notepad-plus-plus-6.7.9.2\PowerEditor\src\ScitillaComponent\GoToLineDlg.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?run_dlgProc@GoToLineDlg@@MAGHIIJ@Z		; GoToLineDlg::run_dlgProc
PUBLIC	?updateLinesNumbers@GoToLineDlg@@ABEXXZ		; GoToLineDlg::updateLinesNumbers
PUBLIC	?cleanLineEdit@GoToLineDlg@@ABEXXZ		; GoToLineDlg::cleanLineEdit
PUBLIC	?getLine@GoToLineDlg@@ABEHXZ			; GoToLineDlg::getLine
...
_TEXT	ENDS
; Function compile flags: /Odtp
;	COMDAT ?getLine@GoToLineDlg@@ABEHXZ
_TEXT	SEGMENT
_line$ = -16						; size = 4
_isSuccessful$ = -12					; size = 4
_this$ = -8						; size = 4
tv75 = -4						; size = 4
?getLine@GoToLineDlg@@ABEHXZ PROC			; GoToLineDlg::getLine, COMDAT
; _this$ = ecx
...
; Line 87
	...
	pop	ebp
	ret	0
?getLine@GoToLineDlg@@ABEHXZ ENDP			; GoToLineDlg::getLine
_TEXT	ENDS
; Function compile flags: /Odtp
;	COMDAT ?cleanLineEdit@GoToLineDlg@@ABEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?cleanLineEdit@GoToLineDlg@@ABEXXZ PROC			; GoToLineDlg::cleanLineEdit, COMDAT
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\scitillacomponent\gotolinedlg.h
; Line 79
	push	ebp
...
; Line 81
	...
	pop	ebp
	ret	0
?cleanLineEdit@GoToLineDlg@@ABEXXZ ENDP			; GoToLineDlg::cleanLineEdit
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_limit$ = -12						; size = 4
_current$ = -8						; size = 4
_this$ = -4						; size = 4
?updateLinesNumbers@GoToLineDlg@@ABEXXZ PROC		; GoToLineDlg::updateLinesNumbers
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\scitillacomponent\gotolinedlg.cpp
; Line 131
	push	ebp
...
; Line 147
	...
	pop	ebp
	ret	0
?updateLinesNumbers@GoToLineDlg@@ABEXXZ ENDP		; GoToLineDlg::updateLinesNumbers
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_notification$1 = -116					; size = 92
_sci_line$2 = -24					; size = 4
tv230 = -20						; size = 4
tv64 = -16						; size = 4
_line$3 = -12						; size = 4
tv80 = -8						; size = 4
_isOffset$4 = -2					; size = 1
_isLine$5 = -1						; size = 1
_this$ = 8						; size = 4
_message$ = 12						; size = 4
_wParam$ = 16						; size = 4
___formal$ = 20						; size = 4
?run_dlgProc@GoToLineDlg@@MAGHIIJ@Z PROC		; GoToLineDlg::run_dlgProc
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\scitillacomponent\gotolinedlg.cpp
; Line 33
	push	ebp
	mov	ebp, esp
...
; Line 44
	...
	jmp	$LN6@run_dlgPro
$LN23@run_dlgPro:
	cmp	DWORD PTR tv80[ebp], 2007		; 000007d7H
	jb	$LN6@run_dlgPro
	cmp	DWORD PTR tv80[ebp], 2008		; 000007d8H
	jbe	$LN9@run_dlgPro
	jmp	$LN6@run_dlgPro
$LN14@run_dlgPro:
; Line 47
...
; Line 48
	mov	ecx, DWORD PTR _this$[ebp]
	call	?cleanLineEdit@GoToLineDlg@@ABEXXZ	; GoToLineDlg::cleanLineEdit
; Line 49
	mov	eax, 1
	jmp	$LN21@run_dlgPro
$LN13@run_dlgPro:
; Line 53
	mov	ecx, DWORD PTR _this$[ebp]
	call	?getLine@GoToLineDlg@@ABEHXZ		; GoToLineDlg::getLine
...
; Line 77
	...
	add	esp, 12					; 0000000cH
; Line 78
	mov	DWORD PTR _notification$1[ebp+8], 2013	; 000007ddH
; Line 79
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+12]
...
$LN9@run_dlgPro:
; Line 92
	cmp	DWORD PTR _wParam$[ebp], 2007		; 000007d7H
...
; Line 106
	mov	ecx, DWORD PTR _this$[ebp]
	call	?updateLinesNumbers@GoToLineDlg@@ABEXXZ	; GoToLineDlg::updateLinesNumbers
; Line 107
	mov	eax, 1
...
; Line 111
	...
	cmp	DWORD PTR tv230[ebp], 256		; 00000100H
	je	SHORT $LN3@run_dlgPro
...
; Line 128
	...
	pop	ebp
	ret	16					; 00000010H
?run_dlgProc@GoToLineDlg@@MAGHIIJ@Z ENDP		; GoToLineDlg::run_dlgProc
_TEXT	ENDS
; Function compile flags: /Odtp
