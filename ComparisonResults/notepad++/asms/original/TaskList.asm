; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	C:\workspace\notepad-plus-plus-6.7.9.2\PowerEditor\src\WinControls\TaskList\TaskList.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG123112 DB	00H, 00H
	ORG $+2
$SG123113 DB	'S', 00H, 'y', 00H, 's', 00H, 'L', 00H, 'i', 00H, 's', 00H
	DB	't', 00H, 'V', 00H, 'i', 00H, 'e', 00H, 'w', 00H, '3', 00H, '2'
	DB	00H, 00H, 00H
$SG123117 DB	'TaskList::init : CreateWindowEx() function return null', 00H
CONST	ENDS
PUBLIC	?init@Window@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z	; Window::init
PUBLIC	?init@TaskList@@QAEXPAUHINSTANCE__@@PAUHWND__@@PAU_IMAGELIST@@HH@Z ; TaskList::init
PUBLIC	?destroy@TaskList@@UAEXXZ			; TaskList::destroy
PUBLIC	?setFont@TaskList@@QAEXPA_WI@Z			; TaskList::setFont
PUBLIC	?adjustSize@TaskList@@QAE?AUtagRECT@@XZ		; TaskList::adjustSize
PUBLIC	?updateCurrentIndex@TaskList@@QAEHXZ		; TaskList::updateCurrentIndex
PUBLIC	?runProc@TaskList@@IAEJPAUHWND__@@IIJ@Z		; TaskList::runProc
PUBLIC	?staticProc@TaskList@@KGJPAUHWND__@@IIJ@Z	; TaskList::staticProc
PUBLIC	_hypot
...
_TEXT	ENDS
; Function compile flags: /Odtp
;	COMDAT ?staticProc@TaskList@@KGJPAUHWND__@@IIJ@Z
_TEXT	SEGMENT
_hwnd$ = 8						; size = 4
_Message$ = 12						; size = 4
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
?staticProc@TaskList@@KGJPAUHWND__@@IIJ@Z PROC		; TaskList::staticProc, COMDAT
...
; Line 70
	...
	mov	ecx, eax
	call	?runProc@TaskList@@IAEJPAUHWND__@@IIJ@Z	; TaskList::runProc
; Line 71
	pop	ebp
	ret	16					; 00000010H
?staticProc@TaskList@@KGJPAUHWND__@@IIJ@Z ENDP		; TaskList::staticProc
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
__macro_lvi$1 = -464					; size = 52
__macro_lvi$2 = -412					; size = 52
__macro_lvi$3 = -360					; size = 52
__macro_lvi$4 = -308					; size = 52
__macro_lvi$5 = -256					; size = 52
__macro_lvi$6 = -204					; size = 52
__macro_lvi$7 = -152					; size = 52
__macro_lvi$8 = -100					; size = 52
tv353 = -48						; size = 4
tv88 = -44						; size = 4
tv257 = -40						; size = 4
tv180 = -36						; size = 4
_zDelta$9 = -32						; size = 2
_selected$10 = -28					; size = 4
_selected$11 = -24					; size = 4
_selected$12 = -20					; size = 4
_selected$13 = -16					; size = 4
tv64 = -12						; size = 4
_msg$14 = -8						; size = 4
_this$ = -4						; size = 4
_hwnd$ = 8						; size = 4
...
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
?runProc@TaskList@@IAEJPAUHWND__@@IIJ@Z PROC		; TaskList::runProc
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklist.cpp
; Line 177
	push	ebp
	mov	ebp, esp
...
$LN6@runProc:
	...
	cmp	DWORD PTR [ecx+8], 38			; 00000026H
	jne	$LN8@runProc
$LN7@runProc:
; Line 243
	mov	edx, DWORD PTR _this$[ebp]
...
; Line 257
	...
	mov	edx, DWORD PTR _msg$14[ebp]
	cmp	DWORD PTR [edx+8], 40			; 00000028H
	jne	$LN5@runProc
$LN3@runProc:
; Line 259
	mov	eax, DWORD PTR _this$[ebp]
...
; Line 284
	...
	pop	ebp
	ret	16					; 00000010H
?runProc@TaskList@@IAEJPAUHWND__@@IIJ@Z ENDP		; TaskList::runProc
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_isSelected$1 = -12					; size = 4
_this$ = -8						; size = 4
_i$2 = -4						; size = 4
?updateCurrentIndex@TaskList@@QAEHXZ PROC		; TaskList::updateCurrentIndex
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklist.cpp
; Line 163
	push	ebp
...
; Line 174
	...
	pop	ebp
	ret	0
?updateCurrentIndex@TaskList@@QAEHXZ ENDP		; TaskList::updateCurrentIndex
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
__macro_lvi$1 = -636					; size = 52
_leftMarge$ = -584					; size = 4
_w7BottomMarge$ = -580					; size = 4
_xpBottomMarge$ = -576					; size = 4
_imgWidth$ = -572					; size = 4
tv66 = -568						; size = 4
_width$2 = -564						; size = 4
_ver$ = -560						; size = 4
tv197 = -556						; size = 4
_maxwidth$ = -552					; size = 4
_i$3 = -548						; size = 4
_this$ = -544						; size = 4
_rc$ = -540						; size = 16
_buf$4 = -524						; size = 520
...
___$ReturnUdt$ = 8					; size = 4
?adjustSize@TaskList@@QAE?AUtagRECT@@XZ PROC		; TaskList::adjustSize
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklist.cpp
; Line 105
	push	ebp
...
; Line 109
	mov	DWORD PTR _leftMarge$[ebp], 30		; 0000001eH
; Line 110
	mov	DWORD PTR _xpBottomMarge$[ebp], 5
; Line 111
	mov	DWORD PTR _w7BottomMarge$[ebp], 15	; 0000000fH
; Line 114
	push	0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+24]
...
; Line 123
	...
	mov	DWORD PTR __macro_lvi$1[ebp+24], 260	; 00000104H
...
$LN9@adjustSize:
	mov	DWORD PTR tv197[ebp], 15		; 0000000fH
$LN10@adjustSize:
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 137
	...
	pop	ebp
	ret	4
?adjustSize@TaskList@@QAE?AUtagRECT@@XZ ENDP		; TaskList::adjustSize
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_fontName$ = 8						; size = 4
_fontSize$ = 12						; size = 4
?setFont@TaskList@@QAEXPA_WI@Z PROC			; TaskList::setFont
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklist.cpp
; Line 140
	push	ebp
...
; Line 160
	...
	pop	ebp
	ret	8
?setFont@TaskList@@QAEXPA_WI@Z ENDP			; TaskList::setFont
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?destroy@TaskList@@UAEXXZ PROC				; TaskList::destroy
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklist.cpp
; Line 95
	push	ebp
...
; Line 102
	...
	pop	ebp
	ret	0
?destroy@TaskList@@UAEXXZ ENDP				; TaskList::destroy
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
__macro_lvi$1 = -116					; size = 52
_lvColumn$ = -64					; size = 32
$T2 = -32						; size = 12
_icex$ = -20						; size = 8
_listViewStyles$ = -12					; size = 4
_exStyle$ = -8						; size = 4
_this$ = -4						; size = 4
_hInst$ = 8						; size = 4
_parent$ = 12						; size = 4
_hImaLst$ = 16						; size = 4
_nbItem$ = 20						; size = 4
_index2set$ = 24					; size = 4
?init@TaskList@@QAEXPAUHINSTANCE__@@PAUHWND__@@PAU_IMAGELIST@@HH@Z PROC ; TaskList::init
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklist.cpp
; Line 37
	push	ebp
...
; Line 54
	mov	DWORD PTR _listViewStyles$[ebp], 54597	; 0000d545H
; Line 66
	push	0
	mov	ecx, DWORD PTR _hInst$[ebp]
	push	ecx
...
; Line 73
	push	OFFSET ?staticProc@TaskList@@KGJPAUHWND__@@IIJ@Z ; TaskList::staticProc
	push	-4					; fffffffcH
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+12]
	push	eax
...
; Line 83
	mov	DWORD PTR _lvColumn$[ebp+8], 500	; 000001f4H
; Line 85
...
; Line 92
	...
	pop	ebp
	ret	20					; 00000014H
?init@TaskList@@QAEXPAUHINSTANCE__@@PAUHWND__@@PAU_IMAGELIST@@HH@Z ENDP ; TaskList::init
_TEXT	ENDS
; Function compile flags: /Odtp
