; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	C:\workspace\notepad-plus-plus-6.7.9.2\PowerEditor\src\WinControls\TaskList\TaskListDlg.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG123977 DB	'V', 00H, 'e', 00H, 'r', 00H, 'd', 00H, 'a', 00H, 'n', 00H
	DB	'a', 00H, 00H, 00H
$SG124025 DB	' ', 00H, 00H, 00H
CONST	ENDS
PUBLIC	_hypot
...
PUBLIC	?getCurrentIndex@TaskList@@QBEHXZ		; TaskList::getCurrentIndex
PUBLIC	?getImgLst@TaskList@@QBEPAU_IMAGELIST@@XZ	; TaskList::getImgLst
PUBLIC	?GetFontSelected@TaskList@@QAEPAUHFONT__@@XZ	; TaskList::GetFontSelected
...
PUBLIC	?doDialog@TaskListDlg@@QAEH_N@Z			; TaskListDlg::doDialog
PUBLIC	?run_dlgProc@TaskListDlg@@MAGHIIJ@Z		; TaskListDlg::run_dlgProc
PUBLIC	?drawItem@TaskListDlg@@AAEXPAUtagDRAWITEMSTRUCT@@@Z ; TaskListDlg::drawItem
...
EXTRN	?init@TaskList@@QAEXPAUHINSTANCE__@@PAUHWND__@@PAU_IMAGELIST@@HH@Z:PROC ; TaskList::init
EXTRN	?setFont@TaskList@@QAEXPA_WI@Z:PROC		; TaskList::setFont
EXTRN	?adjustSize@TaskList@@QAE?AUtagRECT@@XZ:PROC	; TaskList::adjustSize
EXTRN	?updateCurrentIndex@TaskList@@QAEHXZ:PROC	; TaskList::updateCurrentIndex
...
; Function compile flags: /Odtp
_TEXT	SEGMENT
_charPixel$ = -104					; size = 8
_marge$ = -96						; size = 4
_imgStyle$ = -92					; size = 4
_textColor$ = -88					; size = 4
_spaceUnit$ = -84					; size = 4
_iImage$ = -80						; size = 4
_nItem$ = -76						; size = 4
_hImgLst$ = -72						; size = 4
_label$ = -68						; size = 4
_imageRect$ = -64					; size = 4
_this$ = -60						; size = 4
_hDC$ = -56						; size = 4
_info$ = -52						; size = 32
_rect$ = -20						; size = 16
...
?drawItem@TaskListDlg@@AAEXPAUtagDRAWITEMSTRUCT@@@Z PROC ; TaskListDlg::drawItem
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklistdlg.cpp
; Line 169
	push	ebp
	mov	ebp, esp
...
; Line 176
	mov	DWORD PTR _textColor$[ebp], 4210752	; 00404040H
; Line 177
...
; Line 183
	...
	call	?GetFontSelected@TaskList@@QAEPAUHFONT__@@XZ ; TaskList::GetFontSelected
	push	eax
...
; Line 189
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 32					; 00000020H
	call	?getImgLst@TaskList@@QBEPAU_IMAGELIST@@XZ ; TaskList::getImgLst
...
; Line 213
	...
	pop	ebp
	ret	4
?drawItem@TaskListDlg@@AAEXPAUtagDRAWITEMSTRUCT@@@Z ENDP ; TaskListDlg::drawItem
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv254 = -64						; size = 4
_view2set$1 = -60					; size = 4
_index2Switch$2 = -56					; size = 4
_listIndex$3 = -52					; size = 4
_fileNameStatus$4 = -48					; size = 4
tv84 = -44						; size = 4
tv225 = -40						; size = 4
_lvItem$5 = -36						; size = 4
_nbTotal$6 = -32					; size = 4
_i2set$7 = -28						; size = 4
tv64 = -24						; size = 4
$T8 = -20						; size = 16
__$ArrayPad$ = -4					; size = 4
...
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
?run_dlgProc@TaskListDlg@@MAGHIIJ@Z PROC		; TaskListDlg::run_dlgProc
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklistdlg.cpp
; Line 58
	push	ebp
	mov	ebp, esp
...
$LN25@run_dlgPro:
	...
	je	$LN6@run_dlgPro
	cmp	DWORD PTR tv64[ebp], 517		; 00000205H
	je	$LN14@run_dlgPro
	jmp	$LN1@run_dlgPro
$LN18@run_dlgPro:
; Line 63
...
; Line 74
	...
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 32					; 00000020H
	call	?init@TaskList@@QAEXPAUHINSTANCE__@@PAUHWND__@@PAU_IMAGELIST@@HH@Z ; TaskList::init
; Line 75
	push	14					; 0000000eH
	push	OFFSET $SG123977
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 32					; 00000020H
	call	?setFont@TaskList@@QAEXPA_WI@Z		; TaskList::setFont
; Line 76
	lea	eax, DWORD PTR $T8[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 32					; 00000020H
	call	?adjustSize@TaskList@@QAE?AUtagRECT@@XZ	; TaskList::adjustSize
	mov	ecx, DWORD PTR _this$[ebp]
...
; Line 87
	...
	push	ecx
	push	OFFSET ?hookProc@@YGJIIJ@Z		; hookProc
	push	14					; 0000000eH
...
; Line 102
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 32					; 00000020H
	call	?getCurrentIndex@TaskList@@QBEHXZ	; TaskList::getCurrentIndex
	push	eax
	push	2451					; 00000993H
	push	273					; 00000111H
	mov	edx, DWORD PTR _this$[ebp]
...
; Line 109
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?drawItem@TaskListDlg@@AAEXPAUtagDRAWITEMSTRUCT@@@Z ; TaskListDlg::drawItem
; Line 110
	mov	eax, 1
	jmp	$LN21@run_dlgPro
$LN12@run_dlgPro:
; Line 115
	...
	cmp	DWORD PTR tv225[ebp], -177		; ffffff4fH
	je	SHORT $LN9@run_dlgPro
	cmp	DWORD PTR tv225[ebp], -5		; fffffffbH
	je	SHORT $LN8@run_dlgPro
	cmp	DWORD PTR tv225[ebp], -2		; fffffffeH
	je	SHORT $LN8@run_dlgPro
...
; Line 132
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 32					; 00000020H
	call	?updateCurrentIndex@TaskList@@QAEHXZ	; TaskList::updateCurrentIndex
	push	eax
	push	2451					; 00000993H
	push	273					; 00000111H
	mov	edx, DWORD PTR _this$[ebp]
...
; Line 144
	...
	cmp	DWORD PTR tv254[ebp], 2451		; 00000993H
...
; Line 166
	...
	pop	ebp
	ret	16					; 00000010H
?run_dlgProc@TaskListDlg@@MAGHIIJ@Z ENDP		; TaskListDlg::run_dlgProc
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_result$1 = -16						; size = 4
_hMyDlgTemplate$2 = -12					; size = 4
_pMyDlgTemplate$3 = -8					; size = 4
_this$ = -4						; size = 4
_isRTL$ = 8						; size = 1
?doDialog@TaskListDlg@@QAEH_N@Z PROC			; TaskListDlg::doDialog
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklistdlg.cpp
; Line 45
	push	ebp
...
; Line 55
	...
	pop	ebp
	ret	4
?doDialog@TaskListDlg@@QAEH_N@Z ENDP			; TaskListDlg::doDialog
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_nCode$ = 8						; size = 4
_wParam$ = 12						; size = 4
_lParam$ = 16						; size = 4
?hookProc@@YGJIIJ@Z PROC				; hookProc
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklistdlg.cpp
; Line 35
	push	ebp
	mov	ebp, esp
; Line 36
	...
	cmp	DWORD PTR _wParam$[ebp], 517		; 00000205H
...
; Line 42
	pop	ebp
	ret	12					; 0000000cH
?hookProc@@YGJIIJ@Z ENDP				; hookProc
_TEXT	ENDS
; Function compile flags: /Odtp
...
_TEXT	ENDS
; Function compile flags: /Odtp
;	COMDAT ?GetFontSelected@TaskList@@QAEPAUHFONT__@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?GetFontSelected@TaskList@@QAEPAUHFONT__@@XZ PROC	; TaskList::GetFontSelected, COMDAT
; _this$ = ecx
...
; Line 62
	...
	pop	ebp
	ret	0
?GetFontSelected@TaskList@@QAEPAUHFONT__@@XZ ENDP	; TaskList::GetFontSelected
_TEXT	ENDS
; Function compile flags: /Odtp
;	COMDAT ?getImgLst@TaskList@@QBEPAU_IMAGELIST@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getImgLst@TaskList@@QBEPAU_IMAGELIST@@XZ PROC		; TaskList::getImgLst, COMDAT
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklist.h
; Line 58
	push	ebp
...
; Line 60
	...
	pop	ebp
	ret	0
?getImgLst@TaskList@@QBEPAU_IMAGELIST@@XZ ENDP		; TaskList::getImgLst
_TEXT	ENDS
; Function compile flags: /Odtp
;	COMDAT ?getCurrentIndex@TaskList@@QBEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getCurrentIndex@TaskList@@QBEHXZ PROC			; TaskList::getCurrentIndex, COMDAT
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\wincontrols\tasklist\tasklist.h
; Line 55
	push	ebp
	...
	pop	ebp
	ret	0
?getCurrentIndex@TaskList@@QBEHXZ ENDP			; TaskList::getCurrentIndex
_TEXT	ENDS
; Function compile flags: /Odtp
