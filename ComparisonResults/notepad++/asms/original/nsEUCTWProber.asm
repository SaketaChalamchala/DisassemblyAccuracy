...
PUBLIC	?HandleData@nsEUCTWProber@@UAE?AW4nsProbingState@@PBDI@Z ; nsEUCTWProber::HandleData
PUBLIC	?Reset@nsEUCTWProber@@UAEXXZ			; nsEUCTWProber::Reset
PUBLIC	?GetConfidence@nsEUCTWProber@@UAEMXZ		; nsEUCTWProber::GetConfidence
...
_distribCf$ = -8					; size = 4
_this$ = -4						; size = 4
?GetConfidence@nsEUCTWProber@@UAEMXZ PROC		; nsEUCTWProber::GetConfidence
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\uchardet\nseuctwprober.cpp
; Line 86
	push	ebp
...
; Line 90
	...
	pop	ebp
	ret	0
?GetConfidence@nsEUCTWProber@@UAEMXZ ENDP		; nsEUCTWProber::GetConfidence
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Reset@nsEUCTWProber@@UAEXXZ PROC			; nsEUCTWProber::Reset
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\uchardet\nseuctwprober.cpp
; Line 41
	push	ebp
...
; Line 46
	...
	pop	ebp
	ret	0
?Reset@nsEUCTWProber@@UAEXXZ ENDP			; nsEUCTWProber::Reset
_TEXT	ENDS
; Function compile flags: /Odtp
_TEXT	SEGMENT
tv198 = -20						; size = 4
...
_aBuf$ = 8						; size = 4
_aLen$ = 12						; size = 4
?HandleData@nsEUCTWProber@@UAE?AW4nsProbingState@@PBDI@Z PROC ; nsEUCTWProber::HandleData
; _this$ = ecx
; File c:\workspace\notepad-plus-plus-6.7.9.2\powereditor\src\uchardet\nseuctwprober.cpp
; Line 49
	push	ebp
...
; Line 83
	...
	pop	ebp
	ret	8
?HandleData@nsEUCTWProber@@UAE?AW4nsProbingState@@PBDI@Z ENDP ; nsEUCTWProber::HandleData
_TEXT	ENDS
; Function compile flags: /Odtp
