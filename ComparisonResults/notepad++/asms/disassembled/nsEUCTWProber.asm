...
.text$mn:00000000 ; +-------------------------------------------------------------------------+
.text$mn:00000000 ;
.text$mn:00000000 ; Input MD5   : 04DF5B4AC989D403938028AA8828B592
.text$mn:00000000 ; Input CRC32 : 6BE63E74
.text$mn:00000000
...
.text$mn:00000000
.text$mn:00000000 ; public: virtual enum  nsProbingState __thiscall nsEUCTWProber::HandleData(char const *, unsigned int)
.text$mn:00000000                 public ?HandleData@nsEUCTWProber@@UAE?AW4nsProbingState@@PBDI@Z
.text$mn:00000000 ?HandleData@nsEUCTWProber@@UAE?AW4nsProbingState@@PBDI@Z proc near
.text$mn:00000000
...
.text$mn:00000013 ; ---------------------------------------------------------------------------
.text$mn:00000013
.text$mn:00000013 loc_13:                                 ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint):loc_BBj
.text$mn:00000013                 mov     eax, [ebp+var_8]
.text$mn:00000016                 add     eax, 1
.text$mn:00000019                 mov     [ebp+var_8], eax
.text$mn:0000001C
.text$mn:0000001C loc_1C:                                 ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+11j
...
.text$mn:00000052 ; ---------------------------------------------------------------------------
.text$mn:00000052
.text$mn:00000052 loc_52:                                 ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+44j
...
.text$mn:000000A1 ; ---------------------------------------------------------------------------
.text$mn:000000A1
.text$mn:000000A1 loc_A1:                                 ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+6Aj
...
.text$mn:000000BB
.text$mn:000000BB loc_BB:                                 ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+56j
.text$mn:000000BB                                         ; nsEUCTWProber::HandleData(char const *,uint)+9Fj
.text$mn:000000BB                 jmp     loc_13
.text$mn:000000C0 ; ---------------------------------------------------------------------------
.text$mn:000000C0
.text$mn:000000C0 loc_C0:                                 ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+22j
.text$mn:000000C0                                         ; nsEUCTWProber::HandleData(char const *,uint)+50j
...
.text$mn:0000011B
.text$mn:0000011B loc_11B:                                ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+DFj
.text$mn:0000011B                                         ; nsEUCTWProber::HandleData(char const *,uint)+F1j ...
...
.text$mn:00000125 ?HandleData@nsEUCTWProber@@UAE?AW4nsProbingState@@PBDI@Z endp
.text$mn:00000125
.text$mn:00000125 ; ---------------------------------------------------------------------------
...
.text$mn:00000130
.text$mn:00000130 ; void __thiscall nsEUCTWProber::Reset(nsEUCTWProber *__hidden this)
.text$mn:00000130                 public ?Reset@nsEUCTWProber@@UAEXXZ
.text$mn:00000130 ?Reset@nsEUCTWProber@@UAEXXZ proc near
.text$mn:00000130
...
.text$mn:00000162 ?Reset@nsEUCTWProber@@UAEXXZ endp
.text$mn:00000162
.text$mn:00000162 ; ---------------------------------------------------------------------------
...
.text$mn:00000170
.text$mn:00000170 ; float __thiscall nsEUCTWProber::GetConfidence(nsEUCTWProber *__hidden this)
.text$mn:00000170                 public ?GetConfidence@nsEUCTWProber@@UAEMXZ
.text$mn:00000170 ?GetConfidence@nsEUCTWProber@@UAEMXZ proc near
.text$mn:00000170
...
.text$mn:0000018D ?GetConfidence@nsEUCTWProber@@UAEMXZ endp
.text$mn:0000018D
.text$mn:0000018D ; ---------------------------------------------------------------------------
...
.text$mn:00000190                                         ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+5Ep
.text$mn:00000190
...
.text$mn:000001A4                                         ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+E7p
.text$mn:000001A4
...
.text$mn:000001D0                                         ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+9Ap
.text$mn:000001D0                                         ; nsEUCTWProber::HandleData(char const *,uint)+B6p
.text$mn:000001D0
...
.text$mn:0000024C                                         ; CODE XREF: nsEUCTWProber::HandleData(char const *,uint)+38p
.text$mn:0000024C
...
.text$mn:0000033C                                         ; CODE XREF: nsEUCTWProber::Reset(void)+2Ap
.text$mn:0000033C
...
.text$mn:00000388                                         ; CODE XREF: nsEUCTWProber::Reset(void)+Dp
.text$mn:00000388
...
.rdata:0000039C __real@3f733333 dd 3F733333h            ; DATA XREF: nsEUCTWProber::HandleData(char const *,uint)+108r
...
UNDEF:000003A0                                         ; CODE XREF: nsEUCTWProber::GetConfidence(void)+Fp
