?init@ValueDlg@@QAEXPAUHINSTANCE__@@PAUHWND__@@HPB_W@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['10h']
endp
?doDialog@ValueDlg@@QAEHUtagPOINT@@_N@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '10h']
...
retn ['0Ch']
endp
?reSizeValueBox@ValueDlg@@QAEHXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '34h']
...
retn
endp
?run_dlgProc@ValueDlg@@MAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '24h']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn ['10h']
endp
?doDialog@ButtonDlg@@QAEX_N@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?run_dlgProc@ButtonDlg@@MAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '1Ch']
mov ['eax,', '[ebp+arg_4]']
...
test ['ecx,', 'ecx']
jz ['short', 'loc_3D8']
mov ['[ebp+wParam],', '0ABE9h']
jmp ['short', 'loc_3F8']
movzx ['edx,', '[ebp+var_1]']
test ['edx,', 'edx']
jz ['short', 'loc_3E9']
mov ['[ebp+wParam],', '0AC00h']
jmp ['short', 'loc_3F8']
movzx ['eax,', '[ebp+var_2]']
test ['eax,', 'eax']
jz ['short', 'loc_3F8']
