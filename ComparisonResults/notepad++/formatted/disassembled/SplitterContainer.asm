?create@SplitterContainer@@QAEXPAVWindow@@0HW4SplitterMode@@H_N@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '48h']
mov ['[ebp+lpParam],', 'ecx']
...
mov ['edx,', '[ebp+lpParam]']
mov ['[edx+80h],', 'ecx']
movzx ['eax,', 'ds:?_isRegistered@SplitterContainer@@0_NA']
test ['eax,', 'eax']
jnz ['loc_257']
mov ['[ebp+WndClass.style],', '8']
mov ['[ebp+WndClass.lpfnWndProc],', 'offset', '?staticWinProc@SplitterContainer@@CGJPAUHWND__@@IIJ@Z']
...
mov ['[ebp+WndClass.lpszClassName],', 'offset', '$SG91554']
...
mov ['ds:?_isRegistered@SplitterContainer@@0_NA,', '1']
mov ['eax,', '[ebp+lpParam]']
push ['eax']
mov ['ecx,', '[ebp+lpParam]']
mov ['edx,', '[ecx+4]']
...
retn ['18h']
endp
?staticWinProc@SplitterContainer@@CGJPAUHWND__@@IIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '8']
mov ['[ebp+dwNewLong],', '0']
...
retn ['10h']
endp
?runProc@SplitterContainer@@AAEJIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '60h']
...
jz ['loc_737']
jmp ['loc_7F1']
cmp ['[ebp+var_2C],', '13A2h']
jz ['loc_6AA']
cmp ['[ebp+var_2C],', '13A3h']
jz ['loc_56C']
cmp ['[ebp+var_2C],', '13A4h']
jz ['loc_465']
jmp ['loc_7F1']
mov ['ecx,', '[ebp+var_28]']
mov ['edx,', '[ecx+80h]']
...
retn ['0Ch']
endp
?rotateTo@SplitterContainer@@AAEX_N@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '14h']
mov ['[ebp+var_8],', 'ecx']
...
retn
endp
?getPhisicalSize@Splitter@@QBEHXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
