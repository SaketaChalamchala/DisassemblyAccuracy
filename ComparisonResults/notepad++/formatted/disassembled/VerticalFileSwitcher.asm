?activateDoc@VerticalFileSwitcher@@QBEXPAUTaskLstFnStatus@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '20h']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?setHeaderOrder@VerticalFileSwitcher@@QAEHPAUtagNMLISTVIEW@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '38h']
mov ['[ebp+var_18],', 'ecx']
...
retn ['4']
endp
?run_dlgProc@VerticalFileSwitcher@@MAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['0FFFFFFFFh']
push ['offset', '__ehhandler$?run_dlgProc@VerticalFileSwitcher@@MAGHIIJ@Z']
mov ['eax,', 'large', 'fs:0']
push ['eax']
sub ['esp,', '11Ch']
...
retn ['10h']
endp
?ListViewCompareProc@@YGHJJJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '4ACh']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn ['0Ch']
endp
__unwindfunclet$?run_dlgProc@VerticalFileSwitcher@@MAGHIIJ@Z$0 proc near
lea ['ecx,', '[ebp-2Ch]']
jmp ['??1?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QAE@XZ']
endp
__ehhandler$?run_dlgProc@VerticalFileSwitcher@@MAGHIIJ@Z proc near
mov ['edx,', '[esp+arg_4]']
lea ['eax,', '[edx+0Ch]']
mov ['ecx,', '[edx-120h]']
xor ['ecx,', 'eax']
...
retn
endp
?getFullFilePath@VerticalFileSwitcher@@QBE?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@I@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['0FFFFFFFFh']
push ['offset', '__ehhandler$?getFullFilePath@VerticalFileSwitcher@@QBE?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@I@Z']
mov ['eax,', 'large', 'fs:0']
push ['eax']
sub ['esp,', '8']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn ['8']
endp
__unwindfunclet$?getFullFilePath@VerticalFileSwitcher@@QBE?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@I@Z$0 proc near
mov ['eax,', '[ebp-10h]']
and ['eax,', '1']
jz ['$LN4']
...
retn
endp
__ehhandler$?getFullFilePath@VerticalFileSwitcher@@QBE?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@I@Z proc near
mov ['edx,', '[esp+arg_4]']
lea ['eax,', '[edx+0Ch]']
mov ['ecx,', '[edx-0Ch]']
xor ['ecx,', 'eax']
