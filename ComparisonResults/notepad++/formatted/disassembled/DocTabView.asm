?addBuffer@DocTabView@@QAEXPAVBuffer@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '2Ch']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?closeBuffer@DocTabView@@QAEXPAVBuffer@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '8']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?bufferUpdated@DocTabView@@QAEXPAVBuffer@@H@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '444h']
...
retn ['8']
endp
?activateBuffer@DocTabView@@QAE_NPAVBuffer@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '8']
mov ['[ebp+var_8],', 'ecx']
...
retn ['4']
endp
?activeBuffer@DocTabView@@QAEPAVBuffer@@XZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '8']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?findBufferByName@DocTabView@@QAEPAVBuffer@@PB_W@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '2Ch']
mov ['[ebp+var_8],', 'ecx']
...
retn ['4']
endp
?getIndexByBuffer@DocTabView@@QAEHPAVBuffer@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '24h']
mov ['[ebp+var_8],', 'ecx']
...
retn ['4']
endp
?getBufferByIndex@DocTabView@@QAEPAVBuffer@@H@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '20h']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?setBuffer@DocTabView@@QAEXHPAVBuffer@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '20h']
mov ['[ebp+var_4],', 'ecx']
...
retn ['8']
endp
?reSizeTo@DocTabView@@UAEXAAUtagRECT@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '1Ch']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
mov ['eax,', '[eax+28h]']
mov ['[ebp+var_1C],', 'eax']
movzx ['ecx,', 'ds:?_hideTabBarStatus@DocTabView@@0_NA']
test ['ecx,', 'ecx']
jz ['short', 'loc_1357']
mov ['edx,', '[ebp+arg_0]']
mov ['eax,', '[edx]']
