?initMacroList@RunMacroDlg@@QAEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '14h']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?getMacro2Exec@RunMacroDlg@@QBEHXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '10h']
mov ['[ebp+var_8],', 'ecx']
...
retn
endp
?run_dlgProc@RunMacroDlg@@EAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '10h']
mov ['eax,', '[ebp+arg_4]']
...
retn ['10h']
endp
?check@RunMacroDlg@@AAEXH@Z proc near   
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
