?init@StatusBar@@UAEXPAUHINSTANCE__@@PAUHWND__@@H@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '2Ch']
...
mov ['eax,', '[edx+18h]']
push ['eax']
call ['dword', 'ptr', 'ds:__imp__LocalLock@4']
mov ['ecx,', '[ebp+var_18]']
mov ['[ecx+1Ch],', 'eax']
lea ['edx,', '[ebp+Rect]']
push ['edx']
...
retn ['0Ch']
endp
?setText@StatusBar@@QAE_NPB_WH@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '8']
mov ['[ebp+var_4],', 'ecx']
...
retn ['8']
endp
?setOwnerDrawText@StatusBar@@QAE_NPB_W@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '8']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?adjustParts@StatusBar@@QAEXH@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0Ch']
mov ['[ebp+var_4],', 'ecx']
