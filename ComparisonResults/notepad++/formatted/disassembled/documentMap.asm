?doDialog@ViewZoneDlg@@QAEXXZ proc near 
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?run_dlgProc@ViewZoneDlg@@MAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0Ch']
mov ['eax,', '[ebp+arg_4]']
...
retn ['10h']
endp
?canvasStaticProc@ViewZoneDlg@@KGJPAUHWND__@@IIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
push ['0FFFFFFEBh']
...
retn ['10h']
endp
?canvas_runProc@ViewZoneDlg@@IAGJPAUHWND__@@IIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['eax,', '[ebp+arg_8]']
...
retn ['14h']
endp
?drawPreviewZone@ViewZoneDlg@@IAEXPAUtagDRAWITEMSTRUCT@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '28h']
...
retn ['4']
endp
?redraw@DocumentMap@@UBEX_N@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?reloadMap@DocumentMap@@QAEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['0FFFFFFFFh']
push ['offset', '__ehhandler$?reloadMap@DocumentMap@@QAEXXZ']
mov ['eax,', 'large', 'fs:0']
push ['eax']
sub ['esp,', '1Ch']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn
endp
?wrapMap@DocumentMap@@QAEXXZ proc near  
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '2Ch']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
mov ['eax,', '[ebp+var_18]']
mov ['ecx,', '[eax+0A4h]']
movsd ['xmm0,', 'qword_390[ecx*8]']
movsd ['[ebp+var_24],', 'xmm0']
cvtsi2sd ['xmm0,', '[ebp+var_1C]']
divsd ['xmm0,', '[ebp+var_24]']
movsd ['[ebp+var_2C],', 'xmm0']
push ['1']
mov ['edx,', '[ebp+var_8]']
sub ['edx,', '[ebp+var_10]']
push ['edx']
cvttsd2si ['eax,', '[ebp+var_2C]']
push ['eax']
push ['0']
push ['0']
mov ['ecx,', '[ebp+var_18]']
...
retn
endp
?initWrapMap@DocumentMap@@QAEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '1Ch']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn
endp
?scrollMap@DocumentMap@@QAEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '40h']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?scrollMap@DocumentMap@@QAEX_NW4moveMode@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '18h']
mov ['[ebp+var_4],', 'ecx']
...
retn ['8']
endp
?doMove@DocumentMap@@QAEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '20h']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn
endp
?fold@DocumentMap@@QAEXH_N@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['8']
endp
?foldAll@DocumentMap@@QAEX_N@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?setSyntaxHiliting@DocumentMap@@QAEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '8']
mov ['[ebp+var_4],', 'ecx']
...
push ['0']
mov ['edx,', 'dword', 'ptr', 'ds:?_SC_MARGE_FOLDER@ScintillaEditView@@2HB']
push ['edx']
mov ['eax,', '[ebp+var_4]']
mov ['ecx,', '[eax+70h]']
...
retn
endp
?changeTextDirection@DocumentMap@@QAEX_N@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?run_dlgProc@DocumentMap@@MAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '64h']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
mov ['eax,', '[ebp+var_44]']
push ['eax']
mov ['ecx,', '[ebp+var_40.y]']
push ['ecx']
mov ['edx,', '[ebp+var_40.x]']
push ['edx']
mov ['ecx,', '[ebp+this]']
add ['ecx,', '74h']
call ['?getHSelf@Window@@QBEPAUHWND__@@XZ']
...
retn ['10h']
endp
?needToRecomputeWith@DocumentMap@@IAE_NXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0Ch']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?getEditorTextZoneWidth@DocumentMap@@IAEHXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '20h']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn
endp
__unwindfunclet$?reloadMap@DocumentMap@@QAEXXZ$0 proc near
lea ['ecx,', '[ebp-28h]']
jmp ['??1?$vector@IV?$allocator@I@std@@@std@@QAE@XZ']
endp
__ehhandler$?reloadMap@DocumentMap@@QAEXXZ proc near
mov ['edx,', '[esp+arg_4]']
lea ['eax,', '[edx+0Ch]']
mov ['ecx,', '[edx-20h]']
xor ['ecx,', 'eax']
...
retn ['8']
endp
?drawZone@ViewZoneDlg@@QAEXJJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?getCurrentCenterPosY@ViewZoneDlg@@QBEHXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
jmp ['___CxxFrameHandler3']
endp
?mouseWheel@ScintillaEditView@@QAEXIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
