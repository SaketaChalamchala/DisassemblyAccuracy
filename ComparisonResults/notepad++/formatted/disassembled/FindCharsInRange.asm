?run_dlgProc@FindCharsInRangeDlg@@MAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '10h']
mov ['eax,', '[ebp+arg_4]']
...
retn ['10h']
endp
?findCharInRange@FindCharsInRangeDlg@@AAE_NEEH_N0@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '5Ch']
mov ['[ebp+var_14],', 'ecx']
...
retn ['14h']
endp
?getRangeFromUI@FindCharsInRangeDlg@@AAE_NAAE0@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '14h']
mov ['[ebp+var_4],', 'ecx']
...
retn ['8']
endp
?getDirectionFromUI@FindCharsInRangeDlg@@AAEXAA_N0@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
