?init@TaskList@@QAEXPAUHINSTANCE__@@PAUHWND__@@PAU_IMAGELIST@@HH@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '74h']
...
retn ['14h']
endp
?destroy@TaskList@@UAEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?setFont@TaskList@@QAEXPA_WI@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['8']
endp
?adjustSize@TaskList@@QAE?AUtagRECT@@XZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '27Ch']
...
retn ['4']
endp
?updateCurrentIndex@TaskList@@QAEHXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0Ch']
mov ['[ebp+var_8],', 'ecx']
...
retn
endp
?runProc@TaskList@@IAEJPAUHWND__@@IIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '1D0h']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?staticProc@TaskList@@KGJPAUHWND__@@IIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
mov ['eax,', '[ebp+arg_C]']
push ['eax']
