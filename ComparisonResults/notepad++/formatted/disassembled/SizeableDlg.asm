??0SizeableDlg@@QAE@PAVWINRECT@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['0FFFFFFFFh']
push ['offset', '__ehhandler$??0SizeableDlg@@QAE@PAVWINRECT@@@Z']
mov ['eax,', 'large', 'fs:0']
push ['eax']
push ['ecx']
...
retn ['4']
endp
?run_dlgProc@SizeableDlg@@MAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['eax,', '[ebp+arg_4]']
...
jmp ['short', 'loc_110']
mov ['eax,', '[ebp+arg_4]']
cmp ['eax,', 'dword', 'ptr', 'ds:?WM_WINMGR@@3IB']
jnz ['short', 'loc_10E']
mov ['ecx,', '[ebp+arg_C]']
push ['ecx']
mov ['edx,', '[ebp+arg_8]']
...
retn ['10h']
endp
?onInitDialog@SizeableDlg@@MAEHXZ proc near 
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?onSize@SizeableDlg@@MAEXIHH@Z proc near 
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['0Ch']
endp
?onGetMinMaxInfo@SizeableDlg@@MAEXPAUtagMINMAXINFO@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?onWinMgr@SizeableDlg@@MAEJIJ@Z proc near 
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['8']
endp
__unwindfunclet$??0SizeableDlg@@QAE@PAVWINRECT@@@Z$0 proc near
mov ['ecx,', '[ebp-10h]']
jmp ['??1StaticDialog@@UAE@XZ']
endp
__unwindfunclet$??0SizeableDlg@@QAE@PAVWINRECT@@@Z$1 proc near
mov ['ecx,', '[ebp-10h]']
add ['ecx,', '20h']
jmp ['??1CWinMgr@@UAE@XZ']
endp
__ehhandler$??0SizeableDlg@@QAE@PAVWINRECT@@@Z proc near
mov ['edx,', '[esp+arg_4]']
lea ['eax,', '[edx+0Ch]']
mov ['ecx,', '[edx-8]']
xor ['ecx,', 'eax']
...
retn ['4']
endp
??_GSizeableDlg@@UAEPAXI@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?CalcLayout@CWinMgr@@QAEXHHPAUHWND__@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '18h']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
