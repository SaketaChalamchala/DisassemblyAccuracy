...
retn ['0Ch']
endp
?doDialog@TaskListDlg@@QAEH_N@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '10h']
...
retn ['4']
endp
?run_dlgProc@TaskListDlg@@MAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '40h']
...
mov ['eax,', '[edx+8]']
mov ['[ebp+var_28],', 'eax']
cmp ['[ebp+var_28],', '0FFFFFF4Fh']
jz ['short', 'loc_331']
cmp ['[ebp+var_28],', '0FFFFFFFBh']
jz ['short', 'loc_376']
...
retn ['10h']
endp
?drawItem@TaskListDlg@@AAEXPAUtagDRAWITEMSTRUCT@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '68h']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn
endp
?GetFontSelected@TaskList@@QAEPAUHFONT__@@XZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?getCurrentIndex@TaskList@@QBEHXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?getImgLst@TaskList@@QBEPAU_IMAGELIST@@XZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
