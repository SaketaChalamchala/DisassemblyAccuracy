?run_dlgProc@GoToLineDlg@@MAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '74h']
mov ['eax,', '[ebp+arg_4]']
...
retn ['10h']
endp
?updateLinesNumbers@GoToLineDlg@@ABEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0Ch']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?cleanLineEdit@GoToLineDlg@@ABEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?getLine@GoToLineDlg@@ABEHXZ proc near  
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '10h']
mov ['[ebp+var_8],', 'ecx']
