??0SmartHighlighter@@QAE@PAVFindReplaceDlg@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?highlightView@SmartHighlighter@@QAEXPAVScintillaEditView@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['0FFFFFFFFh']
push ['offset', '__ehhandler$?highlightView@SmartHighlighter@@QAEXPAVScintillaEditView@@@Z']
mov ['eax,', 'large', 'fs:0']
push ['eax']
sub ['esp,', '0E8h']
...
retn ['4']
endp
?isQualifiedWord@SmartHighlighter@@ABE_NPBD@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0Ch']
mov ['[ebp+var_C],', 'ecx']
...
retn ['4']
endp
?isWordChar@SmartHighlighter@@ABE_ND@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '8']
mov ['[ebp+var_8],', 'ecx']
...
retn ['4']
endp
__unwindfunclet$?highlightView@SmartHighlighter@@QAEXPAVScintillaEditView@@@Z$0 proc near
lea ['ecx,', '[ebp-94h]']
jmp ['??1FindOption@@QAE@XZ']
endp
__ehhandler$?highlightView@SmartHighlighter@@QAEXPAVScintillaEditView@@@Z proc near
mov ['edx,', '[esp+arg_4]']
lea ['eax,', '[edx+0Ch]']
mov ['ecx,', '[edx-0ECh]']
xor ['ecx,', 'eax']
...
retn
endp
?getSelection@ScintillaEditView@@QBE?AUSci_CharacterRange@@XZ proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '0Ch']
mov ['[ebp+var_4],', 'ecx']
