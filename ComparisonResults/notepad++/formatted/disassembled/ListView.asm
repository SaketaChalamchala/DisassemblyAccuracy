?init@ListView@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['0FFFFFFFFh']
push ['offset', '__ehhandler$?init@ListView@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z']
mov ['eax,', 'large', 'fs:0']
push ['eax']
sub ['esp,', '9Ch']
...
retn ['8']
endp
?destroy@ListView@@UAEXXZ proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn
endp
?setValues@ListView@@QAEXH@Z proc near  
push ['ebp']
mov ['ebp,', 'esp']
push ['0FFFFFFFFh']
push ['offset', '__ehhandler$?setValues@ListView@@QAEXH@Z']
mov ['eax,', 'large', 'fs:0']
push ['eax']
sub ['esp,', '0E4h']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn ['4']
endp
?resetValues@ListView@@QAEXH@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['4']
endp
?getAscii@ListView@@QAE?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@E@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['0FFFFFFFFh']
push ['offset', '__ehhandler$?getAscii@ListView@@QAE?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@E@Z']
mov ['eax,', 'large', 'fs:0']
push ['eax']
sub ['esp,', '2Ch']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
retn ['8']
endp
?runProc@ListView@@IAEJPAUHWND__@@IIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
push ['ecx']
mov ['[ebp+var_4],', 'ecx']
...
retn ['10h']
endp
__unwindfunclet$?init@ListView@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z$0 proc near
lea ['ecx,', '[ebp-48h]']
jmp ['??1?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QAE@XZ']
endp
__unwindfunclet$?init@ListView@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z$1 proc near
lea ['ecx,', '[ebp-2Ch]']
jmp ['??1?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QAE@XZ']
endp
__unwindfunclet$?init@ListView@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z$2 proc near
lea ['ecx,', '[ebp-64h]']
jmp ['??1?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QAE@XZ']
endp
__ehhandler$?init@ListView@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z proc near
mov ['edx,', '[esp+arg_4]']
lea ['eax,', '[edx+0Ch]']
mov ['ecx,', '[edx-0A0h]']
xor ['ecx,', 'eax']
...
endp
__unwindfunclet$?setValues@ListView@@QAEXH@Z$0 proc near
lea ['ecx,', '[ebp-4Ch]']
jmp ['??1?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QAE@XZ']
endp
__ehhandler$?setValues@ListView@@QAEXH@Z proc near
mov ['edx,', '[esp+arg_4]']
lea ['eax,', '[edx+0Ch]']
mov ['ecx,', '[edx-0E8h]']
xor ['ecx,', 'eax']
...
jmp ['___CxxFrameHandler3']
endp
__unwindfunclet$?getAscii@ListView@@QAE?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@E@Z$0 proc near
mov ['eax,', '[ebp-28h]']
and ['eax,', '1']
jz ['locret_DF4']
...
retn
endp
__ehhandler$?getAscii@ListView@@QAE?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@E@Z proc near
mov ['edx,', '[esp+arg_4]']
lea ['eax,', '[edx+0Ch]']
mov ['ecx,', '[edx-30h]']
xor ['ecx,', 'eax']
...
retn
endp
?staticProc@ListView@@KGJPAUHWND__@@IIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
mov ['eax,', '[ebp+arg_C]']
push ['eax']
