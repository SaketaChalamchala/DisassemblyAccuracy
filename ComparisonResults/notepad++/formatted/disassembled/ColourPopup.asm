?create@ColourPopup@@QAEXH@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '10h']
...
retn ['4']
endp
?dlgProc@ColourPopup@@CGHPAUHWND__@@IIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '24h']
...
retn ['10h']
endp
?run_dlgProc@ColourPopup@@AAGHIIJ@Z proc near
push ['ebp']
mov ['ebp,', 'esp']
sub ['esp,', '68h']
mov ['eax,', 'dword', 'ptr', 'ds:___security_cookie']
...
mov ['edx,', '[ebp+wParam]']
mov ['eax,', '?colourItems@@3PAKA[edx*4]']
push ['eax']
mov ['ecx,', '[ebp+wParam]']
push ['ecx']
push ['19Ah']
...
mov ['ecx,', '[ebp+hdc]']
push ['ecx']
call ['dword', 'ptr', 'ds:__imp__FrameRect@12']
mov ['edx,', '[ebp+var_1C]']
add ['edx,', '1Ch']
mov ['eax,', '[edx]']
mov ['[ebp+rc.left],', 'eax']
...
mov ['ecx,', '[ebp+hdc]']
push ['ecx']
call ['dword', 'ptr', 'ds:__imp__DrawFocusRect@8']
mov ['eax,', '1']
jmp ['loc_72E']
mov ['edx,', '[ebp+arg_8]']
and ['edx,', '0FFFFh']
...
mov ['eax,', '[edx+8]']
mov ['[ebp+var_64],', 'eax']
mov ['[ebp+var_58],', 'offset', '?acrCustClr@?BG@??run_dlgProc@ColourPopup@@AAGHIIJ@Z@4PAKA']
mov ['ecx,', '[ebp+this]']
mov ['edx,', '[ecx+20h]']
mov ['[ebp+var_5C],', 'edx']
mov ['[ebp+var_54],', '3']
...
lea ['ecx,', '[ebp+Dst]']
push ['ecx']
call ['dword', 'ptr', 'ds:__imp__ChooseColorW@4']
cmp ['eax,', '1']
jnz ['short', 'loc_675']
push ['0']
mov ['edx,', '[ebp+var_5C]']
