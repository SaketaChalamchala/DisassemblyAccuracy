...
ret	0
ENDP
??A?$vector@UDlgInfo@@V?$allocator@UDlgInfo@@@std@@@std@@QAEAAUDlgInfo@@I@Z PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?renameTab@ControlsTab@@QAE_NPB_W0@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
...
jmp	SHORT $LN5@renameTab
mov	ecx, DWORD PTR _i$[ebp]
add	ecx, 1
mov	DWORD PTR _i$[ebp], ecx
mov	edx, DWORD PTR _i$[ebp]
cmp	edx, DWORD PTR _len$1[ebp]
jae	SHORT $LN3@renameTab
...
movzx	eax, al
test	eax, eax
je	SHORT $LN2@renameTab
mov	BYTE PTR _foundIt$[ebp], 1
jmp	SHORT $LN3@renameTab
jmp	SHORT $LN4@renameTab
movzx	ecx, BYTE PTR _foundIt$[ebp]
test	ecx, ecx
jne	SHORT $LN1@renameTab
xor	al, al
jmp	SHORT $LN6@renameTab
...
ret	8
ENDP
?renameTab@ControlsTab@@QAEXHPB_W@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 32					
mov	DWORD PTR _this$[ebp], ecx
...
ret	8
ENDP
?activateWindowAt@ControlsTab@@QAEXH@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 12					
mov	DWORD PTR _this$[ebp], ecx
...
jne	SHORT $LN1@activateWi
jmp	SHORT $LN2@activateWi
mov	edx, DWORD PTR _this$[ebp]
...
ret	4
ENDP
?reSizeTo@ControlsTab@@UAEXAAUtagRECT@@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 12					
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?createTabs@ControlsTab@@QAEXAAV?$vector@UDlgInfo@@V?$allocator@UDlgInfo@@@std@@@std@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 12					
mov	DWORD PTR _this$[ebp], ecx
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _winVector$[ebp]
mov	DWORD PTR [eax+48], ecx
mov	DWORD PTR _i$2[ebp], 0
mov	ecx, DWORD PTR _winVector$[ebp]
call	?size@?$vector@UDlgInfo@@V?$allocator@UDlgInfo@@@std@@@std@@QBEIXZ 
mov	DWORD PTR _len$1[ebp], eax
jmp	SHORT $LN3@createTabs
mov	edx, DWORD PTR _i$2[ebp]
add	edx, 1
mov	DWORD PTR _i$2[ebp], edx
mov	eax, DWORD PTR _i$2[ebp]
cmp	eax, DWORD PTR _len$1[ebp]
jae	SHORT $LN1@createTabs
...
ret	0
ENDP
?getRowCount@TabBar@@IBEJXZ PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
