...
ret	0
ENDP
?check@RunMacroDlg@@AAEXH@Z PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
cmp	DWORD PTR _id$[ebp], 8001		
jne	SHORT $LN4@check
push	0
push	1
push	241					
...
ret	4
ENDP
?run_dlgProc@RunMacroDlg@@EAGHIIJ@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 16					
...
push	8001					
mov	ecx, DWORD PTR _this$[ebp]
call	?check@RunMacroDlg@@AAEXH@Z		
jmp	SHORT $LN19@run_dlgPro
push	8002					
mov	ecx, DWORD PTR _this$[ebp]
call	?check@RunMacroDlg@@AAEXH@Z		
...
ret	16					
ENDP
?getMacro2Exec@RunMacroDlg@@QBEHXZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?initMacroList@RunMacroDlg@@QAEXXZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 20					
mov	DWORD PTR _this$[ebp], ecx
