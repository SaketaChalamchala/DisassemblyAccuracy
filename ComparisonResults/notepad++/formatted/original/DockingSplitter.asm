...
ret	0
ENDP
?runProc@DockingSplitter@@IAEJPAUHWND__@@IIJ@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 280				
mov	eax, DWORD PTR ___security_cookie
...
call	DWORD PTR __imp__SendMessageW@16
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _pt$2[ebp]
mov	DWORD PTR [eax+24], ecx
mov	edx, DWORD PTR _pt$2[ebp+4]
...
ret	16					
ENDP
?staticWinProc@DockingSplitter@@KGJPAUHWND__@@IIJ@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _pDockingSplitter$[ebp], 0
mov	eax, DWORD PTR _message$[ebp]
mov	DWORD PTR tv64[ebp], eax
...
mov	edx, DWORD PTR [ecx]
mov	DWORD PTR _pDockingSplitter$[ebp], edx
mov	eax, DWORD PTR _pDockingSplitter$[ebp]
mov	ecx, DWORD PTR _hwnd$[ebp]
mov	DWORD PTR [eax+12], ecx
mov	edx, DWORD PTR _pDockingSplitter$[ebp]
push	edx
push	-21					
mov	eax, DWORD PTR _hwnd$[ebp]
push	eax
...
mov	DWORD PTR _pDockingSplitter$[ebp], eax
cmp	DWORD PTR _pDockingSplitter$[ebp], 0
...
mov	eax, DWORD PTR _hwnd$[ebp]
push	eax
mov	ecx, DWORD PTR _pDockingSplitter$[ebp]
call	?runProc@DockingSplitter@@IAEJPAUHWND__@@IIJ@Z 
mov	esp, ebp
pop	ebp
ret	16					
ENDP
?init@DockingSplitter@@QAEXPAUHINSTANCE__@@PAUHWND__@@1I@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 68					
mov	DWORD PTR _this$[ebp], ecx
...
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR _hMessage$[ebp]
...
mov	DWORD PTR _wc$[ebp+36], OFFSET $SG123139
jmp	SHORT $LN9@init
push	32644					
push	0
call	DWORD PTR __imp__LoadCursorW@8
mov	DWORD PTR _wc$[ebp+24], eax
mov	DWORD PTR _wc$[ebp+36], OFFSET $SG123144
cmp	DWORD PTR ?_isHoriReg@DockingSplitter@@0HA, 0 
jne	SHORT $LN6@init
mov	ecx, DWORD PTR _flags$[ebp]
and	ecx, 2
jne	SHORT $LN7@init
cmp	DWORD PTR ?_isVertReg@DockingSplitter@@0HA, 0 
jne	$LN8@init
mov	edx, DWORD PTR _flags$[ebp]
and	edx, 1
je	$LN8@init
mov	DWORD PTR _wc$[ebp], 3
mov	DWORD PTR _wc$[ebp+4], OFFSET ?staticWinProc@DockingSplitter@@KGJPAUHWND__@@IIJ@Z 
...
and	edx, 2
je	SHORT $LN3@init
mov	DWORD PTR ?_isHoriReg@DockingSplitter@@0HA, 1 
jmp	SHORT $LN8@init
mov	DWORD PTR ?_isVertReg@DockingSplitter@@0HA, 1 
mov	eax, DWORD PTR _this$[ebp]
push	eax
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+4]
