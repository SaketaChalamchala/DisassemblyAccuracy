...
ret	0
ENDP
?reSizeTo@DocTabView@@UAEXAAUtagRECT@@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 28					
mov	eax, DWORD PTR ___security_cookie
...
movzx	ecx, BYTE PTR ?_hideTabBarStatus@DocTabView@@0_NA 
test	ecx, ecx
...
ret	4
ENDP
?setBuffer@DocTabView@@QAEXHPAVBuffer@@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 32					
mov	DWORD PTR _this$[ebp], ecx
...
ret	8
ENDP
?getBufferByIndex@DocTabView@@QAEPAVBuffer@@H@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 32					
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?getIndexByBuffer@DocTabView@@QAEHPAVBuffer@@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 36					
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?findBufferByName@DocTabView@@QAEPAVBuffer@@PB_W@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 44					
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?activeBuffer@DocTabView@@QAEPAVBuffer@@XZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?activateBuffer@DocTabView@@QAE_NPAVBuffer@@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?bufferUpdated@DocTabView@@QAEXPAVBuffer@@H@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 1092				
mov	eax, DWORD PTR ___security_cookie
...
ret	8
ENDP
?closeBuffer@DocTabView@@QAEXPAVBuffer@@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?addBuffer@DocTabView@@QAEXPAVBuffer@@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 44					
mov	DWORD PTR _this$[ebp], ecx
