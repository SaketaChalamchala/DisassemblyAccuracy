...
ret	0
ENDP
?staticProc@TaskList@@KGJPAUHWND__@@IIJ@Z PROC		
push	ebp
mov	ebp, esp
...
mov	ecx, eax
call	?runProc@TaskList@@IAEJPAUHWND__@@IIJ@Z	
pop	ebp
ret	16					
ENDP
?runProc@TaskList@@IAEJPAUHWND__@@IIJ@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 464				
mov	DWORD PTR _this$[ebp], ecx
...
ja	SHORT $LN30@runProc
cmp	DWORD PTR tv64[ebp], 257		
je	SHORT $LN17@runProc
cmp	DWORD PTR tv64[ebp], 135		
je	$LN11@runProc
...
shr	edx, 16					
and	edx, 65535				
mov	WORD PTR _zDelta$9[ebp], dx
movsx	eax, WORD PTR _zDelta$9[ebp]
test	eax, eax
jle	$LN14@runProc
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+32]
sub	edx, 1
jns	SHORT $LN22@runProc
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax+28]
sub	ecx, 1
mov	DWORD PTR tv88[ebp], ecx
jmp	SHORT $LN23@runProc
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+32]
sub	eax, 1
mov	DWORD PTR tv88[ebp], eax
mov	ecx, DWORD PTR tv88[ebp]
mov	DWORD PTR _selected$12[ebp], ecx
...
mov	DWORD PTR __macro_lvi$6[ebp+16], 3
mov	DWORD PTR __macro_lvi$6[ebp+12], 3
lea	eax, DWORD PTR __macro_lvi$6[ebp]
push	eax
mov	ecx, DWORD PTR _selected$12[ebp]
push	ecx
push	4139					
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+12]
...
mov	ecx, DWORD PTR _selected$12[ebp]
push	ecx
mov	edx, DWORD PTR _selected$12[ebp]
push	edx
push	4117					
mov	eax, DWORD PTR _this$[ebp]
...
mov	DWORD PTR _selected$13[ebp], eax
mov	DWORD PTR __macro_lvi$8[ebp+16], 3
mov	DWORD PTR __macro_lvi$8[ebp+12], 0
lea	ecx, DWORD PTR __macro_lvi$8[ebp]
push	ecx
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+32]
push	eax
...
mov	DWORD PTR __macro_lvi$4[ebp+12], 3
lea	edx, DWORD PTR __macro_lvi$4[ebp]
push	edx
mov	eax, DWORD PTR _selected$13[ebp]
push	eax
push	4139					
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+12]
...
mov	eax, DWORD PTR _selected$13[ebp]
push	eax
mov	ecx, DWORD PTR _selected$13[ebp]
push	ecx
push	4117					
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+12]
...
and	ecx, 128				
je	$LN9@runProc
mov	edx, DWORD PTR _msg$14[ebp]
cmp	DWORD PTR [edx+8], 9
jne	SHORT $LN6@runProc
push	16					
call	DWORD PTR __imp__GetKeyState@4
cwde
and	eax, 128				
...
cmp	DWORD PTR [ecx+8], 38			
jne	$LN8@runProc
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+32]
sub	eax, 1
jns	SHORT $LN26@runProc
mov	ecx, DWORD PTR _this$[ebp]
...
mov	DWORD PTR _selected$10[ebp], edx
...
mov	DWORD PTR __macro_lvi$5[ebp+12], 3
lea	ecx, DWORD PTR __macro_lvi$5[ebp]
push	ecx
mov	edx, DWORD PTR _selected$10[ebp]
push	edx
push	4139					
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax+12]
...
mov	edx, DWORD PTR _selected$10[ebp]
push	edx
mov	eax, DWORD PTR _selected$10[ebp]
push	eax
push	4117					
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+12]
...
push	edx
mov	eax, DWORD PTR _selected$11[ebp]
push	eax
push	4139					
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+12]
...
mov	eax, DWORD PTR _selected$11[ebp]
push	eax
mov	ecx, DWORD PTR _selected$11[ebp]
push	ecx
push	4117					
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+12]
...
ret	16					
ENDP
?updateCurrentIndex@TaskList@@QAEHXZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 12					
mov	DWORD PTR _this$[ebp], ecx
...
push	edx
call	DWORD PTR __imp__SendMessageW@16
mov	DWORD PTR _isSelected$1[ebp], eax
cmp	DWORD PTR _isSelected$1[ebp], 2
...
ret	0
ENDP
?adjustSize@TaskList@@QAE?AUtagRECT@@XZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 636				
mov	eax, DWORD PTR ___security_cookie
...
mov	DWORD PTR _imgWidth$[ebp], edx
mov	DWORD PTR _leftMarge$[ebp], 30		
mov	DWORD PTR _xpBottomMarge$[ebp], 5
mov	DWORD PTR _w7BottomMarge$[ebp], 15	
push	0
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax+24]
push	ecx
...
mov	DWORD PTR __macro_lvi$1[ebp+24], 260	
...
cmp	eax, DWORD PTR _maxwidth$[ebp]
jle	SHORT $LN1@adjustSize
...
jmp	$LN3@adjustSize
mov	edx, DWORD PTR _imgWidth$[ebp]
...
jg	SHORT $LN9@adjustSize
cmp	DWORD PTR _ver$[ebp], 0
je	SHORT $LN9@adjustSize
mov	DWORD PTR tv197[ebp], 5
jmp	SHORT $LN10@adjustSize
mov	DWORD PTR tv197[ebp], 15		
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+48]
add	edx, DWORD PTR tv197[ebp]
mov	eax, DWORD PTR _this$[ebp]
...
ret	4
ENDP
?setFont@TaskList@@QAEXPA_WI@Z PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?init@TaskList@@QAEXPAUHINSTANCE__@@PAUHWND__@@PAU_IMAGELIST@@HH@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 116				
mov	DWORD PTR _this$[ebp], ecx
...
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR _index2set$[ebp]
mov	DWORD PTR [edx+32], eax
...
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR _nbItem$[ebp]
mov	DWORD PTR [edx+28], eax
mov	DWORD PTR _listViewStyles$[ebp], 54597	
push	0
mov	ecx, DWORD PTR _hInst$[ebp]
push	ecx
push	0
...
push	0
push	0
mov	ecx, DWORD PTR _listViewStyles$[ebp]
or	ecx, 1073741824				
push	ecx
push	OFFSET $SG123112
push	OFFSET $SG123113
push	0
...
push	OFFSET ?staticProc@TaskList@@KGJPAUHWND__@@IIJ@Z 
push	-4					
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+12]
push	eax
...
push	ecx
call	DWORD PTR __imp__SendMessageW@16
mov	DWORD PTR _lvColumn$[ebp], 2
mov	DWORD PTR _lvColumn$[ebp+8], 500	
