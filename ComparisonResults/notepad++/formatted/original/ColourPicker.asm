...
ret	8
ENDP
??_GColourPopup@@UAEPAXI@Z PROC				
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
mov	ecx, DWORD PTR _this$[ebp]
call	??1ColourPopup@@UAE@XZ			
...
ret	4
ENDP
?setColour@ColourPopup@@QAEXK@Z PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?destroy@ColourPopup@@UAEXXZ PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?doDialog@ColourPopup@@QAEXUtagPOINT@@@Z PROC		
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
mov	ecx, DWORD PTR _this$[ebp]
call	?isCreated@ColourPopup@@QBE_NXZ		
movzx	eax, al
test	eax, eax
jne	SHORT $LN1@doDialog
push	2100					
mov	ecx, DWORD PTR _this$[ebp]
call	?create@ColourPopup@@QAEXH@Z		
push	64					
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR _this$[ebp]
...
ret	8
ENDP
?isCreated@ColourPopup@@QBE_NXZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
__unwindfunclet$??1ColourPopup@@UAE@XZ$0 PROC
mov	ecx, DWORD PTR _this$[ebp]
jmp	??1Window@@UAE@XZ			
ENDP
__ehhandler$??1ColourPopup@@UAE@XZ PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ret	4
ENDP
__unwindfunclet$??0ColourPopup@@QAE@K@Z$0 PROC
mov	ecx, DWORD PTR _this$[ebp]
jmp	??1Window@@UAE@XZ			
ENDP
__ehhandler$??0ColourPopup@@QAE@K@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
mov	ecx, DWORD PTR [edx-8]
xor	ecx, eax
...
ENDP
ENDP
?drawBackground@ColourPicker@@AAEXPAUHDC__@@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 32					
mov	eax, DWORD PTR ___security_cookie
...
ret	4
ENDP
?drawForeground@ColourPicker@@AAEXPAUHDC__@@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 40					
mov	eax, DWORD PTR ___security_cookie
...
mov	DWORD PTR _strikeOut$[ebp], 16777215	
mov	edx, DWORD PTR _this$[ebp]
...
ret	4
ENDP
?runProc@ColourPicker@@AAEJIIJ@Z PROC			
push	ebp
mov	ebp, esp
push	-1
...
je	$LN8@runProc
cmp	DWORD PTR tv64[ebp], 7025		
je	$LN5@runProc
cmp	DWORD PTR tv64[ebp], 7026		
je	$LN2@runProc
jmp	$LN1@runProc
...
mov	edx, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [edx+24]
call	?doDialog@ColourPopup@@QAEXUtagPOINT@@@Z 
...
mov	edx, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [edx+24]
call	?setColour@ColourPopup@@QAEXK@Z		
mov	eax, DWORD PTR _p$6[ebp+4]
push	eax
mov	ecx, DWORD PTR _p$6[ebp]
push	ecx
...
push	eax
mov	ecx, DWORD PTR _this$[ebp]
call	?drawBackground@ColourPicker@@AAEXPAUHDC__@@@Z 
mov	eax, 1
jmp	$LN14@runProc
jmp	$LN12@runProc
...
push	ecx
mov	ecx, DWORD PTR _this$[ebp]
call	?drawForeground@ColourPicker@@AAEXPAUHDC__@@@Z 
...
ret	12					
ENDP
__unwindfunclet$?runProc@ColourPicker@@AAEJIIJ@Z$0 PROC
...
ret	0
ENDP
__ehhandler$?runProc@ColourPicker@@AAEJIIJ@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ENDP
ENDP
?staticWinProc@ColourPicker@@CGJPAUHWND__@@IIJ@Z PROC	
push	ebp
mov	ebp, esp
...
mov	ecx, eax
call	?runProc@ColourPicker@@AAEJIIJ@Z	
pop	ebp
ret	16					
ENDP
?destroy@ColourPicker@@UAEXXZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?init@ColourPicker@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
...
push	OFFSET ?staticWinProc@ColourPicker@@CGJPAUHWND__@@IIJ@Z 
push	-4					
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+12]
push	edx
