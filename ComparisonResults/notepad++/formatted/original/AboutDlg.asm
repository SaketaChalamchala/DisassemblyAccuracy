...
ret	0
ENDP
?run_dlgProc@AboutDlg@@MAGHIIJ@Z PROC			
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$?run_dlgProc@AboutDlg@@MAGHIIJ@Z
mov	eax, DWORD PTR fs:0
push	eax
sub	esp, 72					
mov	eax, DWORD PTR ___security_cookie
...
mov	DWORD PTR _compileDateHandle$9[ebp], eax
push	OFFSET $SG138313
lea	ecx, DWORD PTR _buildTime$10[ebp]
...
push	0
push	12					
mov	eax, DWORD PTR _compileDateHandle$9[ebp]
push	eax
call	DWORD PTR __imp__SendMessageW@16
push	0
mov	ecx, DWORD PTR _compileDateHandle$9[ebp]
push	ecx
...
push	eax
call	DWORD PTR __imp__GetDlgItem@8
mov	DWORD PTR _licenceEditHandle$6[ebp], eax
push	OFFSET $SG138321
push	0
push	12					
mov	ecx, DWORD PTR _licenceEditHandle$6[ebp]
push	ecx
call	DWORD PTR __imp__SendMessageW@16
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+12]
...
mov	DWORD PTR _enableDlgTheme$8[ebp], eax
cmp	DWORD PTR _enableDlgTheme$8[ebp], 0
je	SHORT $LN8@run_dlgPro
push	6
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+12]
push	edx
call	DWORD PTR _enableDlgTheme$8[ebp]
push	0
mov	eax, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [eax]
mov	ecx, DWORD PTR _this$[ebp]
...
mov	DWORD PTR _hIcon$5[ebp], eax
mov	eax, DWORD PTR _lParam$[ebp]
mov	DWORD PTR _pdis$4[ebp], eax
push	3
push	0
push	0
push	64					
push	64					
mov	ecx, DWORD PTR _hIcon$5[ebp]
push	ecx
push	0
push	0
mov	edx, DWORD PTR _pdis$4[ebp]
mov	eax, DWORD PTR [edx+24]
push	eax
...
jbe	SHORT $LN1@run_dlgPro
cmp	DWORD PTR tv262[ebp], 2
jbe	SHORT $LN3@run_dlgPro
...
ret	16					
ENDP
__unwindfunclet$?run_dlgProc@AboutDlg@@MAGHIIJ@Z$0 PROC
lea	ecx, DWORD PTR _buildTime$10[ebp]
jmp	??1?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QAE@XZ 
ENDP
__ehhandler$?run_dlgProc@AboutDlg@@MAGHIIJ@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
