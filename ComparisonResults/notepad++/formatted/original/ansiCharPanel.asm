...
ret	0
ENDP
?run_dlgProc@AnsiCharPanel@@MAGHIIJ@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 40					
...
cmp	DWORD PTR _codepage$6[ebp], -1
jne	SHORT $LN20@run_dlgPro
mov	DWORD PTR tv95[ebp], 0
jmp	SHORT $LN21@run_dlgPro
mov	edx, DWORD PTR _codepage$6[ebp]
...
cmp	DWORD PTR tv140[ebp], -155		
je	SHORT $LN9@run_dlgPro
cmp	DWORD PTR tv140[ebp], -3		
je	SHORT $LN11@run_dlgPro
jmp	$LN12@run_dlgPro
mov	edx, DWORD PTR _lParam$[ebp]
mov	DWORD PTR _lpnmitem$3[ebp], edx
mov	eax, DWORD PTR _lpnmitem$3[ebp]
...
ret	16					
ENDP
?insertChar@AnsiCharPanel@@QBEXE@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 68					
mov	eax, DWORD PTR ___security_cookie
...
mov	eax, 1
imul	ecx, eax, 0
mov	dl, BYTE PTR _char2insert$[ebp]
mov	BYTE PTR _charStr$[ebp+ecx], dl
mov	DWORD PTR $T1[ebp], 1
cmp	DWORD PTR $T1[ebp], 2
jae	SHORT $LN7@insertChar
jmp	SHORT $LN8@insertChar
call	___report_rangecheckfailure
mov	eax, DWORD PTR $T1[ebp]
mov	BYTE PTR _charStr$[ebp+eax], 0
mov	ecx, DWORD PTR _this$[ebp]
...
cmp	eax, 65001				
jne	SHORT $LN9@insertChar
mov	DWORD PTR tv83[ebp], 1
jmp	SHORT $LN10@insertChar
mov	DWORD PTR tv83[ebp], 0
mov	dl, BYTE PTR tv83[ebp]
mov	BYTE PTR _isUnicode$2[ebp], dl
movzx	eax, BYTE PTR _isUnicode$2[ebp]
test	eax, eax
je	SHORT $LN3@insertChar
push	20					
lea	ecx, DWORD PTR _wCharStr$[ebp]
push	ecx
push	-1
lea	edx, DWORD PTR _charStr$[ebp]
push	edx
push	0
push	0
...
push	0
push	10					
lea	eax, DWORD PTR _multiByteStr$[ebp]
push	eax
push	-1
lea	ecx, DWORD PTR _wCharStr$[ebp]
push	ecx
...
mov	ecx, 1
imul	edx, ecx, 0
mov	al, BYTE PTR _charStr$[ebp+eax]
mov	BYTE PTR _multiByteStr$[ebp+edx], al
mov	ecx, 1
shl	ecx, 0
mov	edx, 1
shl	edx, 0
mov	al, BYTE PTR _charStr$[ebp+ecx]
mov	BYTE PTR _multiByteStr$[ebp+edx], al
jmp	SHORT $LN1@insertChar
push	20					
lea	ecx, DWORD PTR _wCharStr$[ebp]
push	ecx
push	-1
...
push	0
push	10					
lea	ecx, DWORD PTR _multiByteStr$[ebp]
push	ecx
push	-1
lea	edx, DWORD PTR _wCharStr$[ebp]
push	edx
push	0
push	65001					
call	DWORD PTR __imp__WideCharToMultiByte@32
...
mov	ecx, DWORD PTR [ecx]
call	?execute@ScintillaEditView@@QBEJIIJ@Z	
movzx	edx, BYTE PTR _char2insert$[ebp]
cmp	edx, 128				
jge	SHORT $LN11@insertChar
mov	DWORD PTR tv165[ebp], 1
jmp	SHORT $LN12@insertChar
lea	eax, DWORD PTR _multiByteStr$[ebp]
push	eax
call	_strlen
add	esp, 4
...
lea	edx, DWORD PTR _multiByteStr$[ebp]
push	edx
...
ret	4
ENDP
?switchEncoding@AnsiCharPanel@@QAEXXZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
