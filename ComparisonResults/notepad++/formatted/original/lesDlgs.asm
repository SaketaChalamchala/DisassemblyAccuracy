...
ret	8
ENDP
?run_dlgProc@ButtonDlg@@MAGHIIJ@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 28					
...
cmp	DWORD PTR tv65[ebp], 2411		
je	SHORT $LN8@run_dlgPro
jmp	$LN2@run_dlgPro
mov	ecx, DWORD PTR _this$[ebp]
call	?getButtonStatus@ButtonDlg@@QBEHXZ	
mov	DWORD PTR _bs$1[ebp], eax
mov	edx, DWORD PTR _bs$1[ebp]
and	edx, 1
...
mov	BYTE PTR _isFullScreen$4[ebp], al
mov	ecx, DWORD PTR _bs$1[ebp]
and	ecx, 2
...
mov	BYTE PTR _isPostIt$3[ebp], dl
mov	DWORD PTR _cmd$2[ebp], 0
movzx	eax, BYTE PTR _isFullScreen$4[ebp]
test	eax, eax
je	SHORT $LN7@run_dlgPro
movzx	ecx, BYTE PTR _isPostIt$3[ebp]
test	ecx, ecx
je	SHORT $LN7@run_dlgPro
mov	DWORD PTR _cmd$2[ebp], 44009		
jmp	SHORT $LN6@run_dlgPro
movzx	edx, BYTE PTR _isFullScreen$4[ebp]
test	edx, edx
je	SHORT $LN5@run_dlgPro
mov	DWORD PTR _cmd$2[ebp], 44032		
jmp	SHORT $LN6@run_dlgPro
movzx	eax, BYTE PTR _isPostIt$3[ebp]
test	eax, eax
je	SHORT $LN6@run_dlgPro
mov	DWORD PTR _cmd$2[ebp], 44009		
push	0
mov	ecx, DWORD PTR _cmd$2[ebp]
push	ecx
push	273					
mov	edx, DWORD PTR _this$[ebp]
...
ret	0
ENDP
?doDialog@ButtonDlg@@QAEX_N@Z PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?run_dlgProc@ValueDlg@@MAGHIIJ@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 36					
mov	eax, DWORD PTR ___security_cookie
...
mov	ecx, DWORD PTR _this$[ebp]
call	?reSizeValueBox@ValueDlg@@QAEHXZ	
mov	DWORD PTR _size$2[ebp], eax
push	1
mov	ecx, DWORD PTR _rc$3[ebp+12]
sub	ecx, DWORD PTR _rc$3[ebp+4]
add	ecx, 30					
push	ecx
mov	edx, DWORD PTR _rc$3[ebp+8]
sub	edx, DWORD PTR _rc$3[ebp]
...
ret	16					
ENDP
?reSizeValueBox@ValueDlg@@QAEHXZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 52					
mov	eax, DWORD PTR ___security_cookie
...
sub	ecx, 2
imul	ecx, DWORD PTR _unit$[ebp]
mov	DWORD PTR _extraSize$[ebp], ecx
push	0
mov	edx, DWORD PTR _h$[ebp]
push	edx
mov	eax, DWORD PTR _w$[ebp]
add	eax, DWORD PTR _extraSize$[ebp]
push	eax
...
ret	0
ENDP
?doDialog@ValueDlg@@QAEHUtagPOINT@@_N@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
...
ret	12					
ENDP
?init@ValueDlg@@QAEXPAUHINSTANCE__@@PAUHWND__@@HPB_W@Z PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR _valueToSet$[ebp]
