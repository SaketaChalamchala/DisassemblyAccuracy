...
ret	8
ENDP
?runProc@ToolTip@@IAEJIIJ@Z PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	12					
ENDP
?staticWinProc@ToolTip@@KGJPAUHWND__@@IIJ@Z PROC	
push	ebp
mov	ebp, esp
mov	eax, DWORD PTR _lParam$[ebp]
push	eax
...
mov	ecx, eax
call	?runProc@ToolTip@@IAEJIIJ@Z		
pop	ebp
ret	16					
ENDP
?Show@ToolTip@@QAEXUtagRECT@@PB_WHH@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
...
call	edx
mov	eax, DWORD PTR _pszTitle$[ebp]
push	eax
...
jmp	$LN3@Show
mov	ecx, DWORD PTR _this$[ebp]
mov	DWORD PTR [ecx+24], 48			
mov	edx, DWORD PTR _this$[ebp]
mov	DWORD PTR [edx+28], 160			
mov	eax, DWORD PTR _this$[ebp]
...
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR _rectTitle$[ebp]
mov	DWORD PTR [ecx+40], edx
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR _rectTitle$[ebp+4]
mov	DWORD PTR [eax+44], ecx
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR _rectTitle$[ebp+8]
mov	DWORD PTR [edx+48], eax
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR _rectTitle$[ebp+12]
...
mov	DWORD PTR __hFont$[ebp], eax
push	1
mov	edx, DWORD PTR __hFont$[ebp]
push	edx
push	48					
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax+12]
...
add	edx, DWORD PTR _iXOff$[ebp]
and	edx, 65535				
movzx	eax, dx
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+44]
add	edx, DWORD PTR _iWidthOff$[ebp]
and	edx, 65535				
movzx	ecx, dx
shl	ecx, 16					
or	eax, ecx
...
ret	28					
ENDP
?init@ToolTip@@UAEXPAUHINSTANCE__@@PAUHWND__@@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
...
push	OFFSET ?staticWinProc@ToolTip@@KGJPAUHWND__@@IIJ@Z 
push	-4					
mov	ecx, DWORD PTR _this$[ebp]
