...
ret	0
ENDP
?isWordChar@SmartHighlighter@@ABE_ND@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
...
DB	0
ENDP
?isQualifiedWord@SmartHighlighter@@ABE_NPBD@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 12					
mov	DWORD PTR _this$[ebp], ecx
...
push	ecx
mov	ecx, DWORD PTR _this$[ebp]
call	?isWordChar@SmartHighlighter@@ABE_ND@Z	
movzx	edx, al
test	edx, edx
...
ret	4
ENDP
?highlightView@SmartHighlighter@@QAEXPAVScintillaEditView@@@Z PROC 
push	ebp
mov	ebp, esp
push	-1
...
push	ecx
mov	ecx, DWORD PTR _this$[ebp]
call	?isQualifiedWord@SmartHighlighter@@ABE_NPBD@Z 
movzx	edx, al
test	edx, edx
...
ret	4
ENDP
__unwindfunclet$?highlightView@SmartHighlighter@@QAEXPAVScintillaEditView@@@Z$0 PROC
lea	ecx, DWORD PTR _fo$[ebp]
jmp	??1FindOption@@QAE@XZ
ENDP
__ehhandler$?highlightView@SmartHighlighter@@QAEXPAVScintillaEditView@@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ENDP
ENDP
??0SmartHighlighter@@QAE@PAVFindReplaceDlg@@@Z PROC	
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
