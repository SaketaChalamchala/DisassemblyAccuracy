...
ret	8
ENDP
?adjustParts@StatusBar@@QAEXH@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 12					
mov	DWORD PTR _this$[ebp], ecx
mov	eax, DWORD PTR _clientWidth$[ebp]
sub	eax, 20					
...
jmp	SHORT $LN3@adjustPart
mov	eax, DWORD PTR _i$1[ebp]
sub	eax, 1
mov	DWORD PTR _i$1[ebp], eax
cmp	DWORD PTR _i$1[ebp], 0
jl	SHORT $LN1@adjustPart
mov	ecx, DWORD PTR _this$[ebp]
...
ret	4
ENDP
?setOwnerDrawText@StatusBar@@QAE_NPB_W@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
...
call	DWORD PTR __imp__SendMessageW@16
cmp	eax, 1
jne	SHORT $LN3@setOwnerDr
mov	DWORD PTR tv81[ebp], 1
jmp	SHORT $LN4@setOwnerDr
...
ret	4
ENDP
?setText@StatusBar@@QAE_NPB_WH@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
...
call	?c_str@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QBEPB_WXZ 
push	eax
mov	eax, DWORD PTR _whichPart$[ebp]
push	eax
push	1035					
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+12]
...
ret	8
ENDP
?init@StatusBar@@UAEXPAUHINSTANCE__@@PAUHWND__@@H@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 44					
mov	eax, DWORD PTR ___security_cookie
...
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR _nbParts$[ebp]
...
push	eax
call	DWORD PTR __imp__LocalLock@4
mov	ecx, DWORD PTR _this$[ebp]
