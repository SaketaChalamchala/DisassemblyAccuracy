...
ret	8
ENDP
?getDirectionFromUI@FindCharsInRangeDlg@@AAEXAA_N0@Z PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	8
ENDP
?getRangeFromUI@FindCharsInRangeDlg@@AAE_NAAE0@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 20					
mov	DWORD PTR _this$[ebp], ecx
...
cmp	DWORD PTR _start$4[ebp], 255		
jg	SHORT $LN2@getRangeFr
cmp	DWORD PTR _end$3[ebp], 255		
...
ret	8
ENDP
?findCharInRange@FindCharsInRangeDlg@@AAE_NEEH_N0@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 92					
mov	DWORD PTR _this$[ebp], ecx
...
ret	20					
ENDP
?run_dlgProc@FindCharsInRangeDlg@@MAGHIIJ@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 16					
...
mov	BYTE PTR _endRange$3[ebp], 255		
...
push	ecx
mov	ecx, DWORD PTR _this$[ebp]
call	?getRangeFromUI@FindCharsInRangeDlg@@AAE_NAAE0@Z 
movzx	edx, al
test	edx, edx
...
push	eax
mov	ecx, DWORD PTR _this$[ebp]
call	?getDirectionFromUI@FindCharsInRangeDlg@@AAEXAA_N0@Z 
...
push	edx
mov	ecx, DWORD PTR _this$[ebp]
call	?findCharInRange@FindCharsInRangeDlg@@AAE_NEEH_N0@Z 
mov	eax, 1
jmp	SHORT $LN12@run_dlgPro
xor	eax, eax
mov	esp, ebp
