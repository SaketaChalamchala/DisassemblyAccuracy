...
ret	8
ENDP
?getNbSubValue@RegExtDlg@@ABEHPAUHKEY__@@@Z PROC	
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?getNbSubKey@RegExtDlg@@ABEHPAUHKEY__@@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?writeNppPath@RegExtDlg@@AAEXXZ PROC			
push	ebp
mov	ebp, esp
push	-1
...
mov	DWORD PTR fs:0, eax
mov	DWORD PTR _this$[ebp], ecx
mov	eax, DWORD PTR ?nppName@@3PB_WB		
push	eax
...
push	983103					
push	0
mov	ecx, DWORD PTR ?nppName@@3PB_WB		
push	ecx
push	-2147483648				
call	DWORD PTR __imp__RegOpenKeyExW@20
mov	edx, DWORD PTR ?nppDoc@@3PB_WB		
push	edx
call	DWORD PTR __imp__lstrlenW@4
lea	eax, DWORD PTR [eax+eax+2]
push	eax
mov	ecx, DWORD PTR ?nppDoc@@3PB_WB		
push	ecx
push	1
push	0
push	0
...
ret	0
ENDP
__unwindfunclet$?writeNppPath@RegExtDlg@@AAEXXZ$0 PROC
lea	ecx, DWORD PTR _regStr$[ebp]
jmp	??1?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QAE@XZ 
ENDP
__ehhandler$?writeNppPath@RegExtDlg@@AAEXXZ PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
...
ENDP
ENDP
?deleteExts@RegExtDlg@@AAE_NPB_W@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 160				
mov	eax, DWORD PTR ___security_cookie
...
jmp	$LN3@deleteExts
mov	DWORD PTR _valDataLen$3[ebp], 64	
...
push	edx
push	0
mov	eax, DWORD PTR ?nppBackup@@3PB_WB	
push	eax
mov	ecx, DWORD PTR _hKey$[ebp]
push	ecx
...
ret	4
ENDP
?addExt@RegExtDlg@@AAEXPA_W@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 548				
mov	eax, DWORD PTR ___security_cookie
...
cmp	DWORD PTR _nRet$[ebp], 0
jne	$LN4@addExt
mov	DWORD PTR _valDataLen$2[ebp], 520	
...
push	1
push	0
mov	edx, DWORD PTR ?nppBackup@@3PB_WB	
push	edx
mov	eax, DWORD PTR _hKey$[ebp]
push	eax
call	DWORD PTR __imp__RegSetValueExW@24
...
ret	4
ENDP
?getDefSupportedExts@RegExtDlg@@AAEXXZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 8
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?getRegisteredExts@RegExtDlg@@AAEXXZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 164				
mov	eax, DWORD PTR ___security_cookie
...
jge	$LN6@getRegiste
mov	DWORD PTR _extNameActualLen$5[ebp], 32	
push	0
push	0
push	0
push	0
...
cmp	ecx, 46					
jne	$LN2@getRegiste
mov	DWORD PTR _valDataLen$1[ebp], 64	
mov	DWORD PTR _extNameActualLen$5[ebp], 32	
...
mov	edx, DWORD PTR ?nppName@@3PB_WB		
push	edx
...
ret	0
ENDP
?run_dlgProc@RegExtDlg@@EAGHIIJ@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 236				
mov	eax, DWORD PTR ___security_cookie
...
je	$LN24@run_dlgPro
cmp	DWORD PTR tv137[ebp], 4004		
je	SHORT $LN35@run_dlgPro
cmp	DWORD PTR tv137[ebp], 4007		
je	$LN31@run_dlgPro
jmp	$LN36@run_dlgPro
mov	ecx, DWORD PTR _this$[ebp]
...
ret	16					
ENDP
?doDialog@RegExtDlg@@QAEX_N@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 12					
mov	DWORD PTR _this$[ebp], ecx
