...
ret	8
ENDP
?run_dlgProc@ColourPopup@@AAGHIIJ@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 104				
mov	eax, DWORD PTR ___security_cookie
...
jmp	$LN30@run_dlgPro
mov	DWORD PTR _nColor$7[ebp], 0
jmp	SHORT $LN28@run_dlgPro
mov	ecx, DWORD PTR _nColor$7[ebp]
add	ecx, 1
mov	DWORD PTR _nColor$7[ebp], ecx
cmp	DWORD PTR _nColor$7[ebp], 48		
jge	SHORT $LN26@run_dlgPro
push	OFFSET $SG91740
mov	edx, DWORD PTR _nColor$7[ebp]
push	edx
push	384					
push	2101					
mov	eax, DWORD PTR _this$[ebp]
...
mov	edx, DWORD PTR _nColor$7[ebp]
mov	eax, DWORD PTR ?colourItems@@3PAKA[edx*4]
push	eax
mov	ecx, DWORD PTR _nColor$7[ebp]
push	ecx
push	410					
...
mov	DWORD PTR _pdis$8[ebp], ecx
mov	edx, DWORD PTR _pdis$8[ebp]
mov	eax, DWORD PTR [edx+24]
mov	DWORD PTR _hdc$9[ebp], eax
mov	ecx, DWORD PTR _pdis$8[ebp]
add	ecx, 28					
mov	edx, DWORD PTR [ecx]
mov	DWORD PTR _rc$10[ebp], edx
mov	eax, DWORD PTR [ecx+4]
mov	DWORD PTR _rc$10[ebp+4], eax
mov	edx, DWORD PTR [ecx+8]
mov	DWORD PTR _rc$10[ebp+8], edx
mov	eax, DWORD PTR [ecx+12]
mov	DWORD PTR _rc$10[ebp+12], eax
push	1
mov	ecx, DWORD PTR _hdc$9[ebp]
push	ecx
...
xor	eax, eax
jmp	$LN32@run_dlgPro
mov	eax, DWORD PTR _pdis$8[ebp]
mov	ecx, DWORD PTR [eax+12]
mov	DWORD PTR tv133[ebp], ecx
cmp	DWORD PTR tv133[ebp], 1
je	SHORT $LN20@run_dlgPro
...
mov	DWORD PTR _cr$3[ebp], edx
push	-3					
push	-3					
lea	eax, DWORD PTR _rc$10[ebp]
push	eax
call	DWORD PTR __imp__InflateRect@12
mov	ecx, DWORD PTR _cr$3[ebp]
push	ecx
call	DWORD PTR __imp__CreateSolidBrush@4
mov	DWORD PTR _hbrush$6[ebp], eax
mov	edx, DWORD PTR _hbrush$6[ebp]
push	edx
lea	eax, DWORD PTR _rc$10[ebp]
push	eax
mov	ecx, DWORD PTR _hdc$9[ebp]
...
mov	DWORD PTR _rc$10[ebp], eax
mov	ecx, DWORD PTR [edx+4]
mov	DWORD PTR _rc$10[ebp+4], ecx
mov	eax, DWORD PTR [edx+8]
mov	DWORD PTR _rc$10[ebp+8], eax
mov	ecx, DWORD PTR [edx+12]
mov	DWORD PTR _rc$10[ebp+12], ecx
mov	edx, DWORD PTR _pdis$8[ebp]
mov	eax, DWORD PTR [edx+16]
and	eax, 1
je	$LN15@run_dlgPro
mov	ecx, DWORD PTR _rc$10[ebp+12]
sub	ecx, 1
mov	DWORD PTR _rc$10[ebp+12], ecx
mov	edx, DWORD PTR _rc$10[ebp+8]
sub	edx, 1
mov	DWORD PTR _rc$10[ebp+8], edx
push	16					
call	DWORD PTR __imp__GetSysColor@4
...
mov	DWORD PTR _hpen$5[ebp], eax
mov	eax, DWORD PTR _hpen$5[ebp]
push	eax
mov	ecx, DWORD PTR _hdc$9[ebp]
push	ecx
call	DWORD PTR __imp__SelectObject@8
mov	DWORD PTR _holdPen$4[ebp], eax
push	0
mov	edx, DWORD PTR _rc$10[ebp+12]
push	edx
mov	eax, DWORD PTR _rc$10[ebp]
push	eax
mov	ecx, DWORD PTR _hdc$9[ebp]
push	ecx
...
mov	edx, DWORD PTR _rc$10[ebp+4]
push	edx
mov	eax, DWORD PTR _rc$10[ebp+8]
push	eax
mov	ecx, DWORD PTR _hdc$9[ebp]
push	ecx
call	DWORD PTR __imp__LineTo@12
mov	edx, DWORD PTR _holdPen$4[ebp]
push	edx
mov	eax, DWORD PTR _hdc$9[ebp]
push	eax
call	DWORD PTR __imp__SelectObject@8
mov	ecx, DWORD PTR _hpen$5[ebp]
push	ecx
call	DWORD PTR __imp__DeleteObject@4
push	20					
call	DWORD PTR __imp__GetSysColor@4
...
mov	ecx, DWORD PTR _rc$10[ebp+12]
push	ecx
mov	edx, DWORD PTR _rc$10[ebp]
push	edx
mov	eax, DWORD PTR _hdc$9[ebp]
push	eax
call	DWORD PTR __imp__LineTo@12
mov	ecx, DWORD PTR _holdPen$4[ebp]
push	ecx
...
call	DWORD PTR __imp__CreateSolidBrush@4
mov	DWORD PTR _hbrush$6[ebp], eax
mov	ecx, DWORD PTR _hbrush$6[ebp]
push	ecx
...
cmp	DWORD PTR tv222[ebp], 1
je	SHORT $LN8@run_dlgPro
cmp	DWORD PTR tv222[ebp], 2101		
je	$LN5@run_dlgPro
jmp	$LN3@run_dlgPro
push	36					
push	0
...
call	_memset
add	esp, 12					
mov	DWORD PTR _cc$1[ebp], 36		
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+8]
mov	DWORD PTR _cc$1[ebp+4], eax
mov	DWORD PTR _cc$1[ebp+16], OFFSET ?acrCustClr@?BG@??run_dlgProc@ColourPopup@@AAGHIIJ@Z@4PAKA
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+32]
mov	DWORD PTR _cc$1[ebp+12], edx
...
push	0
mov	edx, DWORD PTR _cc$1[ebp+12]
push	edx
push	7025					
mov	eax, DWORD PTR _this$[ebp]
...
ret	16					
ENDP
?dlgProc@ColourPopup@@CGHPAUHWND__@@IIJ@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 36					
mov	eax, DWORD PTR ___security_cookie
...
mov	eax, DWORD PTR _message$[ebp]
mov	DWORD PTR tv64[ebp], eax
cmp	DWORD PTR tv64[ebp], 44			
je	SHORT $LN4@dlgProc
cmp	DWORD PTR tv64[ebp], 272		
je	SHORT $LN3@dlgProc
jmp	$LN2@dlgProc
mov	ecx, DWORD PTR _lParam$[ebp]
mov	DWORD PTR _lpmis$3[ebp], ecx
lea	edx, DWORD PTR _rc$4[ebp]
push	edx
mov	eax, DWORD PTR _lpmis$3[ebp]
...
mov	ecx, 6
idiv	ecx
mov	edx, DWORD PTR _lpmis$3[ebp]
mov	DWORD PTR [edx+16], eax
mov	eax, DWORD PTR _rc$4[ebp+8]
sub	eax, DWORD PTR _rc$4[ebp]
cdq
and	edx, 7
add	eax, edx
sar	eax, 3
mov	ecx, DWORD PTR _lpmis$3[ebp]
mov	DWORD PTR [ecx+12], eax
mov	eax, 1
jmp	SHORT $LN7@dlgProc
mov	edx, DWORD PTR _lParam$[ebp]
mov	DWORD PTR _pColourPopup$2[ebp], edx
mov	eax, DWORD PTR _pColourPopup$2[ebp]
...
mov	eax, DWORD PTR _message$[ebp]
push	eax
mov	ecx, DWORD PTR _pColourPopup$2[ebp]
push	ecx
call	?run_dlgProc@ColourPopup@@AAGHIIJ@Z	
mov	eax, 1
jmp	SHORT $LN7@dlgProc
push	-21					
mov	edx, DWORD PTR _hwnd$[ebp]
...
mov	DWORD PTR _pColourPopup$1[ebp], eax
cmp	DWORD PTR _pColourPopup$1[ebp], 0
...
push	edx
mov	eax, DWORD PTR _pColourPopup$1[ebp]
push	eax
call	?run_dlgProc@ColourPopup@@AAGHIIJ@Z	
mov	ecx, DWORD PTR __$ArrayPad$[ebp]
xor	ecx, ebp
...
ret	16					
ENDP
?create@ColourPopup@@QAEXH@Z PROC			
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
mov	eax, DWORD PTR _this$[ebp]
push	eax
push	OFFSET ?dlgProc@ColourPopup@@CGHPAUHWND__@@IIJ@Z 
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+8]
push	edx
