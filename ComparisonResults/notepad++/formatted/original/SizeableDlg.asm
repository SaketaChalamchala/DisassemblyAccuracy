...
ENDP
ENDP
?onWinMgr@SizeableDlg@@MAEJIJ@Z PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	8
ENDP
?onGetMinMaxInfo@SizeableDlg@@MAEXPAUtagMINMAXINFO@@@Z PROC 
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
mov	ecx, DWORD PTR _this$[ebp]
add	ecx, 32					
call	?GetMinMaxInfo@CWinMgr@@QAEXPAUHWND__@@PAUtagMINMAXINFO@@@Z 
mov	esp, ebp
pop	ebp
ret	4
ENDP
?onSize@SizeableDlg@@MAEXIHH@Z PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
mov	ecx, DWORD PTR _this$[ebp]
add	ecx, 32					
call	?CalcLayout@CWinMgr@@QAEXHHPAUHWND__@@@Z 
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+12]
push	edx
mov	ecx, DWORD PTR _this$[ebp]
...
ret	12					
ENDP
?onInitDialog@SizeableDlg@@MAEHXZ PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?run_dlgProc@SizeableDlg@@MAGHIIJ@Z PROC		
push	ebp
mov	ebp, esp
push	ecx
...
jmp	SHORT $LN8@run_dlgPro
mov	eax, DWORD PTR _message$[ebp]
cmp	eax, DWORD PTR ?WM_WINMGR@@3IB		
...
ret	16					
ENDP
??0SizeableDlg@@QAE@PAVWINRECT@@@Z PROC			
push	ebp
mov	ebp, esp
push	-1
push	__ehhandler$??0SizeableDlg@@QAE@PAVWINRECT@@@Z
mov	eax, DWORD PTR fs:0
push	eax
push	ecx
mov	eax, DWORD PTR ___security_cookie
...
mov	DWORD PTR __$EHRec$[ebp+8], 0
mov	eax, DWORD PTR _this$[ebp]
mov	DWORD PTR [eax], OFFSET ??_7SizeableDlg@@6B@
mov	ecx, DWORD PTR _pWinMap$[ebp]
push	ecx
mov	ecx, DWORD PTR _this$[ebp]
add	ecx, 32					
call	??0CWinMgr@@QAE@PAVWINRECT@@@Z		
...
ret	4
ENDP
__unwindfunclet$??0SizeableDlg@@QAE@PAVWINRECT@@@Z$0 PROC
mov	ecx, DWORD PTR _this$[ebp]
jmp	??1StaticDialog@@UAE@XZ			
ENDP
__unwindfunclet$??0SizeableDlg@@QAE@PAVWINRECT@@@Z$1 PROC
mov	ecx, DWORD PTR _this$[ebp]
add	ecx, 32					
jmp	??1CWinMgr@@UAE@XZ			
ENDP
__ehhandler$??0SizeableDlg@@QAE@PAVWINRECT@@@Z PROC
mov	edx, DWORD PTR [esp+8]
lea	eax, DWORD PTR [edx+12]
mov	ecx, DWORD PTR [edx-8]
xor	ecx, eax
call	@__security_check_cookie@4
mov	eax, OFFSET __ehfuncinfo$??0SizeableDlg@@QAE@PAVWINRECT@@@Z
jmp	___CxxFrameHandler3
ENDP
ENDP
...
ret	20					
ENDP
?CalcLayout@CWinMgr@@QAEXHHPAUHWND__@@@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 24					
mov	eax, DWORD PTR ___security_cookie
