...
ret	8
ENDP
?rotateTo@SplitterContainer@@AAEX_N@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 20					
mov	DWORD PTR _this$[ebp], ecx
...
mov	ecx, DWORD PTR _this$[ebp]
add	ecx, 24					
call	?rotate@Splitter@@QAEXXZ		
mov	esp, ebp
pop	ebp
ret	4
ENDP
?runProc@SplitterContainer@@AAEJIIJ@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 96					
mov	eax, DWORD PTR ___security_cookie
...
cmp	DWORD PTR tv64[ebp], 515		
je	$LN4@runProc
jmp	$LN1@runProc
cmp	DWORD PTR tv64[ebp], 5026		
je	$LN10@runProc
cmp	DWORD PTR tv64[ebp], 5027		
je	$LN19@runProc
cmp	DWORD PTR tv64[ebp], 5028		
je	$LN24@runProc
jmp	$LN1@runProc
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+128]
...
cmp	DWORD PTR tv88[ebp], 2000		
je	SHORT $LN26@runProc
cmp	DWORD PTR tv88[ebp], 2001		
je	SHORT $LN25@runProc
jmp	SHORT $LN27@runProc
push	1
mov	ecx, DWORD PTR _this$[ebp]
call	?rotateTo@SplitterContainer@@AAEX_N@Z	
mov	eax, 1
jmp	$LN33@runProc
push	0
mov	ecx, DWORD PTR _this$[ebp]
...
mov	ecx, DWORD PTR _this$[ebp]
add	ecx, 24					
call	?getPhisicalSize@Splitter@@QBEHXZ	
add	esi, eax
...
ret	12					
ENDP
?staticWinProc@SplitterContainer@@CGJPAUHWND__@@IIJ@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 8
...
call	?runProc@SplitterContainer@@AAEJIIJ@Z	
mov	esp, ebp
pop	ebp
ret	16					
ENDP
...
ret	0
ENDP
?create@SplitterContainer@@QAEXPAVWindow@@0HW4SplitterMode@@H_N@Z PROC 
push	ebp
mov	ebp, esp
sub	esp, 72					
mov	DWORD PTR _this$[ebp], ecx
...
mov	edx, DWORD PTR _this$[ebp]
mov	DWORD PTR [edx+128], ecx
movzx	eax, BYTE PTR ?_isRegistered@SplitterContainer@@0_NA 
test	eax, eax
jne	$LN3@create
mov	DWORD PTR _splitterContainerClass$1[ebp], 8
mov	DWORD PTR _splitterContainerClass$1[ebp+4], OFFSET ?staticWinProc@SplitterContainer@@CGJPAUHWND__@@IIJ@Z 
...
mov	BYTE PTR ?_isRegistered@SplitterContainer@@0_NA, 1 
mov	eax, DWORD PTR _this$[ebp]
push	eax
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx+4]
...
ret	24					
ENDP
?getPhisicalSize@Splitter@@QBEHXZ PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
