...
ret	8
ENDP
?getLine@GoToLineDlg@@ABEHXZ PROC			
push	ebp
mov	ebp, esp
sub	esp, 16					
mov	DWORD PTR _this$[ebp], ecx
push	0
lea	eax, DWORD PTR _isSuccessful$[ebp]
push	eax
push	2001					
mov	ecx, DWORD PTR _this$[ebp]
...
cmp	DWORD PTR _isSuccessful$[ebp], 0
...
ret	0
ENDP
?cleanLineEdit@GoToLineDlg@@ABEXXZ PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?updateLinesNumbers@GoToLineDlg@@ABEXXZ PROC		
push	ebp
mov	ebp, esp
sub	esp, 12					
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
?run_dlgProc@GoToLineDlg@@MAGHIIJ@Z PROC		
push	ebp
mov	ebp, esp
sub	esp, 116				
...
jmp	$LN6@run_dlgPro
cmp	DWORD PTR tv80[ebp], 2007		
jb	$LN6@run_dlgPro
cmp	DWORD PTR tv80[ebp], 2008		
jbe	$LN9@run_dlgPro
jmp	$LN6@run_dlgPro
push	0
mov	ecx, DWORD PTR _this$[ebp]
...
call	eax
mov	ecx, DWORD PTR _this$[ebp]
call	?cleanLineEdit@GoToLineDlg@@ABEXXZ	
mov	eax, 1
jmp	$LN21@run_dlgPro
mov	ecx, DWORD PTR _this$[ebp]
call	?getLine@GoToLineDlg@@ABEHXZ		
mov	DWORD PTR _line$3[ebp], eax
cmp	DWORD PTR _line$3[ebp], -1
je	$LN12@run_dlgPro
push	0
mov	ecx, DWORD PTR _this$[ebp]
mov	edx, DWORD PTR [ecx]
...
push	92					
push	0
lea	edx, DWORD PTR _notification$1[ebp]
push	edx
call	_memset
add	esp, 12					
...
mov	eax, DWORD PTR _this$[ebp]
mov	ecx, DWORD PTR [eax+12]
mov	DWORD PTR _notification$1[ebp], ecx
mov	edx, DWORD PTR _this$[ebp]
mov	eax, DWORD PTR [edx+12]
push	eax
...
mov	eax, 1
jmp	$LN21@run_dlgPro
cmp	DWORD PTR _wParam$[ebp], 2007		
jne	SHORT $LN8@run_dlgPro
mov	BYTE PTR _isLine$5[ebp], 1
mov	BYTE PTR _isOffset$4[ebp], 0
mov	eax, DWORD PTR _this$[ebp]
mov	DWORD PTR [eax+32], 0
jmp	SHORT $LN7@run_dlgPro
mov	BYTE PTR _isLine$5[ebp], 0
mov	BYTE PTR _isOffset$4[ebp], 1
mov	ecx, DWORD PTR _this$[ebp]
mov	DWORD PTR [ecx+32], 1
push	0
movzx	edx, BYTE PTR _isLine$5[ebp]
push	edx
push	241					
push	2007					
mov	eax, DWORD PTR _this$[ebp]
...
call	DWORD PTR __imp__SendDlgItemMessageW@20
push	0
movzx	edx, BYTE PTR _isOffset$4[ebp]
push	edx
push	241					
push	2008					
mov	eax, DWORD PTR _this$[ebp]
...
call	DWORD PTR __imp__SendDlgItemMessageW@20
mov	ecx, DWORD PTR _this$[ebp]
call	?updateLinesNumbers@GoToLineDlg@@ABEXXZ	
mov	eax, 1
...
cmp	DWORD PTR tv230[ebp], 6
je	SHORT $LN3@run_dlgPro
cmp	DWORD PTR tv230[ebp], 256		
je	SHORT $LN3@run_dlgPro
