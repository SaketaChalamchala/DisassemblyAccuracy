...
ret	0
ENDP
?copy@Mutex@Yuni@@AAEXABV12@@Z PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	4
ENDP
?destroy@Mutex@Yuni@@AAEXXZ PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
...
ret	0
ENDP
??4Mutex@Yuni@@QAEAAV01@ABV01@@Z PROC			
push	ebp
mov	ebp, esp
push	ecx
mov	DWORD PTR _this$[ebp], ecx
