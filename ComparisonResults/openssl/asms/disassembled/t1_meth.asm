...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	F24F350395DD0446ABE598898C73AD2F
; Input	CRC32 :	EE6E0F89

; File Name   :	C:\compspace\Diff\openssl\obj\t1_meth.obj
...
_tls1_get_method proc near		; DATA XREF: .rdata:00000090o
					; .rdata:00000108o ...
...
arg_0		= dword	ptr  4
		...
		cmp	ecx, 303h
		jnz	short loc_12
		mov	eax, offset ?TLSv1_2_method_data@?1??TLSv1_2_method@@9@9 ; `TLSv1_2_method'::`2'::TLSv1_2_method_data
		retn
; ---------------------------------------------------------------------------

loc_12:					; CODE XREF: _tls1_get_method+Aj
		cmp	ecx, 302h
		jnz	short loc_20
		mov	eax, offset ?TLSv1_1_method_data@?1??TLSv1_1_method@@9@9 ; `TLSv1_1_method'::`2'::TLSv1_1_method_data
		retn
; ---------------------------------------------------------------------------

loc_20:					; CODE XREF: _tls1_get_method+18j
		xor	edx, edx
		mov	eax, offset ?TLSv1_method_data@?1??TLSv1_method@@9@9 ; `TLSv1_method'::`2'::TLSv1_method_data
		cmp	ecx, 301h
		cmovnz	eax, edx
		retn
...
_rdata		segment	para public 'DATA' use32
		assume cs:_rdata
		;org 34h
; `TLSv1_2_method'::`2'::TLSv1_2_method_data
?TLSv1_2_method_data@?1??TLSv1_2_method@@9@9 dd	303h ; DATA XREF: _tls1_get_method+Co
					; _TLSv1_2_methodo
		dd offset _tls1_new
		...
		dd 0
; `TLSv1_1_method'::`2'::TLSv1_1_method_data
?TLSv1_1_method_data@?1??TLSv1_1_method@@9@9 dd	302h ; DATA XREF: _tls1_get_method+1Ao
					; _TLSv1_1_methodo
		dd offset _tls1_new
		dd offset _tls1_clear
		dd offset _tls1_free
		...
		dd offset _ssl3_ctx_callback_ctrl
		dd 0
; `TLSv1_method'::`2'::TLSv1_method_data
?TLSv1_method_data@?1??TLSv1_method@@9@9 dd 301h ; DATA	XREF: _tls1_get_method+22o
					; _TLSv1_methodo
		dd offset _tls1_new
		dd offset _tls1_clear
		dd offset _tls1_free
