...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	1F0612425449C5258CDEA4C344502F01
; Input	CRC32 :	E350FC56

; File Name   :	C:\compspace\compare\thunderbird\dlls\original\mozalloc.dll
...
; int __cdecl sub_10001000(int,	char *)
...
; void *__cdecl	moz_calloc(size_t, size_t)
		public moz_calloc
...
; void *__cdecl	moz_malloc(size_t)
		public moz_malloc
...
moz_malloc_usable_size proc near	; DATA XREF: .rdata:off_10002348o
...
loc_10001150:				; CODE XREF: moz_malloc_usable_size+5j
...
; void *__cdecl	moz_realloc(void *, size_t)
		public moz_realloc
...
; char *__cdecl	moz_strdup(const char *)
		public moz_strdup
...
; int __cdecl moz_xcalloc(size_t, size_t)
		public moz_xcalloc
...
; int __cdecl moz_xmalloc(size_t)
		public moz_xmalloc
...
; int __cdecl sub_1000185D(_onexit_t)
...
; int __cdecl sub_10001906(_onexit_t)
...
; int __cdecl sub_100019F9()
sub_100019F9	proc near		; DATA XREF: _pre_c_init+31o
		push	esi
		push	edi
...
loc_10001A07:				; CODE XREF: sub_100019F9+1Bj
		mov	eax, [esi]
		test	eax, eax
		jz	short loc_10001A0F
		call	eax

loc_10001A0F:				; CODE XREF: sub_100019F9+12j
		add	esi, 4

loc_10001A12:				; CODE XREF: sub_100019F9+Cj
		cmp	esi, edi
...
aFatalStlThrewS	db 'fatal: STL threw %s: ',0 ; DATA XREF: sub_10001000+4o
		align 10h
...
a0123456789abcd	db '0123456789ABCDEF',0 ; DATA XREF: .data:off_10003000o
		align 4
; char asc_10002178[2]
asc_10002178	db 0Ah,0		; DATA XREF: mozalloc_abort(char const * const)+1Eo
		align 4
...
dword_100022A8	dd 2 dup(0)		; DATA XREF: sub_100019D9+2o
					; sub_100019D9+7o
dword_100022B0	dd 2 dup(0)		; DATA XREF: sub_100019F9+2o
					; sub_100019F9+7o
...
off_10002348	dd rva ?moz_Xinvalid_argument@std@@YAXPBD@Z, rva ?moz_Xlength_error@std@@YAXPBD@Z
		...
		dd rva moz_calloc, rva moz_free, rva moz_malloc, 2 dup(rva moz_malloc_usable_size)
