...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	4A1077BE08F601C7259CB59DA4D0D58C
; Input	CRC32 :	0CCFCA2C
...
; int __cdecl ldif_base64_decode(char *, int)
...
; int __cdecl sub_1000205D(_onexit_t)
...
; int __cdecl sub_10002106(_onexit_t)
...
; int __cdecl sub_100021F9()
sub_100021F9	proc near		; DATA XREF: _pre_c_init+31o
		push	esi
		push	edi
...
loc_10002207:				; CODE XREF: sub_100021F9+1Bj
		mov	eax, [esi]
		test	eax, eax
		jz	short loc_1000220F
		call	eax

loc_1000220F:				; CODE XREF: sub_100021F9+12j
		add	esi, 4

loc_10002212:				; CODE XREF: sub_100021F9+Cj
		cmp	esi, edi
...
dword_100031E8	dd 2 dup(0)		; DATA XREF: sub_100021D9+2o
					; sub_100021D9+7o
dword_100031F0	dd 2 dup(0)		; DATA XREF: sub_100021F9+2o
					; sub_100021F9+7o
