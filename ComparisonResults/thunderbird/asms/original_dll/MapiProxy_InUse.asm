...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	A978AD58E7628CEEBEB409E5A351E04D
; Input	CRC32 :	B6A21530

; File Name   :	C:\compspace\compare\thunderbird\dlls\original\MapiProxy_InUse.dll
...
; int __cdecl sub_1000166D(_onexit_t)
...
; int __cdecl sub_10001716(_onexit_t)
...
; int __cdecl sub_100017E7()
sub_100017E7	proc near		; DATA XREF: _pre_c_init+31o
		push	esi
		push	edi
...
loc_100017F5:				; CODE XREF: sub_100017E7+1Bj
		mov	eax, [esi]
		test	eax, eax
		jz	short loc_100017FD
		call	eax

loc_100017FD:				; CODE XREF: sub_100017E7+12j
		add	esi, 4

loc_10001800:				; CODE XREF: sub_100017E7+Cj
		cmp	esi, edi
...
; int __stdcall	sub_10002000(void *, int)
...
dword_10003798	dd 2 dup(0)		; DATA XREF: sub_100017C7+2o
					; sub_100017C7+7o
dword_100037A0	dd 2 dup(0)		; DATA XREF: sub_100017E7+2o
					; sub_100017E7+7o
