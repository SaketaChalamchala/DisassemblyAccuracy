...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	B7F3EF8C3E8EB1B2E102FAE2A30BA274
; Input	CRC32 :	A7A693CC

; File Name   :	C:\compspace\compare\thunderbird\dlls\full\AccessibleMarshal_full.dll
...
; int __stdcall	sub_10001000(void *Buf1, int)
...
; int __stdcall	sub_1000103C(void *Buf1, int)
...
; int __stdcall	sub_10001078(void *Buf1, int)
...
; int __cdecl sub_1000265D(_onexit_t Func)
...
; int __cdecl sub_10002706(_onexit_t Func)
...
loc_100027E5:				; CODE XREF: Func+1Bj
		mov	eax, [esi]
		test	eax, eax
		jz	short loc_100027ED
		call	eax

loc_100027ED:				; CODE XREF: Func+12j
		add	esi, 4

loc_100027F0:				; CODE XREF: Func+Cj
		cmp	esi, edi
...
dword_10003BF8	dd 2 dup(0)		; DATA XREF: sub_100027B7+2o
					; sub_100027B7+7o
dword_10003C00	dd 2 dup(0)		; DATA XREF: Func+2o Func+7o
