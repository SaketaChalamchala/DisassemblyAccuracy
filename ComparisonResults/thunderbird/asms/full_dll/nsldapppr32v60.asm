...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	262A92C9BC17082ACC62637446328305
; Input	CRC32 :	B1BA23E1

; File Name   :	C:\compspace\compare\thunderbird\dlls\full\nsldapppr32v60_full.dll
...
loc_1000134C:				; CODE XREF: sub_100012E0+64j
		...
		push	[esp+54h+arg_4]
		push	ebp
		call	NSLDAP32V60_529
		lea	esp, [esp+0]

loc_10001370:				; CODE XREF: sub_100012E0+170j
		test	eax, eax
		jnz	loc_10001456
		mov	eax, dword ptr [esp+44h+var_38+4]
		test	eax, eax
		jz	loc_10001464
		push	8020h
		push	0
...
loc_100013A0:				; CODE XREF: sub_100012E0+103j
		lea	eax, [esp+40h+var_28+0Ch]
		xorps	xmm0, xmm0
		push	eax
		push	dword ptr [esp+44h+var_38+0Ch]
		movdqu	[esp+48h+var_28+0Ch], xmm0
		push	ebp
		push	edi
		movdqu	xmmword	ptr [esp+44h], xmm0
...
loc_100013F5:				; CODE XREF: sub_100012E0+B9j
		lea	eax, [esp+40h+var_28+0Ch]
		push	eax
		push	dword ptr [esp+44h+var_38+8]
		call	ds:PR_StringToNetAddr
		add	esp, 8
		test	eax, eax
		jnz	short loc_10001432
		push	dword ptr [esp+40h+var_38+0Ch]
		call	ds:PR_htons
		add	esp, 4
		mov	word ptr [esp+40h+var_28+0Eh], ax
		lea	eax, [esp+40h+var_28+0Ch]
		push	edi
		push	[esp+44h+arg_10]
		push	eax
...
loc_10001432:				; CODE XREF: sub_100012E0+113j
					; sub_100012E0+129j
		push	dword ptr [esp+40h+var_38+8]
		call	NSLDAP32V60_200
		push	dword ptr [esp+44h+var_38+0Ch]
		lea	eax, [esp+48h+var_38+8]
		push	eax
		lea	eax, [esp+4Ch+var_38+4]
		push	eax
		call	NSLDAP32V60_530
		test	esi, esi
		js	loc_10001370
...
loc_100014A6:				; CODE XREF: sub_100012E0+18Fj
		mov	eax, dword ptr [esp+48h+var_38+0Ch]
		mov	[eax], ebx
...
arg_4		= dword	ptr  8
		...
		mov	dword ptr [esp+28h+var_28+0Ch],	offset loc_100019A0
		...
		mov	dword ptr [esp+28h+var_28+4], offset sub_100012E0
		mov	dword ptr [esp+28h+var_28+8], offset loc_100012A0
...
loc_10001614:				; CODE XREF: sub_10001560+98j
		...
		push	ecx
		call	esi ; PR_Free
		mov	eax, dword ptr [esp+30h+var_8]
		add	esp, 4
		mov	dword ptr [eax], 0
		mov	eax, dword ptr [esp+2Ch+var_8]
...
arg_0		= dword	ptr  4
		...
		push	4F00h
		push	eax
		call	NSLDAP32V60_419
		test	eax, eax
		jnz	short loc_100016BC
		cmp	dword ptr [esp+28h+var_28+4], offset sub_100012E0
		jnz	short loc_100016BC
		mov	eax, 1
		add	esp, 28h
		retn
...
arg_4		= dword	ptr  8
		...
		xorps	xmm0, xmm0
		push	4F00h
		movdqu	[esp+34h+var_28], xmm0
		push	esi
		movdqu	[esp+38h+var_18], xmm0
		mov	dword ptr [esp+38h+var_28], 28h
...
arg_4		= dword	ptr  8
		...
		push	eax
		push	4F00h
		movdqu	[esp+38h+var_28], xmm0
		push	esi
		movdqu	[esp+3Ch+var_18], xmm0
		mov	dword ptr [esp+3Ch+var_28], 28h
...
loc_10001B6D:				; CODE XREF: sub_10001B30+2Bj
		lea	eax, [esp+1Ch+var_20+0Ch]
		mov	[esp+1Ch+var_4], 0
		push	eax
		push	100h
		push	[esp+24h+arg_0]
		xorps	xmm0, xmm0
		movdqu	[esp+28h+var_20+0Ch], xmm0
		mov	dword ptr [esp+28h+var_20+0Ch],	14h
		call	NSLDAP32V60_142
		test	eax, eax
...
loc_10002400:				; CODE XREF: sub_100023D0+18j
		...
		movdqu	[esp+40h+var_24], xmm0
		mov	[esp+40h+var_4], 0
		mov	dword ptr [esp+40h+var_14], offset loc_10001230
		mov	dword ptr [esp+40h+var_14+4], offset sub_10001280
		jz	short loc_10002478
		mov	dword ptr [esp+40h+var_24], offset loc_100024D0
		mov	dword ptr [esp+40h+var_24+4], offset loc_100024E0
		mov	dword ptr [esp+40h+var_24+8], offset loc_100024F0
		mov	dword ptr [esp+40h+var_24+0Ch],	offset loc_10002500
...
loc_1000249D:				; CODE XREF: sub_100023D0+B7j
		lea	eax, [esp+40h+var_48+0Ch]
		xorps	xmm0, xmm0
		push	eax
		push	65h
		movq	[esp+48h+var_2C], xmm0
		push	esi
		movdqu	[esp+4Ch+var_48+0Ch], xmm0
		mov	dword ptr [esp+4Ch+var_2C+4], offset loc_10002390
		call	NSLDAP32V60_418
		neg	eax
		pop	esi
		sbb	eax, eax
...
; ---------------------------------------------------------------------------
		align 2
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_418]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_142]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_419]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_200]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_430]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_431]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_529]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_530]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_531]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_85]
; [00000006 BYTES: COLLAPSED FUNCTION NSLDAP32V60_13]
...
; int __cdecl sub_10002F1D(_onexit_t Func)
...
; int __cdecl sub_10002FC6(_onexit_t Func)
...
loc_100030C7:				; CODE XREF: Func+1Bj
		mov	eax, [esi]
		test	eax, eax
		jz	short loc_100030CF
		call	eax

loc_100030CF:				; CODE XREF: Func+12j
		add	esi, 4

loc_100030D2:				; CODE XREF: Func+Cj
		cmp	esi, edi
...
;
		extrn __imp_NSLDAP32V60_142:dword ; DATA XREF: NSLDAP32V60_142r
					; .rdata:100044F4o
		extrn __imp_NSLDAP32V60_419:dword ; DATA XREF: NSLDAP32V60_419r
		extrn __imp_NSLDAP32V60_200:dword ; DATA XREF: NSLDAP32V60_200r
		extrn __imp_NSLDAP32V60_430:dword ; DATA XREF: NSLDAP32V60_430r
		extrn __imp_NSLDAP32V60_431:dword ; DATA XREF: NSLDAP32V60_431r
		extrn __imp_NSLDAP32V60_529:dword ; DATA XREF: NSLDAP32V60_529r
		extrn __imp_NSLDAP32V60_530:dword ; DATA XREF: NSLDAP32V60_530r
		extrn __imp_NSLDAP32V60_531:dword ; DATA XREF: NSLDAP32V60_531r
		extrn __imp_NSLDAP32V60_85:dword ; DATA	XREF: NSLDAP32V60_85r
		extrn __imp_NSLDAP32V60_418:dword ; DATA XREF: NSLDAP32V60_418r
		extrn __imp_NSLDAP32V60_13:dword ; DATA	XREF: NSLDAP32V60_13r
...
dword_10004298	dd 2 dup(0)		; DATA XREF: sub_10003099+2o
					; sub_10003099+7o
dword_100042A0	dd 2 dup(0)		; DATA XREF: Func+2o Func+7o
...
__IMPORT_DESCRIPTOR_NSLDAP32V60	dd rva dword_100045B8 ;	Import Name Table
		...
		dd rva __imp_NSLDAP32V60_142 ; Import Address Table
