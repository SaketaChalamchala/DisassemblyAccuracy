...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	9AEAD00B641A08A345E436FC83F0BB29
; Input	CRC32 :	58B2E5C4

; File Name   :	C:\compspace\compare\thunderbird\dlls\full\libEGL_full.dll
...
; int __cdecl sub_10001AC6(void	*Src, int, char)
...
; int __usercall sub_10001B74@<eax>(char@<cl>, void *Src, int, int, int)
...
; int __cdecl sub_10001D13(void	*Src, int, int)
...
; int __cdecl sub_10001E53(void	*Src, int, int,	int, int)
...
; int __stdcall	sub_10001FA9(void *Src,	int, void *Dst)
...
; int __usercall sub_1000226B@<eax>(int@<ecx>, void *Src, int, int, int)
...
; int __stdcall	sub_10002355(void *Src)
...
; int __stdcall	sub_10002375(void *Src)
...
; int __stdcall	sub_100023A2(void *Src,	size_t Size)
...
; int __thiscall sub_10002813(void *Dst, void *Src)
...
; int __thiscall sub_10002BBF(void *Dst, void *Src)
...
; int __thiscall sub_10002D1F(void *Dst, int, size_t Size)
...
; int __stdcall	sub_10002DB7(void *Dst,	int)
...
; int __thiscall sub_10003185(void *Dst, char, size_t Size)
...
; int __stdcall	sub_1000329C(int, int, size_t Size)
...
; int __thiscall sub_10003343(int, void	*Src, size_t Size)
...
; int __stdcall	sub_10003473(void *Src,	size_t Size)
...
loc_10004347:				; CODE XREF: sub_1000415C+52j
					; sub_1000415C+58j
					; DATA XREF: ...
		lea	ecx, [esp+24h+Src] ; jumptable 100041B4	default	case
...
loc_10004471:				; CODE XREF: sub_1000445D+6j
		...
		call	sub_10003E95
		mov	[esp+8+Func], offset sub_1000705B ; Func
		call	sub_100065CF
		pop	ecx
...
; int __stdcall	sub_10004C60(void *Src)
...
; int __stdcall	sub_1000533C(void *Dst)
...
eglWaitClient	proc near		; DATA XREF: .rdata:off_10008748o
...
; int __cdecl sub_10006526(_onexit_t Func)
...
; int __cdecl sub_100065CF(_onexit_t Func)
...
sub_1000705B	proc near		; DATA XREF: sub_1000445D+31o
		push	0		; Size
		push	1		; char
		mov	ecx, offset dword_1000A050 ; Dst
		call	sub_10003185
		retn
sub_1000705B	endp
...
off_10008748	dd rva eglGetError, rva	eglGetDisplay, rva eglInitialize
		...
		dd rva eglGetCurrentDisplay, rva eglQueryContext, rva eglWaitClient
...
dwTlsIndex	dd 0FFFFFFFFh		; DATA XREF: sub_10002A4Ar
					; sub_10002A4A+2Dr ...
off_1000A004	dd offset off_10008208	; DATA XREF: sub_10003A3B+17o Funcw
